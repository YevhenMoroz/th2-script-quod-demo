...
class RFQExtractionDetailsRequest:
    ...
    def extract_instrument_label_control(self, name: str):
        self.extract_value(RFQPanelValues.INSTRUMENT_LABEL_CONTROL, name)

    def extract_currency_value_label_control(self, name: str):
        self.extract_value(RFQPanelValues.CURRENCY_VALUE_LABEL_CONTROL, name)

    def extract_near_tenor_label(self, name: str):
        self.extract_value(RFQPanelValues.NEAR_TENOR_LABEL, name)

    def extract_far_tenor_label(self, name: str):
        self.extract_value(RFQPanelValues.FAR_TENOR_LABEL, name)

    def extract_near_settl_date_label(self, name: str):
        self.extract_value(RFQPanelValues.NEAR_SETTL_DATE_LABEL, name)

    def extract_far_settl_date_label(self, name: str):
        self.extract_value(RFQPanelValues.FAR_SETTL_DATE_LABEL, name)

    def extract_party_value_label_control(self, name: str):
        self.extract_value(RFQPanelValues.PARTY_VALUE_LABEL_CONTROL, name)

    def extract_request_side_value_label_control(self, name: str):
        self.extract_value(RFQPanelValues.REQUEST_SIDE_VALUE_LABEL_CONTROL, name)

    def extract_fill_side_value_label_control(self, name: str):
        self.extract_value(RFQPanelValues.FILL_SIDE_VALUE_LABEL_CONTROL, name)

    def extract_creation_value_label_control(self, name: str):
        self.extract_value(RFQPanelValues.CREATION_VALUE_LABEL_CONTROL, name)

    def extract_bid_near_points_value_label(self, name: str):
        self.extract_value(RFQPanelValues.BID_NEAR_POINTS_VALUE_LABEL, name)

    def extract_bid_far_points_value_label(self, name: str):
        self.extract_value(RFQPanelValues.BID_FAR_POINTS_VALUE_LABEL, name)

    def extract_bid_near_price_value_label(self, name: str):
        self.extract_value(RFQPanelValues.BID_NEAR_PRICE_VALUE_LABEL, name)

    def extract_bid_far_price_value_label(self, name: str):
        self.extract_value(RFQPanelValues.BID_FAR_PRICE_VALUE_LABEL, name)

    def extract_bid_value_label(self, name: str):
        self.extract_value(RFQPanelValues.BID_VALUE_LABEL, name)

    def extract_ask_value_label(self, name: str):
        self.extract_value(RFQPanelValues.ASK_VALUE_LABEL, name)

    def extract_ask_near_points_value_label(self, name: str):
        self.extract_value(RFQPanelValues.ASK_NEAR_POINTS_VALUE_LABEL, name)

    def extract_ask_far_points_value_label(self, name: str):
        self.extract_value(RFQPanelValues.ASK_FAR_POINTS_VALUE_LABEL, name)

    def extract_ask_near_price_value_label(self, name: str):
        self.extract_value(RFQPanelValues.ASK_NEAR_PRICE_VALUE_LABEL, name)

    def extract_ask_far_price_value_label(self, name: str):
        self.extract_value(RFQPanelValues.ASK_FAR_PRICE_VALUE_LABEL, name)

    def extract_opposite_near_bid_qty_value_label(self, name: str):
        self.extract_value(RFQPanelValues.OPPOSITE_NEAR_BID_QTY_VALUE_LABEL, name)

    def extract_opposite_near_ask_qty_value_label(self, name: str):
        self.extract_value(RFQPanelValues.OPPOSITE_NEAR_ASK_QTY_VALUE_LABEL, name)

    def extract_opposite_far_bid_qty_value_label(self, name: str):
        self.extract_value(RFQPanelValues.OPPOSITE_FAR_BID_QTY_VALUE_LABEL, name)

    def extract_opposite_far_ask_qty_value_label(self, name: str):
        self.extract_value(RFQPanelValues.OPPOSITE_FAR_ASK_QTY_VALUE_LABEL, name)

    def extract_is_bid_price_pips_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_BID_PRICE_PIPS_ENABLED, name)

    def extract_is_ask_price_pips_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_ASK_PRICE_PIPS_ENABLED, name)

    def extract_is_near_leg_quantity_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_NEAR_LEG_QUANTITY_ENABLED, name)

    def extract_is_far_leg_quantity_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_FAR_LEG_QUANTITY_ENABLED, name)

    def extract_is_price_spread_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_PRICE_SPREAD_ENABLED, name)

    def extract_is_bid_price_large_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_BID_PRICE_LARGE_ENABLED, name)

    def extract_is_ask_price_large_enabled(self, name: str):
        self.extract_value(RFQPanelValues.IS_ASK_PRICE_LARGE_ENABLED, name)
