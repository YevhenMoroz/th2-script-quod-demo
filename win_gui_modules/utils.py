...
def prepare_fe_2(main_event, session, fe_dir: str = 'qf_trading_fe_folder_303'):
    stub = Stubs.win_act
    init_event = create_event("Initialization", parent_id=main_event)
    ...
    login_details_req.set_username(Stubs.custom_config['qf_trading_fe_user_303'])
    login_details_req.set_password(Stubs.custom_config['qf_trading_fe_password_303'])
