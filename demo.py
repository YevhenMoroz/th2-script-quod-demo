...
from quod_qa.eq.Test import read_log_example, MD_test, TradingSession_test_2, TradingSession_test, MD_test_3
...
def test_run():
    ...
    try:
        ...
        # TradingSession_test_2.execute(report_id)
        ...
        #     20,
        #     350,
        #     [NoMDEntries(MDEntryType="0", MDEntryPx="0", MDEntrySize="0", MDEntryPositionNo="1"),
        #      NoMDEntries(MDEntryType="1", MDEntryPx="20", MDEntrySize="500", MDEntryPositionNo="1")],
        #     [NoMDEntries(MDUpdateAction='0', MDEntryType='2', MDEntryPx='40', MDEntrySize='1000',
        #                  MDEntryDate=datetime.utcnow().date().strftime("%Y%m%d"),
        #                  MDEntryTime=datetime.utcnow().time().strftime("%H:%M:%S"))])

        # rm = RuleManager()
        # rm.add_NewOrdSingleExecutionReportPendingAndNew("fix-buy-side-316-ganymede","XPAR_CLIENT2","XPAR",1)
