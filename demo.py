...
from test_cases.fx.fx_mm_esp import QAP_2069, QAP_1536, QAP_1559
from test_cases.fx.fx_mm_rfq import QAP_2101
from test_cases.fx.fx_mm_rfq.QAP_6364 import QAP_6364
from test_cases.fx.fx_taker_rfq import QAP_569, QAP_574, QAP_2836
...
def test_run():
    ...
    try:
        ...
        QAP_6364(report_id, session_id, data_set).execute()
