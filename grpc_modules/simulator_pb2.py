...
_RULEINFO.fields_by_name['connection_id'].message_type = infra__pb2._CONNECTIONID
...
RulesInfo = _reflection.GeneratedProtocolMessageType('RulesInfo', (_message.Message,), dict(
