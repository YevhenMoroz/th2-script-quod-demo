...
def execute(report_id):
    try:
        ...
        fix_message.update_fields_in_component('QuodFlatParameters', dict(NavigatorExecution= 1, NavigatorLimitPrice= price_nav, NavigatorInitialSweepTime= 10, Waves = 10, NavigatorPercentage = 50))
