...
def rules_creation():
    ...
    nos_rule1 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(connectivity_buy_side, account, ex_destination_1, price_nav_with_off)
...
def execute(report_id):
    try:
        ...
        nav_child.change_parameters(dict(OrderQty=qty_nav, Price=price_nav_with_off))
