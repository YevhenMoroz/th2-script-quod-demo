...
def execute(report_id):
    try:
        ...
        execution_report = FixMessageExecutionReportAlgo().set_params_from_new_order_single(new_order_single, Side.Sell, Status.Pending)
        fix_verifier.check_fix_message(execution_report)

        execution_report2 = FixMessageExecutionReportAlgo().set_params_from_new_order_single(new_order_single, Side.Sell, Status.New)
