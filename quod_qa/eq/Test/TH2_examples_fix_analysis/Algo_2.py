...
instrument = {
            'Symbol': 'FR0000130809_EUR',
            'SecurityID': 'FR0000130809',
            'SecurityIDSource': '4',
...
def execute(report_id):
    try:
        ...
        nos_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew("fix-buy-side-316-ganymede", "XPAR_CLIENT1", "XPAR", 30)
