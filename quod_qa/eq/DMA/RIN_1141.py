...
def execute(report_id):
    ...
    qty = ["100", "0"]  # Setting values for all orders
    price = "0"
    client = "HAKKIM"
    lookup = [" ", "RELIANCE"]
    # endregion
    ...
    new_order_details.set_lookup_instr(lookup[0])
    ...
    main_order_details.set_filter(["Lookup", lookup[0]])
    # endregion
    ...
    new_order_details = NewOrderDetails()
    new_order_details.set_lookup_instr(lookup[1])
    new_order_details.set_order_details(order_ticket)
    new_order_details.set_default_params(base_request)
    order_ticket_service = Stubs.win_act_order_ticket
    common_act = Stubs.win_act
    ...
    main_order_details.set_default_params(base_request)
    main_order_details.set_extraction_id(extraction_id)
    main_order_details.set_filter(["Lookup", lookup[1]])
    # endregion
