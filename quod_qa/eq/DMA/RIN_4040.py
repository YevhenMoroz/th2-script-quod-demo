...
from win_gui_modules.utils import set_session_id, get_base_request, prepare_fe, call, get_opened_fe, prepare_fe_2
...
def execute(report_id):
    ...
    call(stub.verifyEntities, verification("LoginErrorMessageExtraction", "checking order",
                                                 [verify_ent("Login Status", response, "Error")]))
