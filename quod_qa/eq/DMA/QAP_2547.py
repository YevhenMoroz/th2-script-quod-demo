...
from rule_management import RuleManager, rule_manager
...
def execute(report_id):
    ...
    mnos = rule_manager.add_NewOrdSingle_Market("fix-bs-310-columbia", "CLIENTYMOROZ_PARIS", "XPAR", True, 100, 10.0)
