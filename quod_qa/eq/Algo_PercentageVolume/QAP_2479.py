...
def execute(report_id):
    try:
        ...
        fix_verifier_bs.CheckExecutionReport(er_7, responce_new_order_single, direction='SECOND', case=case_id_7, message_name='BS FIXBUYTH2 sent 35=8 Cancel MD Child',key_parameters=['OrderQty', 'ExecType', 'OrdStatus', 'Text'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_8, responce_new_order_single, direction='SECOND', case=case_id_7, message_name='BS FIXBUYTH2 sent 35=8 Cancel LTQ Child',key_parameters=['OrderQty', 'ExecType', 'OrdStatus', 'Text'])
        ...
        fix_verifier_ss.CheckExecutionReport(er_15, responce_new_order_single, case=case_id_7, message_name='SS FIXSELLQUOD5 sent 35=8 Cancel', key_parameters=['OrderQty', 'ExecType', 'OrdStatus', 'OrderID', 'Text'])
        #endregion
