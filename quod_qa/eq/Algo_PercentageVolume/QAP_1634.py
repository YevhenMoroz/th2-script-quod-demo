...
def execute(report_id):
    ...
    fix_message_PerVolume = FixMessage(participate_params)
    ...
    # #Check on bs
    # new_order_single_bs = {
    #     'Side': participate_params['Side'],
    #     'Price': participate_params['Price'],
    #     'TimeInForce': participate_params['TimeInForce']
    # }
