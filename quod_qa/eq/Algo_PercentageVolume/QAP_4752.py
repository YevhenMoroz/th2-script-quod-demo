...
text_s = 'sim work'
text_free_notes = 'could not determine Would price from Primary'
side = 1
tif_day = 0
tif_ioc = 3
...
def execute(report_id):
    try:
        ...
        new_order_single_params = {
            'Account': client,
            'ClOrdID': 'QAP_4752_' + bca.client_orderid(9),
            'HandlInst': 2,
            'Side': side,
            'OrderQty': qty,
            'TimeInForce': tif_day,
        ...
        # Check that FIXQUODSELL5 sent 35=8 Eliminated
        er_3 = {
        'ExecID': '*',
        'OrderQty': qty,
        'NoStrategyParameters': '*',
        ...
        fix_verifier_ss.CheckExecutionReport(er_3, responce_new_order_single, case=case_id_1, message_name='FIXQUODSELL5 sent 35=8 Eliminated', key_parameters=['ClOrdID', 'OrdStatus', 'ExecType', 'OrderQty', 'Price', 'Text'])
        #endregion
