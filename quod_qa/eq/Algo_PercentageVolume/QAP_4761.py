...
percentage = 10
aggressivity = 1
child_mkd_qty = 23                  #round (ltq * percentage / (100 - percentage))   
child_ltq_qty = 12                  #round (mkd * percentage / (100 - percentage))   
...
def rule_creation():
    ...
    return [nos_rule1, nos_rule2, ocr_rule]
...
def execute(report_id):
    try:
        ...
        new_order_single_params = {
            'Account': client,
            'ClOrdID': 'QAP_4761_' + bca.client_orderid(9),
            'HandlInst': 2,
            'Side': side,
            'OrderQty': qty,
            'TimeInForce': tif_day,
        ...
        fix_verifier_bs.CheckExecutionReport(er_8, responce_new_order_single, direction='SECOND', case=case_id_9, message_name='BS FIXBUYTH2 sent 35=8 Cancel LTQ',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_9, responce_new_order_single, direction='SECOND', case=case_id_9, message_name='BS FIXBUYTH2 sent 35=8 Cancel LTQ',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
