...
def execute(report_id):
    ...
    verifier_310_sell_side.CheckNewOrderSingle(nos_1, responce_new_order_single, direction='SECOND')
    ...
    verifier_310_sell_side.CheckExecutionReport(er_1, responce_new_order_single)
    ...
    verifier_310_sell_side.CheckExecutionReport(er_2, responce_new_order_single)
    ...
    verifier_310_buy_side.CheckNewOrderSingle(nos_2, responce_new_order_single,key_parameters = ['ExDestination', 'Side', 'Price'])
    ...
    verifier_310_buy_side.CheckNewOrderSingle(nos_3, responce_new_order_single,key_parameters = ['ExDestination', 'Side', 'Price'])
    ...
    verifier_310_buy_side.CheckExecutionReport(er_3, responce_new_order_single,key_parameters = ['Side', 'ExecType'], direction='SECOND')
...
#TODO Add difference between cancel on QDD1 and QDD2
    ...
    verifier_310_buy_side.CheckExecutionReport(er_3, responce_new_order_single, key_parameters=['Side', 'ExecType'],
                                               direction='SECOND')
    ...
    verifier_310_buy_side.CheckNewOrderSingle(nos_4, responce_new_order_single,key_parameters = ['ExDestination', 'Side', 'Price'])
    ...
    verifier_310_buy_side.CheckExecutionReport(er_4, responce_new_order_single,key_parameters = ['ExDestination', 'ExecType', 'OrdStatus'],direction='SECOND')
    ...
    verifier_310_buy_side.CheckExecutionReport(er_5, responce_new_order_single,key_parameters = ['ExDestination', 'ExecType', 'OrdStatus'],direction='SECOND')
    ...
    time.sleep(1)
    verifier_310_sell_side.CheckExecutionReport(cancel_er_params, responce_cancel)
