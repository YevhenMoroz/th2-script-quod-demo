...
def execute(report_id, session_id):
    ...
    path_xlsx = "C:\\Users\\" + "IPalamarchuk" + '\\PycharmProjects\\th2-script-quod-demo\\quod_qa\\eq\\Basket' \
                                                 '\\Basket_import_files\\BasketTemplate_withHeader_Mapping1.xlsx'
    path_csv = "C:\\Users\\" + "IPalamarchuk" + '\\PycharmProjects\\th2-script-quod-demo\\quod_qa\\eq\\Basket' \
