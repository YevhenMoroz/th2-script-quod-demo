...
def execute(report_id, session_id):
    ...
    # region Create CO
    fix_message = quod_qa.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 3, 2, client_for_first_order, 2, qty, 0,
                                                                       price)
    ...
    fix_message_second_order = quod_qa.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 3, 2,
