...
def rule_creation():
    ...
    fok_rule = rule_manager.add_NewOrdSingle_FOK(connectivity_buy_side, account,  ex_destination_1, True, 40)
    return [fok_rule]
...
def execute(report_id):
    try:
        ...
        case_id_3 = bca.create_event("Check Fill Order", case_id)
        # Check that FUXBUYTH2 sent 35=8 Fill
        er_5 = {
            'Account': account,
            'CumQty': qty,
            'LastPx': price,
