...
def execute(report_id):
    try:
        ...
        fix_verifier_ss.CheckNewOrderSingle(nost_1, responce_new_order_single, direction='SECOND', case=case_id_1, message_name='FIXQUODSELL5 receive 35=D')
        ...
        er_5 = {
            ...
            'Instrument': '*',
            'ExecType': "F",
            'LeavesQty': display_qty - trade_qty
        }
        time.sleep(1)
        fix_verifier_bs.CheckExecutionReport(er_5, responce_new_order_single, direction='SECOND', case=case_id_2,  message_name='BS FIXBUYTH2 sent 35=8 Partially Filled', key_parameters=['OrderQty', 'Price', 'ExecType', 'OrdStatus', 'TimeInForce'])        
        #endregion
