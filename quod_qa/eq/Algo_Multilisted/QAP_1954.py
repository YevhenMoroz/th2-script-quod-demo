...
def execute(report_id):
    try:
        ...
        fix_verifier_bs.CheckExecutionReport(er_9, responce_cancel, direction='SECOND', case=case_id_3, message_name='BS FIXBUYTH2 sent 35=8 Cancel',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
        ...
        fix_verifier_ss.CheckExecutionReport(er_10, responce_cancel, case=case_id_3, message_name="SS FIXSELLQUOD5 send 35=8 Cancel")
        #endregion
