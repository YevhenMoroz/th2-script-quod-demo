...
def execute(report_id):
    ...
    call(common_act.verifyEntities, verification(child_order_info_extraction, "checking Child order",
                                                 [verify_ent("Child Order Qty - 4", child1_order_qty.name, "1,000"),
                                                  verify_ent("Child Order Qty - 3", child2_order_qty.name, "750"),
                                                  verify_ent("Child Order Qty - 2", child3_order_qty.name, "500"),
