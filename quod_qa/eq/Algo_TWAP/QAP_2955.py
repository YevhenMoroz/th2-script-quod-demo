    ...
    try:
        ...
        new_order_single_params = {
            ...
            'TargetStrategy': 1005,
                ...
                {
                    'StrategyParameterName': 'Neutral',
                    'StrategyParameterType': '14',
                    'StrategyParameterValue': 'LTP'
                },
                {
                    'StrategyParameterName': 'LowLiquidity',
                    'StrategyParameterType': '13',
                    'StrategyParameterValue': '1'
                },
                {
                    'StrategyParameterName': 'ParticipateInOpeningAuctions',
                    'StrategyParameterType': '13',
                    'StrategyParameterValue': '1'
                },
                {
                    'StrategyParameterName': 'ParticipateInClosingAuctions',
                    'StrategyParameterType': '13',
                    'StrategyParameterValue': '1'
                },
                {
                    'StrategyParameterName': 'AcceptPartialSlice',
                    'StrategyParameterType': '13',
                    'StrategyParameterValue': '1'
                },
                {
                    'StrategyParameterName': 'PartialFront',
                    'StrategyParameterType': '13',
                    'StrategyParameterValue': '1'
                },
                {
                    'StrategyParameterName': 'SizeRandomness',
                    'StrategyParameterType': '6',
                    'StrategyParameterValue': '0.0'
                },
                {
                    'StrategyParameterName': 'Waves',
                    'StrategyParameterType': '1',
                    'StrategyParameterValue': '14'
                },
                {
                ...
                {
                    'StrategyParameterName': 'ReservedQty',
                    'StrategyParameterType': '1',
                ...
                {
                    'StrategyParameterName': 'ChildMinQty',
                    'StrategyParameterType': '1',
                    'StrategyParameterValue': '0'
                },
                {
                    ...
                    'StrategyParameterType': '6',
                    'StrategyParameterValue': '0.000'
                },
                {
                    'StrategyParameterName': 'TimeRandomness',
                    'StrategyParameterType': '1',
                    'StrategyParameterValue': '0'
                },
                {
                ...
                {
                    'StrategyParameterName': 'NeutralOffset',
                    'StrategyParameterType': '1',
                    'StrategyParameterValue': '0'
                }
            ]
