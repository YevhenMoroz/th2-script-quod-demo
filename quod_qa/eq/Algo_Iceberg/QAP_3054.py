...
def execute(report_id):
    try:
        ...
        fix_modify_message.change_parameters({'DisplayInstruction': {'DisplayQty': inc_displ_qty}})
        ...
        replace_ss_param ={
            ...
            'Currency': currency,
            'TimeInForce': '0',
            'DisplayInstruction': {'DisplayQty' : inc_displ_qty},
            'HandlInst': new_order_single_params['HandlInst'],
            'OrdType': new_order_single_params['OrdType'],
            'ClOrdID': fix_message_new_order_single.get_ClOrdID(),
            'OrderCapacity': new_order_single_params['OrderCapacity'],
        ...
        fix_verifier_bs.CheckExecutionReport(er_5, responce_new_order_single, direction='SECOND', case=case_id_3, message_name='BS FIXBUYTH2 sent 35=8 Replace',key_parameters=['OrderQty', 'Price', 'ExecType', 'OrdStatus'])
