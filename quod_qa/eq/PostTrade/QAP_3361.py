...
def execute(report_id, session_id):
    ...
    try:
        ...
        fix_message = quod_qa.wrapper.eq_fix_wrappers.create_order_via_fix(case_id=case_id, handl_inst=handl_inst, side=side, client=client, ord_type=ord_type, qty=qty, tif=tif, price=price)
    except Exception:
