...
class QAP_801(CommonTestCase):
    ...
    def precondition(self):
        ...
        counterparts_wizard.set_name_value_at_values_tab("don\'t touch just for autotest!")
    ...
    def test_context(self):
        ...
        expected_pdf_content = 'Counterpart: "don\'t touch just for autotest!"Counterpart    Name: don\'t touch just for ' \
                               'autotest!SubCounterparts1.   data - 12 - 3 - BIC 2.   newName - new - new - Application ' \
                               'Counterpart Party Role1.   BIC - 2 - Exchange - 3 - Bank - Australia And New Zealand ' \
