...
class RunOthers:
    ...
    def execute(self):
        ...
        # QAP_1738(self.web_driver_container).run()
        # QAP_1741(self.web_driver_container).run()
        # QAP_1739(self.web_driver_container).run() don't work block in filter venue
        QAP_1831(self.web_driver_container).run()