...
class QAP_2628(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            self.verify("PDF content before saving", True, client_tiers_wizard.click_download_pdf_entity_button_and_check_pdf(expected_pdf_content))
            ...
            self.verify("PDF content after saving", True,
                        client_tier_instrument_main_page.click_download_pdf_entity_button_and_check_pdf(expected_pdf_content))
