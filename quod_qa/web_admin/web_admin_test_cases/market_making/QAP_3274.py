...
class QAP_3274(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id):
        ...
        self.core_spot_price_strategy = "MidPoint"
        self.core_spot_price_strategy_new = "Direct"
        self.symbol = "EUR/USD"
    ...
    def test_context(self):
        ...
        try:
            ...
            time.sleep(2)
            client_tier_instrument_values_sub_wizard.set_core_spot_price_strategy(self.core_spot_price_strategy_new)
            time.sleep(2)
            client_tiers_wizard.click_on_save_changes()
            time.sleep(2)
            client_tiers_main_page.set_name(self.name)
            ...
            client_tier_instrument_main_page.set_symbol(self.symbol)
            time.sleep(2)
            self.verify("Is Core Spot changed correctly", self.core_spot_price_strategy_new,
                        client_tier_instrument_main_page.get_core_spot_price_strategy())
