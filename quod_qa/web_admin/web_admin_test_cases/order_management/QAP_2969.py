...
class QAP_2969(CommonTestCase):
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id):
        ...
        self.value_at_dark_parameter = "ExtCust1"
    ...
    def test_context(self):
        ...
        strategies_wizard = ExecutionStrategiesWizard(self.web_driver_container)
        dark_block = ExecutionStrategiesDarkSubWizard(self.web_driver_container)
        expected_parameter_at_dark_block = "ExtCust1"
        ...
        lit_general.set_value_by_dropdown_list_at_sub_wizard("ExtCust2")
        lit_general.click_on_checkmark_button()
        expected_parameter_at_lit_general_block = "ExtCust2"
        ...
        expected_parameter_and_value_at_dark_block = ["DarkOpeningBrokerStrategy: ", expected_parameter_at_dark_block]
        ...
        actual_parameter_and_value_at_lit_general_block = [strategies_wizard.get_parameter_name_at_lit_general_block(),
