class UsersConstants:
    ...
    FIRST_TIME_LOGIN_CHECKBOX_AT_LOGIN_SUB_WIZARD ='//*[text()="First Time Login"]/preceding-sibling::span'
    ...
    DESKS_CHECKBOX_LIST_AT_ROLE_SUB_WIZARD = '//*[@class="cdk-overlay-container"]//*[text()="{}"]'
