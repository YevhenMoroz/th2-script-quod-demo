class VenuesConstants:
    ...
    # --Match type tab--
    MATCH_TYPE_TAB_TAB_PLUS_BUTTON_XPATH = '//*[text()=" Match Type "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-plus"]'
    MATCH_TYPE_TAB_TAB_CHECKMARK_BUTTON_XPATH = '//*[text()=" Match Type "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-checkmark"]'
    MATCH_TYPE_TAB_TAB_CLOSE_BUTTON_XPATH = '//*[text()=" Match Type "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-close"]'
    MATCH_TYPE_TAB_TAB_EDIT_BUTTON_XPATH = '//*[text()=" Match Type "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-edit"]'
    MATCH_TYPE_TAB_TAB_DELETE_BUTTON_XPATH = '//*[text()=" Match Type "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-trash"]'

    MATCH_TYPE_TAB_TAB_NAME_XPATH = '//*[@placeholder="Name *"]'
    MATCH_TYPE_TAB_TAB_NAME_FILTER_XPATH = '//*[@class="matchTypeName ng2-smart-th ng-star-inserted"]//input'
    MATCH_TYPE_TAB_TAB_MATCH_TYPE_XPATH = '//*[@placeholder="Match Type *"]'
    MATCH_TYPE_TAB_TAB_MATCH_TYPE_FILTER_XPATH = '//*[@class="matchType ng2-smart-th ng-star-inserted"]//input'

    # --Phase session tab--
    PHASE_SESSION_TAB_TAB_PLUS_BUTTON_XPATH = '//*[text()=" Phase Session "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-plus"]'
    PHASE_SESSION_TAB_TAB_CHECKMARK_BUTTON_XPATH = '//*[text()=" Phase Session "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-checkmark"]'
    PHASE_SESSION_TAB_TAB_CLOSE_BUTTON_XPATH = '//*[text()=" Phase Session "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-close"]'
    PHASE_SESSION_TAB_TAB_EDIT_BUTTON_XPATH = '//*[text()=" Phase Session "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-edit"]'
    PHASE_SESSION_TAB_TAB_DELETE_BUTTON_XPATH = '//*[text()=" Phase Session "]/parent::nb-accordion-item//nb-accordion-item-body//*[@class="nb-trash"]'

    PHASE_SESSION_TAB_TAB_TRADING_PHASE_XPATH = '//*[@placeholder="Trading Phase *"]'
    PHASE_SESSION_TAB_TAB_TRADING_PHASE_FILTER_XPATH = '//*[@class="ng2-smart-th tradingPhase ng-star-inserted"]//input'
    PHASE_SESSION_TAB_TAB_TRADING_SESSION_XPATH = '//*[@placeholder="Trading Session *"]'
    PHASE_SESSION_TAB_TAB_TRADING_SESSION_FILTER_XPATH = '//*[@class="ng2-smart-th tradingSession ng-star-inserted"]//input'
    PHASE_SESSION_TAB_TAB_SUPPORT_MIN_QUANTITY_XPATH = '//*[@placeholder="Trading Session *"]'
    PHASE_SESSION_TAB_TAB_SUPPORT_MIN_QUANTITY_FILTER_XPATH = '//*[@class="status-basic ng-untouched ng-pristine ng-valid nb-transition"]//input'
    PHASE_SESSION_TAB_TAB_PEG_PRICE_TYPE_XPATH = '//*[@class="appearance-outline full-width size-medium status-basic shape-rectangle ng-untouched ng-pristine ng-valid nb-transition"]'
    PHASE_SESSION_TAB_TAB_PEG_PRICE_TYPE_FILTER_XPATH = '//*[@class="ng2-smart-th venuePhaseSessionPegPriceType ng-star-inserted"]//input'

    # --Type tif sub tab--
    TYPE_TIF_TAB_TAB_PLUS_BUTTON_XPATH = '//*[text()="Type TIF"]/following-sibling::ng2-smart-table//*[@class="nb-plus sub-table-action"]'
    TYPE_TIF_TAB_TAB_CHECKMARK_BUTTON_XPATH = '//*[text()="Type TIF"]/following-sibling::ng2-smart-table//*[@class="nb-checkmark"]'
    TYPE_TIF_TAB_TAB_CLOSE_BUTTON_XPATH = '//*[text()="Type TIF"]/following-sibling::ng2-smart-table//*[@class="nb-close"]'
    TYPE_TIF_TAB_TAB_EDIT_BUTTON_XPATH = '//*[text()="Type TIF"]/following-sibling::ng2-smart-table//*[@class="nb-edit sub-table-action"]'
    TYPE_TIF_TAB_TAB_DELETE_BUTTON_XPATH = '//*[text()="Type TIF"]/following-sibling::ng2-smart-table//*[@class="nb-trash sub-table-action"]'

    TYPE_TIF_TAB_TAB_TIME_IN_FORCE_XPATH = '//*[@placeholder="Time In Force *"]'
    TYPE_TIF_TAB_TAB_TIME_IN_FORCE_FILTER_XPATH = '//*[@class="ng2-smart-th timeInForce ng-star-inserted"]//input'
    TYPE_TIF_TAB_TAB_ORD_TYPE_XPATH = '//*[@placeholder="Ord Type *"]'
    TYPE_TIF_TAB_TAB_ORD_TYPE_FILTER_XPATH = '//*[@class="ng2-smart-th ordType ng-star-inserted"]//input'
    TYPE_TIF_TAB_TAB_SUPPORT_DISPLAY_QUANTITY_CHECKBOX_XPATH = '//*[@class="status-basic ng-untouched ng-pristine ng-valid nb-transition"]//input'
    TYPE_TIF_TAB_TAB_SUPPORT_DISPLAY_QUANTITY_CHECKBOX_FILTER_XPATH = '//*[@class="ng2-smart-th supportDisplayQty ng-star-inserted"]//input'
