class CounterpartsConstants:
    ...
    # ----------------COUNTERPARTS WIZARD---------------
    NAME_AT_VALUES_TAB = '//input[@id="counterpartName"]'
    ...
    # --Values--
    NAME_VALUE_AT_SUB_COUNTERPARTS_TAB = '//*//td[2]//div[@class="ng-star-inserted"]'
    PARTY_ID_VALUE_AT_SUB_COUNTERPARTS_TAB = '//*//td[3]//div[@class="ng-star-inserted"]'
    EXT_ID_VALUE_CLIENT_AT_SUB_COUNTERPARTS_TAB = '//*//td[4]//div[@class="ng-star-inserted"]'
    PARTY_SUB_ID_VALUE_TYPE_AT_SUB_COUNTERPARTS_TAB = '//*//td[5]//div[@class="ng-star-inserted"]'
    ...
    # --Values--
    PARTY_ID_SOURCE_VALUE_AT_PARTY_ROLES_TAB = '//*//td[2]//div[@class="ng-star-inserted"]'
    VENUE_COUNTERPART_ID_VALUE_AT_PARTY_ROLES_TAB = '//*//td[3]//div[@class="ng-star-inserted"]'
    PARTY_ROLE_VALUE_AT_PARTY_ROLES_TAB = '//*//td[4]//div[@class="ng-star-inserted"]'
    EXT_ID_CLIENT_VALUE_AT_PARTY_ROLES_TAB = '//*//td[5]//div[@class="ng-star-inserted"]'
    PARTY_ROLE_QUALIFIER_VALUE_AT_PARTY_ROLES_TAB = '//*//td[6]//div[@class="ng-star-inserted"]'
    VENUE_VALUE_AT_PARTY_ROLES_TAB = '//*//td[7]//custom-view-component[@class="ng-star-inserted"]'
