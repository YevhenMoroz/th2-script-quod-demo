...
class CrossedVenueRatesDimensionsSubWizard(CommonPage):
    def __init__(self, web_driver_container: WebDriverContainer):
        super().__init__(web_driver_container)

    def set_venue(self, value):
        self.set_combobox_value(CrossedVenueRatesConstants.DIMENSIONS_TAB_VENUE_XPATH, value)
    ...
    def set_instr_type(self, value):
        self.set_combobox_value(CrossedVenueRatesConstants.DIMENSIONS_TAB_INSTR_TYPE_XPATH, value)

    def get_instr_type(self):
        return self.get_text_by_xpath(CrossedVenueRatesConstants.DIMENSIONS_TAB_INSTR_TYPE_XPATH)

    def set_symbol(self, value):
        self.set_combobox_value(CrossedVenueRatesConstants.DIMENSIONS_TAB_SYMBOL_XPATH, value)

    def get_symbol(self):
        return self.get_text_by_xpath(CrossedVenueRatesConstants.DIMENSIONS_TAB_SYMBOL_XPATH)
