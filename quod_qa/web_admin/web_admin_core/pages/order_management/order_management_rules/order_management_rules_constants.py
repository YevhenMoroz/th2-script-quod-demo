class OrderManagementRulesConstants:
    ...
    DEFAULT_RESULT_TAB_PRICE_ORIGIN_XPATH = '//*[@id="priceOriginresult-table"]'
    DEFAULT_RESULT_TAB_EXECUTION_STRATEGY_XPATH = '//*[@id="algoPolicyresult-table"]'
    DEFAULT_RESULT_TAB_STRATEGY_TYPE_XPATH = '//*[@id="scenarioresult-table"]'
    DEFAULT_RESULT_TAB_SOR_EXECUTION_STRATEGY_XPATH = '//*[@id="SORAlgoPolicyresult-table"]'
    DEFAULT_RESULT_TAB_VENUE_XPATH = '//*[@id="resultVenueresult-table"]'
    DEFAULT_RESULT_TAB_ROUTE_XPATH = '//*[@id="routeresult-table"]'
