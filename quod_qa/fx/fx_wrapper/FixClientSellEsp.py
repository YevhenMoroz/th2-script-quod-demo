...
class FixClientSellEsp():
    ...
    def send_md_request(self, event_name_custom=''):
        ...
        self.subscribe = self.fix_act.placeMarketDataRequestFIX(
            bca.convert_to_request(
                ...
                bca.message_to_grpc('MarketDataRequest', self.case_params_sell_esp.md_params,
                                    self.case_params_sell_esp.connectivityESP)
            ))
        return self
    ...
    def send_new_order_single(self, price, qty=''):
        ...
        self.new_order = self.fix_act.placeOrderFIX(
            request=bca.convert_to_request(
                ...
                bca.message_to_grpc('NewOrderSingle', self.case_params_sell_esp.order_params,
                                    self.case_params_sell_esp.connectivityESP)
            ))
        return self
    ...
    def send_new_order_single_timeout(self, price):
        ...
        self.new_order = self.fix_act.placeOrderFIX(
            request=bca.convert_to_request(
                'Send new order ' + tif, self.case_params_sell_esp.connectivityESP, self.case_params_sell_esp.case_id,
                bca.message_to_grpc('NewOrderSingle', self.case_params_sell_esp.order_params,
                                    self.case_params_sell_esp.connectivityESP), 5
            ))
        return self
    ...
    def verify_md_pending(self):
        ...
        self.md_pending_response = self.verifier.submitCheckRule(
            bca.create_check_rule(
                ...
                bca.filter_to_grpc('MarketDataSnapshotFullRefresh', self.case_params_sell_esp.md_subscribe_response,
                                   ['MDReqID']),
    ...
    def verify_md_rejected(self, text, reason=''):
        ...
        self.verifier.submitCheckRule(
            bca.create_check_rule(
                ...
                bca.filter_to_grpc('MarketDataRequestReject', self.case_params_sell_esp.md_reject_response,
                                   ['MDReqID']),
                self.subscribe.checkpoint_id,
                self.case_params_sell_esp.connectivityESP,
                self.case_params_sell_esp.case_id
    ...
    def verify_order_pending(self, price='', qty=''):
        ...
        self.case_params_sell_esp.order_pending['OrderID'] = self.new_order.response_messages_list[0].fields[
            'OrderID'].simple_value
        self.checkpoint = self.new_order.checkpoint_id
        self.verifier.submitCheckRule(
            request=bca.create_check_rule(
                'Execution Report with OrdStatus = Pending',
                bca.filter_to_grpc('ExecutionReport', self.case_params_sell_esp.order_pending,
                                   ['ClOrdID', 'OrdStatus']),
    ...
    def verify_order_new(self):
        ...
        self.case_params_sell_esp.order_new['OrderID'] = self.new_order.response_messages_list[0].fields[
            'OrderID'].simple_value
        self.verifier.submitCheckRule(
            request=bca.create_check_rule(
    ...
    def verify_order_filled(self, price='', qty='', spot_s_d=''):
        ...
        self.case_params_sell_esp.order_filled['OrderID'] = self.new_order.response_messages_list[0].fields[
            'OrderID'].simple_value
        if spot_s_d != '':
    ...
    def verify_order_rejected(self, text='', price='', qty=''):
        ...
        self.case_params_sell_esp.order_rejected['OrderID'] = self.new_order.response_messages_list[0].fields[
            'OrderID'].simple_value
        ...
        self.verifier.submitCheckRule(
            request=bca.create_check_rule(
                ...
                bca.filter_to_grpc('ExecutionReport', self.case_params_sell_esp.order_rejected,
                                   ['ClOrdID', 'OrdStatus']),
                self.checkpoint, self.case_params_sell_esp.connectivityESP, self.case_params_sell_esp.case_id
            ),
            timeout=3000
    ...
    def verify_order_algo_rejected(self, text):
        ...
        self.verifier.submitCheckRule(
            request=bca.create_check_rule(
                'Execution Report with OrdStatus = Rejected',
                bca.filter_to_grpc('ExecutionReport', self.case_params_sell_esp.order_algo_rejected,
                                   ['ClOrdID', 'OrdStatus']),
                self.checkpoint, self.case_params_sell_esp.connectivityESP, self.case_params_sell_esp.case_id
            ),
            timeout=3000
