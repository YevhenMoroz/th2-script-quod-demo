...
def execute(report_id):
    ...
    try:
        ...
        FixClientSellEsp(CaseParamsSellEsp(client, case_id, symbol=symbol, securitytype=securitytype_fwd,
                                           settltype=settltype_mo1)).send_md_request().send_md_unsubscribe()
        ...
        params = CaseParamsSellEsp(client, case_id, settltype=settltype_mo1, symbol=symbol,
                                   securitytype=securitytype_fwd, securityidsource=securityidsource,
