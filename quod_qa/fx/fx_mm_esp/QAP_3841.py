...
def execute(report_id):
    ...
    try:
        ...
        params = CaseParamsSellEsp(client, case_id, side=side, orderqty=orderqty, ordtype=ordtype,
                                   ...
                                   settldate=settldate, symbol=symbol,
        ...
        text = '11734 \'TradeDate\' ({0}) is later than \'SettlDate\' ({1}) / 11697 No listing found for order with currency EUR on exchange QUODFX'. \
