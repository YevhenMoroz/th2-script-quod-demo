...
def get_dealing_positions_details(del_act, base_request, symbol, account):
    ...
    position = ExtractionPositionsFieldsDetails("dealingpositions.position", "Daily MTM Quote Position")
...
def compare_position(case_id, pos_before, position, pos_after):
    ...
    verifier.compare_values("Daily MTM Quote Position", str(round(expected_pos, 2)), str(pos_after))
