...
def execute(report_id, session_id):
    ...
    try:
        ...
        quote_book.set_filter(["BidSize", "2000000"]).check_quote_book_fields_list({"Bid Px": "1.181161"})

        quote_request_book = FXQuoteRequestBook(case_id, case_base_request)
        quote_request_book.set_filter(["Qty", "2000000"]).check_quote_book_fields_list({"User":"ostronov", "Status": "Terminated"})
