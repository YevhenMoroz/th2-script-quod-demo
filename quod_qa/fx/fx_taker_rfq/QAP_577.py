...
def check_value_pts_dist(base_request, service, case_id, venue):
    extract_value = ExtractRFQTileValues(details=base_request)
    extraction_id = bca.client_orderid(4)
    extract_value.set_extraction_id(extraction_id)
    ...
    verifier.compare_values("Pts", extracted_bid, extracted_pts)
...
def execute(report_id):
    ...
    try:
        ...
        # Step 2
        check_date(base_rfq_details, ar_service, case_id, date_1m)
        # Step 3
        # TODO Add check countdown
        # Step 4
        check_value_in_tob(base_rfq_details, ar_service, case_id)
        # Step 5-6
        check_value_pts_dist(base_rfq_details, ar_service, case_id, case_venue)
        # Step 7
