...
def modify_order(base_request, service, near_qty, far_qty, cur1, cur2, near_tenor, far_tenor, client, venues):
...
def check_order_book(ex_id, base_request, instr_type, act_ob, case_id, near_leg_qty, far_leg_qty):
    ob = OrdersDetails()
...
def execute(report_id):
    ...
    try:
        ...
        modify_order(base_rfq_details, ar_service, case_qty,case_qty2,  case_from_currency, case_to_currency,
