...
def modify_order_swap(base_request, service, near_qty, cur1, cur2, near_tenor, far_tenor, client, venues):
...
def execute(report_id):
    ...
    try:
        ...
        modify_order_swap(base_rfq_details, ar_service, case_qty, case_from_currency, case_to_currency,
