...
def modify_order(base_request, service, cur1, cur2, near_tenor, far_tenor, client):
...
def execute(report_id):
    ...
    try:
        ...
        modify_order(base_rfq_details, ar_service, case_from_currency, case_to_currency,
