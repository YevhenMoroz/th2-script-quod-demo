...
def execute(report_id):
    ...
    try:
        ...
        modify_rfq_tile(base_rfq_details_0, ar_service, case_qty, case_currency_eur,
                        case_currency_usd, case_near_tenor, case_client, venues_hsb)
        modify_rfq_tile(base_rfq_details_1, ar_service, case_qty, case_currency_usd,
                        case_currency_cad, case_near_tenor, case_client, venues_cit)
        # Step 2
        ...
        quote_hsbcr = check_order_book("OB_0", case_base_request, case_instr_type, ob_act, case_id,
                                       case_qty, case_venue_hsbcr)
        quote_citir = check_order_book("OB_1", case_base_request, case_instr_type, ob_act, case_id,
        ...
        quote_hsbcr = check_order_book("OB_2", case_base_request, case_instr_type, ob_act, case_id,
                                       case_qty, case_venue_hsbcr)
        quote_citir = check_order_book("OB_3", case_base_request, case_instr_type, ob_act, case_id,
                                       case_qty, case_venue_citir)
