...
def execute(session_id, report_id):
    ...
    verify_order_value(base_request, case_id, "GatingRuleName", "QAP-4288(Gr_for_Care)", False)
    verify_order_value(base_request, case_id, "GatingRuleCondName", "CareDefResult", False)
    # endregion
