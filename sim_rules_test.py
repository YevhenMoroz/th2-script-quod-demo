...
# OCRR = simulator.createQuodOCRRRule(request=quod_simulator_pb2_grpc_simulator_pb2.TemplateQuodOCRRRule(connection_id=infra_pb2.ConnectionID(session_alias='kch-qa-ret-child')))
# stop rule
