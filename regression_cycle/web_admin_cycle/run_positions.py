...
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3469 import QAP_T3469
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3470 import QAP_T3470
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3478 import QAP_T3478
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3479 import QAP_T3479
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3486 import QAP_T3486
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3493 import QAP_T3493
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T3495 import QAP_T3495
...
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T7797 import QAP_T7797
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T8645 import QAP_T8645
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T8646 import QAP_T8646
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T8899 import QAP_T8899
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T8997 import QAP_T8997
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T10720 import QAP_T10720
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T10721 import QAP_T10721
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T10723 import QAP_T10723
from test_cases.web_admin.web_admin_test_cases.positions.QAP_T11176 import QAP_T11176
...
class RunPositions:
    ...
    def execute(self):
        try:
            configuration = WebAdminComponentConfiguration("WA_Positions")  # look at xml (component name="web_admin_general")
            ...
            QAP_T3430(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T3478(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment, db_manager=self.db_manager).run()
            QAP_T3479(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment, db_manager=self.db_manager).run()
            QAP_T3486(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T3495(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            ...
            QAP_T7796(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T7797(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment, db_manager=self.db_manager).run()
            QAP_T8645(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T8646(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T8899(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                      environment=configuration.environment).run()
            QAP_T10720(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                       environment=configuration.environment).run()
            QAP_T10721(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                       environment=configuration.environment, db_manager=self.db_manager).run()
            QAP_T10723(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                       environment=configuration.environment, db_manager=self.db_manager).run()
            QAP_T11176(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                       environment=configuration.environment, db_manager=self.db_manager).run()
            ...
            #           environment=configuration.environment).run()
            # QAP_T3469(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
            #           environment=configuration.environment, db_manager=self.db_manager).run()
            ...
            #           environment=configuration.environment, db_manager=self.db_manager).run()
            # QAP_T8997(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
            #           environment=configuration.environment, db_manager=self.db_manager).run()
