...
from test_cases.web_admin.web_admin_test_cases.middle_office.QAP_3143 import QAP_3143
...
class RunMiddleOffice:
    ...
    def execute(self):
        try:
            ...
            QAP_3143(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                     environment=configuration.environment).run()
