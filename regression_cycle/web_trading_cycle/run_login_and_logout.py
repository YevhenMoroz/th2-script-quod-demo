...
from test_cases.web_trading.test_cases.pages.login_and_logout.QAP_6524 import QAP_6524
...
from test_cases.web_trading.test_cases.pages.login_and_logout.QAP_6648 import QAP_6648
...
class RunLoginAndLogout:
    ...
    def execute(self):
        try:
            ...
            #          environment=configuration.environment).run()
            QAP_6524(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
                     environment=configuration.environment).run()
