...
class RunAccountSummary:
    def __init__(self, root_report_id):
        self.second_lvl_id = bca.create_event("WebTrading_Account_Summary", root_report_id)
        self.web_driver_container = None

    def execute(self):
        try:
            start_time = time.monotonic()
            configuration = ComponentConfiguration("WebTrading_Account_Summary")
            ...
            print("Run Account Summary ~execution time~ = " + str(timedelta(seconds=end_time - start_time)))
