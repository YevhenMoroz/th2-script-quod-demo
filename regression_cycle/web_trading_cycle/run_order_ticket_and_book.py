...
from test_cases.web_trading.test_cases.pages.main_page.workspace.order_ticket_and_book.QAP_6514 import QAP_6514
...
class RunOrderTicketAndBook:
    ...
    def execute(self):
        try:
            ...
            QAP_6514(self.web_driver_container, self.second_lvl_id, data_set=configuration.data_set,
