...
def test_run():
    try:
        ...
        report_id = bca.create_event('REDBURN autotests')
        ...
        redburn_exa_navigator_regression.test_run(parent_id=report_id, version=version)
