...
from test_cases.eq.Basket.QAP_T7202 import QAP_T7202
...
def test_run(parent_id=None, version='5.1.167.180'):
    ...
    try:
        ...
        QAP_T7332(report_id=report_id, session_id=session_id, data_set=data_set, environment=configuration.environment) \
            .execute()
        QAP_T7202(report_id=report_id, session_id=session_id, data_set=data_set, environment=configuration.environment) \
            .execute()
