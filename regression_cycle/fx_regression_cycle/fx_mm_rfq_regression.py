from test_cases.fx.fx_mm_rfq import QAP_T2962, QAP_T2940, QAP_T2939, QAP_T2931, QAP_T2930, QAP_T2929, QAP_T2910, \
    QAP_T2888, QAP_T2887, QAP_T2869, QAP_T2819, QAP_T2818, QAP_T2817, QAP_T2816, QAP_T2815, QAP_T2814, \
    QAP_T2732, QAP_T2731, QAP_T2969, QAP_T2906, QAP_T2886, QAP_T2885, QAP_T2880, QAP_T2863, \
    QAP_T2861, QAP_T2846, QAP_T2845, QAP_T2844, QAP_T2843, QAP_T2741, QAP_T2740, QAP_T2739, QAP_T2721, \
    QAP_2992, QAP_T2716, QAP_T2714, QAP_T2678, QAP_T2646, QAP_T2629, \
    QAP_T2538, QAP_4509, QAP_T2614, QAP_T2539, QAP_4748, QAP_T2715, QAP_T2481
...
def test_run(parent_id=None):
    ...
    try:
        ...
        QAP_6571(report_id, session_id, configuration.data_set, configuration.environment).execute()        # endregion
        ...
        QAP_T2978(report_id=report_id, session_id=session_id, data_set=configuration.data_set,
        ...
        QAP_T2929.execute(report_id)
        QAP_T2888.execute(report_id)
        QAP_T2887.execute(report_id)
        QAP_T2481.execute(report_id)
        ...
        QAP_T2970(report_id, session_id, configuration.data_set, configuration.environment).execute()
        ...
        QAP_T2930.execute(report_id, case_params, session_id)
        QAP_T2905(report_id, session_id, configuration.data_set, configuration.environment).execute()
        QAP_T2869.execute(report_id, case_params, session_id)
        QAP_T2910.execute(report_id, session_id)
        QAP_T2906.execute(report_id, session_id)

        QAP_T2885.execute(report_id, session_id)
        QAP_T2880.execute(report_id, session_id)
        ...
        QAP_T2741.execute(report_id, session_id)
        QAP_T2740.execute(report_id, session_id)
        QAP_T2739.execute(report_id, session_id)
        ...
        QAP_T2646.execute(report_id, session_id)
