...
def test_run(parent_id=None, version=None):
    ...
    try:
        ...
        # region FIX test
        QAP_T2375(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2386(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2406(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2411(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2413(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2426(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2430(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2431(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2432(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2433(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2434(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2437(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2438(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2451(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2453(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2456(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2457(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2458(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2459(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2460(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2462(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2464(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2479(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2518(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2543(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2561(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2562(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2578(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2602(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2605(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2615(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2619(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2622(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2650(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2652(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2684(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2722(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2736(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2742(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2745(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2758(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2768(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2832(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2883(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2889(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2890(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2891(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2892(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2893(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2894(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2895(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2896(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2897(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2915(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2916(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2917(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2919(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2920(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2921(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2926(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2953(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2955(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2956(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2957(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2968(report_id, configuration.data_set, configuration.environment).execute()
        QAP_T2983(report_id, configuration.data_set, configuration.environment).execute()
