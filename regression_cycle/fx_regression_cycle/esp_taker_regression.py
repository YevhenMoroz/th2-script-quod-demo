...
from test_cases.fx.fx_taker_esp.QAP_T2453 import QAP_T2453
from test_cases.fx.fx_taker_esp.QAP_T2456 import QAP_T2456
from test_cases.fx.fx_taker_esp.QAP_T2477 import QAP_T2477
...
def test_run(parent_id=None, version=None):
    ...
    # QAP_T2487.execute(report_id, data_set, environment)
    # QAP_T2488.execute(report_id, data_set, environment)
    # QAP_T2489.execute(report_id, data_set, environment)
    # QAP_T2496.execute(report_id, data_set, environment)
    # QAP_T2498.execute(report_id)
    ...
    QAP_T2453(report_id=report_id, data_set=data_set, environment=environment).execute()
    QAP_T2456(report_id=report_id, data_set=data_set, environment=environment).execute()
    QAP_T2477(report_id=report_id, data_set=data_set, environment=environment).execute()
    ...
    QAP_T2624(report_id=report_id, data_set=data_set, environment=environment).execute()
    ...
    QAP_T3104(report_id=report_id, data_set=data_set, environment=environment).execute()
    QAP_T3107(report_id=report_id, data_set=data_set, environment=environment).execute()
    ...
    QAP_T8666(report_id=report_id, data_set=data_set, environment=environment).execute()
