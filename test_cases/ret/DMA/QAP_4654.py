...
def amend_order(base_request, pos_validity):
...
def execute(session_id, report_id):
    ...
    amend_order(base_request, pos_validity="BTST")
    # end region

    # region Extract and Verify Position Validity field after amend step 5
    new_pos_validity = extract_parent_order_details(base_request, column_name="PosValidity", extraction_id="PosVal")
    verifier(case_id, event_name="Check Position Validity after amend", expected_value="BTST",
             actual_value=new_pos_validity)
    # end region
