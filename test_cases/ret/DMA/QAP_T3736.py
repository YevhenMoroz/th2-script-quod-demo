...
from test_framework.old_wrappers.ret_wrappers import extract_parent_order_details, verifier, amend_negative_ex, get_order_id, \
    extract_error_message_order_ticket, try_except
...
def execute(session_id, report_id):
    ...
    create_order(base_request, lookup, client, price, order_type="Limit", qty="1300", tif="Day", side="Sell")
    # end region

    # region Extract and Verify order status step 3
    ...
    order_status = extract_parent_order_details(base_request, column_name="Sts", extraction_id="Sts", order_id=order_id)
    verifier(case_id, event_name="Check order Status after execution", expected_value="Filled",
