...
def execute(report_id):
    ...
    # region Set Test_Location(id=6) - step 2
    ...
    # region Set Test_Desk(id=6) - step 3
    modify_params_user_desk = {
        "userConfirmFollowUp": "false",
        "userID": "user_desk",
        "userEmail": "q",
        "clientUserID": "QAP-5444",
    ...
    api_message_tested_user.modify_user(modify_params_user_desk)
    api_manager_tested_user.send_post_request(api_message_site_adm)
    # endregion
