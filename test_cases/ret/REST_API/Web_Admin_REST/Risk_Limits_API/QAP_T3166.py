...
class QAP_T3166(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.rules_name = ['QAP_7908_api_0',
                           'QAP_7908_api_1',
                           'QAP_7908_api_2',
                           'QAP_7908_api_3']
    ...
    def run_pre_conditions_and_steps(self):
        # region step 1, create risk limit dimension rule with: Client, Desk, Listing and Instrument Type
        parameters_step_1 = {
        ...
        # region step 2, create risk limit dimension rule with: Client, Desk, Trading Phase and Instrument
        parameters_step_2 = {
        ...
        # region step 3, create risk limit dimension rule with: Client, Desk, Listing and Side
        parameters_step_3 = {
        ...
        # region step 4, create risk limit dimension rule with: Client, Desk, Route and Execution Policy
        parameters_step_4 = {
