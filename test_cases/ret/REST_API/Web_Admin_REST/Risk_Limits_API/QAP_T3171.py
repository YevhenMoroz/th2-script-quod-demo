...
class QAP_T3171(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.rules_name = ['QAP_7903_api_0',
                           'QAP_7903_api_1',
                           'QAP_7903_api_2',
                           'QAP_7903_api_3',
                           'QAP_7903_api_4',
    ...
    def run_pre_conditions_and_steps(self):
        # region step 1, create risk limit dimension rule with: Account, User, Venue and Instrument Type
        parameters_step_1 = {
        ...
        # region step 2, create risk limit dimension rule with: Route, Execution Policy, Venue, Instrument Type
        parameters_step_2 = {
        ...
        # region step 3, create risk limit dimension rule with: Route, User, Venue, Side
        parameters_step_3 = {
        ...
        # region step 4, create risk limit dimension rule with: Account, User, Venue, Side
        parameters_step_4 = {
        ...
        # region step 5, create risk limit dimension rule with: Account, Execution Policy, Venue, Instrument Type
        parameters_step_5 = {
        ...
        # region step 6, create risk limit dimension rule with: Venue, Trading Phase, Instrument Type, Side
        parameters_step_6 = {
