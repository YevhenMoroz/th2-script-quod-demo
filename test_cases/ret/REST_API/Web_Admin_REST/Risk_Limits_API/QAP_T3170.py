...
class QAP_T3170(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.rules_name = ['QAP_7904_api_0',
                           'QAP_7904_api_1',
                           'QAP_7904_api_2',
                           'QAP_7904_api_3']
    ...
    def run_pre_conditions_and_steps(self):
        # region step 1, create risk limit dimension rule with: Account, Desk, Venue and Instrument Type
        parameters_step_1 = {
        ...
        # region step 2, create risk limit dimension rule with: Route, Desk, Venue, Side
        parameters_step_2 = {
        ...
        # region step 3, create risk limit dimension rule with: Account, Desk, Venue, Execution Policy
        parameters_step_3 = {
        ...
        # region step 4, create risk limit dimension rule with: Venue, Desk, Trading Phase, Execution Policy
        parameters_step_4 = {
