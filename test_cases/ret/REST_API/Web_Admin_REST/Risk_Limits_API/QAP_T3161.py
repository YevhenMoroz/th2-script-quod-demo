...
class QAP_T3161(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.rules_name = ['QAP_7913_api_0',
                           'QAP_7913_api_1',
                           'QAP_7913_api_2',
                           'QAP_7913_api_3',
                           'QAP_7913_api_4']
    ...
    def run_pre_conditions_and_steps(self):
        # region step 1, create risk limit dimension rule with: Client, User, Sub Venue and Instrument Type
        parameters_step_1 = {
        ...
        # region step 2, create risk limit dimension rule with: Client, User, Sub Venue and Route
        parameters_step_2 = {
        ...
        # region step 3, create risk limit dimension rule with: Client, User, Sub Venue and Execution Policy
        parameters_step_3 = {
        ...
        # region step 4, create risk limit dimension rule with: Client, User, Sub Venue and Trading Phase
        parameters_step_4 = {
        ...
        # region step 5, create risk limit dimension rule with: Client, User, Sub Venue and Side
        parameters_step_5 = {
