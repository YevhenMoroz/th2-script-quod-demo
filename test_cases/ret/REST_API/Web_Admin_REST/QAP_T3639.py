...
def execute(report_id):
    ...
    create_params = {
        ...
        "accountGroupName": "test_api_client_5396",
        "accountMgrDeskID": 1,
        "clientAccountGroupID": "test_api_client_5396",
        "accountGroupID": "test_api_client_5396",
        "accountType": "HT",
        "accountScheme": "S",
        "transactionType": "C",
        "discloseExec": "M",
    ...
    new_client_status = api_manager.get_response_details(response=api_manager.send_get_request(api_message),
                                                         response_name="AccountGroupResponse",
                                                         expected_entity_name="test_api_client_5396",
