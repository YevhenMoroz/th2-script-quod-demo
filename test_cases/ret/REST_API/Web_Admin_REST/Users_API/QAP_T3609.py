...
class QAP_T3609(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.error_message_step2 = "Request fails: code=QUOD-32533:Request not allowed:" \
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region step 2, Check that user with hierarchical level - Site can not set 4 hierarchical assignment at time
        ...
        user_response_step2 = self.wa_api_manager_site.parse_response_error_message_details(
            response=self.wa_api_manager_site.send_multiple_request(self.user_message))
        data_validation(test_id=self.test_id,
                        event_name="Check that user with hierarchical level - Site"
