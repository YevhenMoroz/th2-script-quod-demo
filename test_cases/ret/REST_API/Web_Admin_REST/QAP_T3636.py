...
def execute(report_id):
    ...
    create_params = {
        "accountGroupName": "test_api_client_5402",
        "clientAccountGroupID": "test_api_client_5402",
        "accountGroupID": "test_api_client_5402",
        "accountType": "HT",
        "accountScheme": "S",
        "transactionType": "C",
        "discloseExec": "M",
    ...
    new_client_status = api_manager.get_response_details(response=api_manager.send_get_request(api_message),
                                                         ...
                                                         expected_entity_name="test_api_client_5402",
    ...
    verifier(case_id=case_id,
             ...
             expected_value="test_api_client_5400",
    ...
    verifier(case_id=case_id,
             ...
             expected_value="5",
             actual_value=user_hierarchy["deskUserRole"].list_value.values[0].message_value.fields["deskID"].simple_value)
    ...
    modify_client_step3 = {
        ...
        "accountGroupName": "client_api_test_5402",
        "accountMgrDeskID": 5,
        "clientAccountGroupID": "client_api_test_5402",
        "accountGroupID": "client_api_test_5402",
        "accountType": "HT",
        "accountScheme": "S",
        "transactionType": "C",
        "discloseExec": "M",
