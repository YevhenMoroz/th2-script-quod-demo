...
def execute(report_id):
    ...
    create_params = {
        "accountGroupName": "test_api_client_5391",
        "clientAccountGroupID": "test_api_client_5391",
        "accountGroupID": "test_api_client_5391",
        "accountType": "HT",
        "accountScheme": "S",
        "transactionType": "C",
        "discloseExec": "M",
    ...
    new_client_status = api_manager.get_response_details(response=api_manager.send_get_request(api_message),
                                                         ...
                                                         expected_entity_name="test_api_client_5391",
    ...
    user_account_group = api_manager.get_response_details(response=api_manager.send_get_request(api_message),
                                                          ...
                                                          expected_entity_name="user_zone",
                                                          entity_field_id="userID")

    verifier(case_id=case_id,
             event_name="Check userRolesAccountGroup",
             expected_value="test_api_client_5391",
    ...
    verifier(case_id=case_id,
             ...
             expected_value="3",
             actual_value=user_hierarchy["institutionID"].simple_value)
    ...
    modify_client_step3 = {
        ...
        "accountGroupName": "client_api_test_5391",
        "accountMgrDeskID": 5,
        "clientAccountGroupID": "client_api_test_5391",
        "accountGroupID": "client_api_test_5391",
        "accountType": "HT",
        "accountScheme": "S",
        "transactionType": "C",
        "discloseExec": "M",
    ...
    #     verifier(case_id=case_id,
    #              event_name=f"Check Client '{client}' after send GET request",
    #              expected_value="true",
    #              actual_value=value)
