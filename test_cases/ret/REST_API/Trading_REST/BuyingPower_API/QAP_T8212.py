...
class QAP_T8212(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        # region check BuyingPower updating upon order modification, Decrease Qty and Increase Price
        ...
        if 'ExecType' in nos_response.keys() and nos_response['ExecType'] == 'Open':
            ...
            if 'ExecType' in modified_response.keys() and modified_response['ExecType'] == 'Replaced':
                ...
                booked_amount_validation(test_id=self.test_id,
                                         event_name='Booked Amount upon order Modification.'
                                                    f'Decrease Qty to {self.qty} and Increase Price to {self.price}',
