    ...
    def run_pre_conditions_and_steps(self):
        ...
        if 'ExecType' in nos_response.keys() and nos_response['ExecType'] == 'Open':
            ...
            if 'ExecType' in modified_response.keys() and modified_response['ExecType'] == 'Replaced':
                ...
                booked_amount_validation(test_id=self.test_id, booked_amount_current=booked_amount_after_modification_decrease[0],
                ...
                bca.create_event(f"Modification response wasn't received,"
                                 f" (decrease  price to {self.price} and Qty to {self.qty})",
                                 status="FAILED",
