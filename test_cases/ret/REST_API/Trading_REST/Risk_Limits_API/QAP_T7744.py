...
class QAP_T7744(TestCase):
    def __init__(self, report_id, data_set: BaseDataSet, environment):
        ...
        self.error_message = "11824 &apos;Calculated CumOrdAmt&apos; (200) greater than MaxCumOrdAmt (1000000)"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.nos_message.change_parameter_in_component(component_name='PreTradeAllocations',
                                                       fields={'AllocQty': 100})
        self.nos_message.change_parameter(parameter_name='Price', new_parameter_value=3000)
        self.nos_message.change_parameter_in_component(component_name='PreTradeAllocations',
