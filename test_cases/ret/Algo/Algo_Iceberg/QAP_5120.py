...
from test_framework.old_wrappers.ret_wrappers import verifier, extract_error_message_order_ticket
...
def execute(session_id, report_id):
    ...
    display_qty = "0"
    lookup = "T55FD"
    expected_result = "Error - [QUOD-11603] 'DisplayQty' (0) negative or zero"
    # end region
    ...
    # region Extract and verify error message
