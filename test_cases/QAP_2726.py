...
def execute(report_id):
    ...
    try:
        ...
        main_order_details.set_filter(["Owner", Stubs.custom_config['qf_trading_fe_user_305']])
        ...
        main_order_exec_pcy = ExtractionDetail("main_order.ExecPcy", "ExecPcy")
        main_order_extraction_action = ExtractionAction.create_extraction_action(extraction_detail=main_order_exec_pcy)
        main_order_info = OrderInfo.create(action=main_order_extraction_action, sub_order_details=sub_order_details)
        ...
        open_app_req.set_work_dir(work_dir)
