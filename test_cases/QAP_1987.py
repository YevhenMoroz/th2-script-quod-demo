...
def execute(report_id):
    ...
    NOS_1 = simulator.createQuodNOSRule(request=TemplateQuodNOSRule(connection_id=conn1))
    NOS_2 = simulator.createQuodNOSRule(request=TemplateQuodNOSRule(connection_id=conn2))
    OCRR_1 = simulator.createQuodOCRRRule(request=TemplateQuodOCRRRule(connection_id=conn1))
    OCRR_2 = simulator.createQuodOCRRRule(request=TemplateQuodOCRRRule(connection_id=conn2))
    OCR_1 = simulator.createQuodOCRRule(request=TemplateQuodOCRRule(connection_id=conn1))
    OCR_2 = simulator.createQuodOCRRule(request=TemplateQuodOCRRule(connection_id=conn2))
