...
def execute(report_id):
    ...
    try:
        ...
        main_order_details.set_filter(["ClOrdID", dma_buy_order_params['ClOrdID']])
        ...
        allocations_details.add_allocation_param({"Account": "MOClient2SA1",
                                                  "Alloc Qty": dma_buy_order_params['OrderQty']})
        ...
        block_order_match_status = ExtractionDetail("middleOffice.matchStatus", "Match Status")
        block_order_summary_status = ExtractionDetail("middleOffice.summaryStatus", "Summary Status")
        extract_request_allocate.add_extraction_details([block_order_status, block_order_match_status,
                                                         block_order_summary_status])
        request_allocate = call(middle_office_service_allocate.extractMiddleOfficeBlotterValues,
        ...
        verifier.compare_values("Allocation Account ID", "MOClient2SA1",
