...
def execute(report_id):
    ...
    try:
        ...
        extract_request.set_allocations_filter({"Account ID": "MOClient3SA1"})
        ...
        verifier.compare_values("Allocation Account ID", "MOClient3SA1", request_allocate_blotter[allocate_account_id.name])
