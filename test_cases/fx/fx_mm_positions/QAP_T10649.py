...
class QAP_T10649(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.trade_request_3 = TradeEntryRequestFX()
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.trade_request_1.update_fields_in_component("TradeEntryRequestBlock", {"AccountGroupID": self.client,
        ...
        self.sleep(5)
        self.trade_request_2.set_params_for_fwd()
        self.trade_request_2.update_fields_in_component("TradeEntryRequestBlock", {"AccountGroupID": self.client,
        ...
        exec_id_fwd = self.trade_request_2.get_exec_id(response)
        self.sleep(5)
        self.trade_request_3.set_default_params()
        self.trade_request_3.update_fields_in_component("TradeEntryRequestBlock", {"AccountGroupID": self.client,
                                                                                   "ListingID": self.listing_eur_gbp})

        response: list = self.java_api_manager.send_message_and_receive_response(self.trade_request_3)
        exec_id_after = self.trade_request_3.get_exec_id(response)
        # endregion
        # region Step 2
    ...
    def run_post_conditions(self):
        ...
        self.maintenance_request_2.change_account(self.account)
        self.maintenance_request_2.change_client(self.client)
        self.maintenance_request_2.change_instrument(self.eur_gbp)
        self.java_api_manager.send_message(self.maintenance_request)
        self.sleep(5)
