...
class QAP_T10460(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.sec_type = self.data_set.get_security_type_by_name("fx_ndf")
        self.settle_date = self.data_set.get_settle_date_by_name("wk2_ndf")
        self.instrument = {
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.execution_report.add_tag({"LastForwardPoints": "*"})
        ...
        self.request_for_position.change_parameters({"Instrument": self.instrument_pos, "Currency": self.currency,
                                                     "Account": self.client, "SettlDate": self.settle_date})
