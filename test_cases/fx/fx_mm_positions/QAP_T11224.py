...
class QAP_T11224(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.pos_report_eur_gbp_new_mo = FixMessagePositionReportFX()
        self.pos_report_eur_gbp_new_exec = FixMessagePositionReportFX()
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.pos_report_eur_gbp_new_mo.set_params_for_all(self.request_for_position)
        self.pos_report_eur_gbp_new_mo.change_parameter("LastPositUpdateEventID", ordr_id)
        self.pos_report_eur_gbp_new_exec.set_params_for_all(self.request_for_position)
        self.pos_report_eur_gbp_new_exec.change_parameter("LastPositUpdateEventID", exec_id)
        self.fix_verifier.check_fix_message_sequence(
            fix_messages_list=[self.pos_report_gbp_cad,
                               ...
                               self.pos_report_eur_gbp_new_mo,
                               self.pos_report_eur_gbp_new_exec],
            key_parameters_list=[key_params, key_params, key_params, key_params, key_params, key_params],
            pre_filter=prefilter,
            message_name="Check that we receive 6 reports")
        # endregion
