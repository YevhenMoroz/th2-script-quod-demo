...
class QAP_T2809(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 2 Check Daily System MTM PnL
        ...
        self.position_verifier.check_daily_system_mtm_pnl_position(position_report, self.trade_request)
        self.sleep(1)
        self.request_for_position.set_unsubscribe()
        self.fix_manager.send_message(self.request_for_position)
        # endregion
        # region Step 3 Send sell order on 8M and check Daily System MTM PnL
        self.trade_request.set_default_params()
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client,
                                                       "ExecQty": self.qty_2,
        ...
        self.fix_manager.send_message(self.request_for_position)
        # endregion
        # region Step 5 Send sell order on 3M and check Daily System MTM PnL
        self.trade_request.set_default_params()
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client,
                                                       "ExecQty": self.qty_3,
