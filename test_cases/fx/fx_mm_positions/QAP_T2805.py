...
class QAP_T2805(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.sleep(5)
        # endregion
        # region Step 1 Send buy order on 6M and check Quote Position
        ...
        self.position_verifier.check_quote_position_default(position_report, self.trade_request)
        self.sleep(1)
        self.request_for_position.set_unsubscribe()
        self.fix_manager.send_message(self.request_for_position)
        # endregion

        # region Step 2 Send buy order on 2M and check Quote Position
        self.trade_request.set_default_params()
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client,
                                                       "ExecQty": self.qty_2})
        ...
        self.fix_manager.send_message(self.request_for_position)
        # endregion
        # region Step 3 Send sell order on 8M and check Quote Position
        self.trade_request.set_default_params()
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client,
                                                       "ExecQty": self.qty_3,
        ...
        self.fix_manager.send_message(self.request_for_position)
        # endregion
        # region Step 4 Send sell order on 3M and check Quote Position
        self.trade_request.set_default_params()
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client,
                                                       "ExecQty": self.qty_4,
