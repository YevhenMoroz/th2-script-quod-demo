...
class QAP_T2399(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_message.set_default_params().create_cross_venue_rates_cleansing_rule().set_target_venue(
            self.hsbc).set_symbol(self.gbp_usd)
        ...
        self.fix_md.change_parameter("NoMDEntries", self.wrong_md_entries_hsbc)
