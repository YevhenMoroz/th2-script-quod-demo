...
class QAP_T8143(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.md_req_id = f"{self.symbol}:{self.instr_type_wa}:REG:{self.hsbc}" + "_" + str(randint(100, 9999))
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_message.set_default_params().create_deviation_cleansing_rule().set_target_venue(self.hsbc). \
            clear_ref_venues().add_ref_venues(self.reference_venues).set_symbol(self.symbol).set_deviation("5")
