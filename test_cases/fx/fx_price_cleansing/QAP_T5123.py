...
class QAP_T5123(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.reference_venues = (self.venue_reference, self.venue_target)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_message.set_default_params().create_deviation_cleansing_rule().set_target_venue(self.venue_target). \
            clear_ref_venues().add_ref_venues(self.reference_venues).set_symbol(self.symbol)
