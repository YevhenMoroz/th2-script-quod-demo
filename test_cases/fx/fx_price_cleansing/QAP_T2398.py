...
class QAP_T2398(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.rest_message = RestApiPriceCleansingCrossedVenueRatesMessages(data_set=self.data_set)
        ...
        self.md_id_bnp = f"{self.gbp_aud}:{self.instr_type_wa_fwd}:WK1:{self.bnp}"
        self.md_id_bnp_a = f"{self.gbp_aud}:{self.instr_type_wa_fwd}:WK1:{self.bnp}" + "_" + str(randint(100, 9999))
        self.md_id_bnp_b = f"{self.gbp_aud}:{self.instr_type_wa_fwd}:WK1:{self.bnp}" + "_" + str(randint(100, 9999))
        self.md_id_bnp_c = f"{self.gbp_aud}:{self.instr_type_wa_fwd}:WK1:{self.bnp}" + "_" + str(randint(100, 9999))
        self.md_req_id = ''
        self.wrong_md_entries_bnp = [
            {
                "MDEntryType": "0",
                "MDEntryPx": 1.19118,
                "MDEntrySize": 1000000,
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.md_request.set_md_req_parameters_taker(). \
            change_parameters({'MDReqID': self.md_id_bnp_a}). \
        ...
        self.fix_md.change_parameter("NoMDEntries", self.wrong_md_entries_bnp)
