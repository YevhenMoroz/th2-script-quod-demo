...
class QAP_T5124(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_md_snapshot.change_parameters({"OrigMDArrivalTime": "*", "OrigMDTime": "*"})
        self.fix_md_snapshot.change_parameter("PriceCleansingReason", "5")
