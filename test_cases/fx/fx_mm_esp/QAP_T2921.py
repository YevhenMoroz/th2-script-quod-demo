...
class QAP_T2921(TestCase):
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.qty_list_additional = ['1000000', '2000000', '5000000', '10000000']
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_message.clear_message_params().modify_client_tier_instrument().set_params(
            self.params).set_sweepable_qty(self.qty_list_additional).set_published_false(['2000000'])
        self.rest_manager.send_post_request(self.rest_message)
        # endregion
