...
class QAP_T2915(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.rounded_mm_md_entry_px_0 = round(self.md_entry_px_0 * (1 - 0.00015), 5)
        self.mm_md_entry_px_1 = self.md_entry_px_1 * (1 + 0.0003)
        self.rounded_mm_md_entry_px_1 = round(ceil(self.mm_md_entry_px_1 * 10 ** 5) * 10 ** -5, 5)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.md_snapshot.update_repeating_group_by_index("NoMDEntries", 0, MDEntryPx=self.rounded_mm_md_entry_px_0)
        self.md_snapshot.update_repeating_group_by_index("NoMDEntries", 1, MDEntryPx=self.rounded_mm_md_entry_px_1)
