...
class QAP_T2843(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.aud_gbp = self.data_set.get_symbol_by_name('symbol_26')

        self.instr_for_ordr = {
            "Symbol": self.aud_gbp,
            "SecurityType": self.settle_type_spot,
            "Product": "4"}
        ...
        self.md_req_id = f"{self.aud_gbp}:SPO:REG:{self.hsbc}"
        self.no_md_entries = [
            {"MDEntryType": "0",
             "MDEntryPx": 1,
             "MDEntrySize": 1000000,
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.new_order_single.set_default().change_parameters(
            {"Account": self.palladium2, "Instrument": self.instr_for_ordr})
