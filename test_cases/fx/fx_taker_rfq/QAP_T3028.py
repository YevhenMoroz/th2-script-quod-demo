...
class QAP_T3028(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rfq_tile.crete_tile().modify_rfq_tile(from_cur=eur_currency, to_cur=usd_currency,
                                                   near_tenor=tenor_1m, far_tenor=tenor_2m,
                                                   near_qty=self.qty, client=client, single_venue=venue)
        ...
        # endregion
        # region Step 4
        self.rfq_tile.place_order(side=Side.buy.value, venue=venue)
