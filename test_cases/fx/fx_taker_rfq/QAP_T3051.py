...
from custom.tenor_settlement_date import tom_front_end
...
class QAP_T3051(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        tenor = self.data_set.get_tenor_by_name('tenor_tom')
        ...
        self.rfq_tile.crete_tile().modify_rfq_tile(from_cur=eur_currency, to_cur=usd_currency,
                                                   near_tenor=tenor, client=client)
        self.rfq_tile.check_date(near_date=tom_front_end())
        # endregion
        # region Step 2
        self.rfq_tile.modify_rfq_tile(far_tenor=tenor)
        self.rfq_tile.check_date(far_date=tom_front_end())
        # endregion
