...
from test_framework.win_gui_wrappers.fe_trading_constant import QuoteRequestBookColumns as qrb, \
    Status as st, QuoteStatus as qs, Side


class QAP_T3045(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rfq_tile.crete_tile().modify_rfq_tile(from_cur=eur_currency, to_cur=usd_currency, near_qty=self.qty,
                                                   near_tenor=near_tenor, client=client, single_venue=venue)
        # endregion
        # region Step 2
        ...
        # endregion
        # region Step 3
        self.rfq_tile.check_buttons(send_button='Stop')
