    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.order_book.set_filter(
            ...
            {ob.symbol.value: eur_usd_symbol,
             ...
             ob.currency.value: eur_currency,
             ob.side.value: self.side_buy,
             ob.ccy_side.value: self.side_buy}, 'Checking currency value in order book')
        # endregion
        # region Step 3
        ...
        self.order_book.set_filter(
            ...
            {ob.symbol.value: eur_usd_symbol,
             ob.sts.value: st.terminated.value,
             ob.exec_sts.value: ExecSts.filled.value,
             ob.currency.value: usd_currency,
             ob.side.value: self.side_sell,
             ob.ccy_side.value: self.side_buy}, 'Checking currency value in order book')
        # endregion
