...
class QAP_T9353(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.new_qty = "41000000"
        self.new_ah_qty = "6000000"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.trade_request.change_instrument(self.usd_php, self.instr_type_spo)
        response: list = self.java_api_manager.send_message_and_receive_response(self.trade_request)
        ord_id_new = self.trade_request.get_ah_ord_id(response)
        ...
        self.ah_order.set_default_sor_from_trade(self.trade_request)
        self.ah_order.change_parameters({"ClOrdID": ord_id_new, "Account": self.client_int,
                                         "SettlDate": self.settle_date, "OrderQty": self.new_ah_qty})
        self.ah_order.remove_parameters(["Misc0", "StrategyName"])
        self.sleep(5)
        self.fix_drop_copy_verifier.check_fix_message(self.ah_order, message_name="Check New AutoHedger Order",
                                                      key_parameters=["ClOrdID"])
        # endregion
