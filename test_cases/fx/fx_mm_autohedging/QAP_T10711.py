...
class QAP_T10711(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.exec_qty = "50000000"
        self.expected_qty_int = "0"
        self.expected_qty_backup = f"-{self.exec_qty}"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.position_verifier.check_base_position(internal_report, self.expected_qty_backup,
        ...
        self.position_verifier.check_quote_position_default(backup_report, self.trade_request)
        self.request_for_position_backup.set_unsubscribe()
        self.fix_manager.send_message(self.request_for_position_backup)
        self.sleep(1)
        # endregion
