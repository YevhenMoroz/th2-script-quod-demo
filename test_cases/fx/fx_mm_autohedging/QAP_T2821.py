...
class QAP_T2821(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock",
                                                      {"ClientAccountGroupID": self.client_int, "ExecQty": self.qty,
        ...
        ah_order_id = self.trade_request.get_ah_ord_id_int(response)
        # endregion

        # region Step 3
        self.ah_order.set_default_sor_from_trade(self.trade_request)
        self.ah_order.change_parameters({"Account": self.client_int, "ClOrdID": ah_order_id, "Side": "2"})
