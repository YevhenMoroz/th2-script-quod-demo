...
class QAP_T10292(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.ah_params_1 = self.rest_api_manager.send_get_request_filtered(self.rest_api_ah_msg_1)
        self.ah_params_1 = self.rest_api_manager.parse_response_details(self.ah_params_1,
                                                                        {"autoHedgerName": self.auto_hedger_name})
        for i in self.ah_params_1["autoHedgerInstrSymbol"]:
            if i["instrSymbol"] == 'EUR/GBP':
                i["sendHedgeOrders"] = "false"
        self.rest_api_ah_msg_1.clear_message_params().modify_auto_hedger().set_params(self.ah_params_1)
