...
class QAP_T10775(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.listing_gbp_usd = self.data_set.get_listing_id_by_name("gbp_usd_spo")
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.maintenance_request_ext.change_instrument(self.gbp_usd)
        ...
        self.maintenance_request_int.change_instrument(self.gbp_usd)
        ...
        self.trade_request.update_fields_in_component("TradeEntryRequestBlock", {"AccountGroupID": self.client_ext,
                                                                                 "ListingID": self.listing_gbp_usd,
        ...
        self.mo_order.change_parameter("OrdType", "1")
        self.mo_order.remove_parameter("Price")
        prefilter = {
            "header": {
                "MsgType": ("D", "EQUAL"),
                "TargetCompID": "QUOD8",
        ...
        key_params = ["Misc0"]
        self.fix_drop_copy_verifier.check_fix_message_sequence([self.mo_order],
                                                               key_parameters_list=[key_params],
                                                               pre_filter=prefilter,
                                                               message_name="Check that we create AH order")

        self.ah_exec_report.set_params_from_trade_mo(self.trade_request)
        ...
        self.position_report_int.change_parameter("LastPositUpdateEventID", ah_exec_id)
        self.fix_pos_verifier.check_fix_message(self.position_report_int,
