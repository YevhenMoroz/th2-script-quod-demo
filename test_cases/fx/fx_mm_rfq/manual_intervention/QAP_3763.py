...
class QAP_3763(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.user_column = QuoteRequestBookColumns.user.value
        self.expected_user = "gtwquod9"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dealer_intervention.set_list_filter(
            [self.client_column, self.client_argentina, self.user_column, self.expected_user]).assign_quote(1)
