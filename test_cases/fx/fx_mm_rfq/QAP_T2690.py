...
class QAP_T2690(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.expected_free_notes = "no available depth on EUR/USD SPO - manual intervention required"

        self.qty_1m = random_qty(1, 2, 7)
        self.qty_2m = random_qty(2, 3, 7)
        self.expected_qty = ""
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.quote_request.update_far_leg(leg_qty=self.qty_2m)
