...
from test_framework.win_gui_wrappers.fe_trading_constant import RFQPanelHeaderValues


class QAP_T2389(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.label = RFQPanelHeaderValues.party_value_label_control
        self.qty = "55000000"
        self.party = self.account + " / " + self.account
        self.instrument = {
            "Symbol": self.symbol,
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 3
        extracted_value = self.dealer_intervention.extract_header_part_from_di_panel(self.label)
        actual_party = extracted_value[self.label.value]
        # endregion
        # region Step 4
        self.dealer_intervention.compare_values(expected_value=self.party, actual_value=actual_party,
                                                event_name="Compare DI party values")
        # endregion
