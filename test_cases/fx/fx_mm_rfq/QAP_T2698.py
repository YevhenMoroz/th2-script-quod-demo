...
class QAP_T2698(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.quote_request.update_repeating_group_by_index(component="NoRelatedSymbols", index=0, Account=self.account,
                                                           Currency=self.usd, Instrument=self.instrument_spot,
                                                           OrderQty=self.qty)
        ...
        self.java_quote.set_params_for_quote_ccy2(self.quote_request, estimation_reply[0])
        ...
        new_order_single = FixMessageNewOrderSinglePrevQuotedFX().set_default_for_dealer_ccy2(self.quote_request,
                                                                                         quote_from_di)
        self.fix_manager_gtw.send_message_and_receive_response(new_order_single)
        execution_report = FixMessageExecutionReportPrevQuotedFX().set_params_from_new_order_single_ccy2(new_order_single)
