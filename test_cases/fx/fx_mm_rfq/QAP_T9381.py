...
class QAP_T9381(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.quote.get_parameter("NoLegs")[1]["InstrumentLeg"].update({"LegMaturityDate": "*"})
        ...
        self.execution_report.get_parameter("NoLegs")[1]["InstrumentLeg"].update({"LegMaturityDate": "*"})
        self.execution_report.change_parameter("SpotSettlDate", "*")
        self.execution_report.remove_parameter("SettlType")
