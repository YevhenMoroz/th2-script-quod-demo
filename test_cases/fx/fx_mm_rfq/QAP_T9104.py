...
class QAP_T9104(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        quote_from_di = self.fix_manager_sel.parse_response(self.quote_response)[0]
        # self.quote.remove_parameters(["OrigMDArrivalTime", "OrigMDTime", "OrigClientVenueID"])
        ...
        new_order_single = FixMessageNewOrderSinglePrevQuotedFX().set_default_for_dealer(self.quote_request,
                                                                                         quote_from_di)
        self.fix_manager_sel.send_message_and_receive_response(new_order_single)
