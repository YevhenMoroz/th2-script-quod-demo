...
class QAP_T8010(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.quote_request.update_repeating_group_by_index("NoRelatedSym", 0, OrderQty=self.qty)
        ...
        expected_list = ["N", "request exceeds quantity threshold for instrument over this client tier"]
