...
class QAP_T7967(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # endregion
        # region Step 3
        self.velocity_rule.clear_message_params().set_params(self.rest_message_params)
        self.velocity_rule.update_parameters({"blockedRule": "false"}).modify_limit()
        self.rest_manager.send_post_request(self.velocity_rule)
        self.sleep(3)
        # endregion
        # region Step 4
