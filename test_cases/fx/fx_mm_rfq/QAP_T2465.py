...
class QAP_T2465(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.modify_quoting_session.update_parameters({"updateInterval": 20000, "concurrentlyActiveQuoteAge": 5000})
        ...
        # region Step 5
        self.sleep(5)
        self.new_order_single.set_default_prev_quoted(self.quote_request, self.response[0], side="1",
                                                      price=self.offer_px_0)
