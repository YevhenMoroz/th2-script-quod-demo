...
class QAP_T11464(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.strategy = [
            {"StrategyParameterName": "ReleasedNbr", "StrategyParameterType": "1", "StrategyParameterValue": "2"},
            {"StrategyParameterName": "ReleasedQty", "StrategyParameterType": "6", "StrategyParameterValue": "1000000"}]
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.sleep(1)
        # region Step 1
        self.new_order.set_default_SOR().change_parameters(
            {"Currency": self.gbp, "Instrument": self.gbp_usd_spot})
        self.fix_manager.send_message_and_receive_response(self.new_order)
        # endregion
        # Region Step 2
        self.execution_report.set_params_from_new_order_single(self.new_order, status=Status.New)
        self.execution_report.add_tag(
            {"GatingRuleCondName": "First Main", "GatingRuleName": "Main Rule", "NoStrategyParameters": self.strategy,
             "LastMkt": "*"})
