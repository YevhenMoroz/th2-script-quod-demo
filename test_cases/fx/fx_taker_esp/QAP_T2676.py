...
class QAP_T2676(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.broken_settle_date = self.data_set.get_settle_date_by_name("broken_1")
        self.broken_settle_type = self.data_set.get_settle_type_by_name("broken")
        ...
        self.no_related_symbols = [{
            ...
            "SettlDate": self.broken_settle_date,
            "SettlType": self.broken_settle_type,
