...
class QAP_T11466(TestCase):
    ...
    {
        "gatingRulePriceOffset": "null",
        "recoveryDesk": [],
        "alive": "true",
        "qtyPrecision": "null",
        "gatingRuleResultAction": "EVA",
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.gating_rule.change_result_by_index(self.secondary_rule_result)
        self.gating_rule.modify_gating_rule()
        self.rest_manager.send_post_request(self.gating_rule)
        self.gating_rule.enable_gating_rule()
        self.rest_manager.send_post_request(self.gating_rule)
