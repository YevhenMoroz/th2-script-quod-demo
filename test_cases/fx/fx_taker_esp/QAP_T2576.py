...
class QAP_T2576(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.order_price_buy = "1.17"
        self.stop_price = "1.181"
        self.md_px1 = "1.1815"
        self.md_px2 = "1.1801"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 2
        self.md_snapshot.set_market_data()
        self.md_snapshot.update_repeating_group_by_index("NoMDEntries", 1, MDEntryPx=self.md_px2)
        self.md_snapshot.update_MDReqID(self.md_symbol, self.fix_env.feed_handler, "FX")
        self.fix_manager.send_message(self.md_snapshot, "Send MD to USD/SEK")
