...
def execute(report_id, session_id, data_set):
    ...
    try:
        ...
        # STEP 1
        new_order_sor = FixMessageNewOrderSingleAlgoFX(data_set = data_set).set_default_mo().change_parameters(
        ...
        FXOrderBook(case_id, session_id).set_filter(
            [ob_col.order_id.value, "AO", ob_col.qty.value, "10000000", ob_col.orig.value, "FIX", ob_col.lookup.value,
             "EUR/USD-SPO.SPO", ob_col.client_id.value, "TH2_Taker",
             ob_col.tif.value, tif.GTC.value]).check_order_fields_list(
            {ob_col.exec_sts.value: exe_sts.filled.value})
        FXOrderBook(case_id, session_id).set_filter(
            [ob_col.order_id.value, "AO", ob_col.qty.value, "10000000", ob_col.orig.value, "FIX", ob_col.lookup.value,
             "EUR/USD-SPO.SPO", ob_col.client_id.value, "TH2_Taker",
             ob_col.tif.value, tif.GTC.value]).check_second_lvl_fields_list(
            {ob_col.exec_sts.value: exe_sts.filled.value, ob_col.venue.value: "CITI",
             ob_col.limit_price.value: "1.18141",
             ob_col.qty.value: "1,000,000"}, row_number=1)
        FXOrderBook(case_id, session_id).set_filter(
            [ob_col.order_id.value, "AO", ob_col.qty.value, "10000000", ob_col.orig.value, "FIX", ob_col.lookup.value,
             "EUR/USD-SPO.SPO", ob_col.client_id.value, "TH2_Taker",
             ob_col.tif.value, tif.GTC.value]).check_second_lvl_fields_list(
            {ob_col.exec_sts.value: exe_sts.filled.value, ob_col.venue.value: "BARX",
             ob_col.limit_price.value: "1.18146",
             ob_col.qty.value: "4,000,000"}, row_number=2)
        FXOrderBook(case_id, session_id).set_filter(
            [ob_col.order_id.value, "AO", ob_col.qty.value, "10000000", ob_col.orig.value, "FIX", ob_col.lookup.value,
             "EUR/USD-SPO.SPO", ob_col.client_id.value, "TH2_Taker",
             ob_col.tif.value, tif.GTC.value]).check_second_lvl_fields_list(
            {ob_col.exec_sts.value: exe_sts.filled.value, ob_col.venue.value: "HSBC",
             ...
             ob_col.qty.value: "5,000,000"}, row_number=3)
    except Exception:
