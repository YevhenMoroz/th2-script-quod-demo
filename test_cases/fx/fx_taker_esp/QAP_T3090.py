...
class QAP_T3090(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        # region 2
        self.new_order_singe.set_default_SOR()
            # .update_repeating_group("NoStrategyParameters",
            #                         self.no_strategy_parameters)
        self.new_order_singe.change_parameters({"TimeInForce": "3"})
        ...
        self.new_order_singe.set_default_SOR()
            # .update_repeating_group("NoStrategyParameters",
            #                         self.no_strategy_parameters)
        self.new_order_singe.change_parameters({"TimeInForce": "4"})
        response = self.fix_manager.send_message_and_receive_response(self.new_order_singe)
        # endregion
        # region 3
        gateway_side_sell = GatewaySide.Sell
