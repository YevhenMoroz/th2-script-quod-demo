...
class QAP_T2668(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set: BaseDataSet = None, environment: FullEnvironment = None):
        ...
        self.update_db_1 = f"UPDATE INSTRUMENT SET eurusdintermediateinstrid = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_2 = f"UPDATE INSTRUMENT SET crossthrougheurtousd = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_3 = f"UPDATE INSTRUMENT SET crossthroughusdtoeur = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_4 = f"UPDATE INSTRUMENT SET eurmajorpairinstrid1 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_5 = f"UPDATE INSTRUMENT SET eurmajorpairinstrid2 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_6 = f"UPDATE INSTRUMENT SET eurdirectquotation1 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_7 = f"UPDATE INSTRUMENT SET eurdirectquotation2 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_8 = f"UPDATE INSTRUMENT SET usdmajorpairinstrid1 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_9 = f"UPDATE INSTRUMENT SET usdmajorpairinstrid2 = NULL " \
                           f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_10 = f"UPDATE INSTRUMENT SET usddirectquotation1 = NULL " \
                            f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        self.update_db_11 = f"UPDATE INSTRUMENT SET usddirectquotation2 = NULL " \
                            f"WHERE instrtype = 'SPO' AND instrsymbol = 'GBP/MYR';"
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        execute_db_command(self.update_db_1, self.update_db_2, self.update_db_3, self.update_db_4, self.update_db_5,
                           self.update_db_6, self.update_db_7, self.update_db_8, self.update_db_9, self.update_db_10,
                           self.update_db_11)
        # region Step 1-2
