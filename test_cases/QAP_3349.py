    ...
    try:
        ...
        extract_request.add_extraction_details(
            [block_order_id, block_id, block_order_status, block_order_match_status, block_order_summary_status,
             ...
             block_order_settl_date, block_order_pset, block_order_pset_bic, block_order_total_fees,
        ...
        verifier.compare_values("Order Total Fees", request_amend_ticket[total_fees], request[block_order_total_fees.name])
