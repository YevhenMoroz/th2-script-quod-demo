...
def execute_1():
    ...
    order_params_buys_side["Instrument"] = instrument_2
    ...
    er_params_buy_side = {
        ...
        "Text": "Hello sim",
        "LeavesQty": new_order_params['OrderQty'] - cum_qty,
        "TransactTime": "*",
        "OrderQty": new_order_params["OrderQty"],
        "OrdType": new_order_params["OrdType"],
        "ClOrdID": "*",
    ...
    print(f"Case {case_name} was executed in {str(round(datetime.now().timestamp() - seconds))} sec.")
