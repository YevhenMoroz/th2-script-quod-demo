...
class QAP_T11588(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        scheduler.enterabs(initial_slice, 1, self.fix_verifier_sell.set_case_id, kwargs=dict(case_id=case_id_1))
        ...
        scheduler.enterabs(random_uncross, 1, self.fix_manager_feed_handler.send_message, kwargs=dict(fix_message=self.incremental_refresh_1))
        # endregion
