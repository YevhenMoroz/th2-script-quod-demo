...
class QAP_T4466(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.auction_algo.update_fields_in_component("QuodFlatParameters", dict(MaxParticipation=self.percentage, WouldInAuction=1, WouldPriceReference='PRM', WouldPriceOffset=self.offset))
        ...
        self.would_order.change_parameters(dict(Account=self.account, ExDestination=self.mic, OrderQty=self.would_qty, Price=self.would_price, Instrument=self.instrument))
