...
class QAP_T4453(TestCase):
    ...
    def run_post_conditions(self):
        ...
        er_cancel_auction_order.add_tag(dict(SettlDate='*')).add_tag(dict(NoParty='*', SecAltIDGrp='*', Text='core order Rejected', LastMkt=self.mic)).change_parameters(dict(TimeInForce=2)).remove_parameters(["CxlQty", 'TargetStrategy', 'OrigClOrdID'])
