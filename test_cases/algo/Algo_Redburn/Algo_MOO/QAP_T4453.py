...
class QAP_T4453(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        reject_rule = rule_manager.add_NewOrderSingle_ExecutionReport_Reject(self.fix_env1.buy_side, self.account, self.mic, self.price)
        ...
        scheduler.enterabs(start_time, 1, self.fix_manager_feed_handler.send_message, kwargs=dict(fix_message=self.incremental_refresh_pre_open))
        ...
        er_rejected = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_order, self.gateway_side_buy, self.status_rejected).remove_parameters({'OrdRejReason', "Text"})
    ...
    def run_post_conditions(self):
        ...
        er_cancel_auction_order.change_parameters(dict(TimeInForce=self.tif_ato, Text='core order Rejected'))
