...
class QAP_T11010(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region
        case_id_3 = bca.create_event("Send trading phase - Open", self.test_id)
        ...
        seconds_to_check = AFM.calculate_how_many_sec_to_this_time(phases=trading_phases, phase=TradingPhases.Open, start_time=True)

        self.incremental_refresh_at_last = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_indicative().update_value_in_repeating_group('NoMDEntriesIR', 'MDEntrySize', self.indicative_volume).update_MDReqID(self.listing_id, self.fix_env1.feed_handler).set_phase(TradingPhases.Open)
    ...
    def run_post_conditions(self):
        ...
        er_cancel_auction_order.change_parameters(dict(TimeInForce=self.tif_ato, Text='reached uncross')).remove_parameter("LastMkt")
