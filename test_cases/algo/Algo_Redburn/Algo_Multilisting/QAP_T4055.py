...
class QAP_T4055(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [nos_passive_rule_xpar, ocr_rule_xpar]
        # endregion
        ...
        self.passive_child_order_par_1.change_parameters(dict(Account=self.account_xpar, OrderQty=self.qty, Price=self.price, Instrument='*', ExDestination=self.ex_destination_xpar))
        ...
        self.fix_verifier_buy.check_fix_message(pending_passive_child_order_par_1_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Pasiive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message(new_passive_child_order_par_1_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport New Pasiive Child DMA order')
        # endregion
    ...
    def run_post_conditions(self):
        ...
        cancel_passive_child_order_par_1_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.passive_child_order_par_1, self.gateway_side_buy, self.status_cancel)
        self.fix_verifier_buy.check_fix_message(cancel_passive_child_order_par_1_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport Eliminate Pasiive Child DMA 2 order')
