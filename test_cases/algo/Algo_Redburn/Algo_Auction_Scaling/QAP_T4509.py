...
class QAP_T4509(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.auction_algo.update_fields_in_component("QuodFlatParameters", dict(MaxParticipation=self.percentage_volume, PricePoint1Participation=self.pp1_percentage, PricePoint1Offset=self.pp1_offset, PricePoint2Participation=self.pp2_percentage, PricePoint2Price=self.pp2_price))
