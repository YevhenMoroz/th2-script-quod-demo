...
class QAP_T4498(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.pp2_reference = Reference.Manual.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.auction_algo.update_fields_in_component('QuodFlatParameters', dict(MaxParticipation=self.percentage_volume, PricePoint1Price=self.pp1_price, PricePoint1Participation=self.pp1_percentage, PricePoint2Reference=self.pp2_reference, PricePoint2Offset=self.pp2_offset, PricePoint2Participation=self.pp2_percentage))
        self.auction_algo.remove_fields_from_component('QuodFlatParameters', ['PricePoint2Price'])
