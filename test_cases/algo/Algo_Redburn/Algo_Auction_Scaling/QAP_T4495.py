...
class QAP_T4495(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.pp1_price = 120
        self.pp2_percentage = 11
        self.pp2_price = 117

        self.text_reject = FreeNotesReject.PricePoint2ParticipationMustBeEqualOrHigherThenPricePoint1Participation.value
