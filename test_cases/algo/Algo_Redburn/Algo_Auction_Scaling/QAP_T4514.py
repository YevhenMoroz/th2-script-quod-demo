...
class QAP_T4514(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text_reject = FreeNotesReject.PricePoint2ParticipationMustBeEqualOrHigherThenMaxParticipation.value
