...
class QAP_T10978(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        scaling_market_dma_child_order.change_parameters(dict(Account=self.account, OrderQty=self.scaling_child_order_qty, Price=self.scaling_child_order_price, Instrument='*', TimeInForce=self.tif_atc, OrdType=self.order_type_market, ExDestination=self.ex_destination_1))
