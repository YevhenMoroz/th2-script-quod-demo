...
class QAP_T4447(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.pp1_reference = Reference.LastTradePrice.value
        self.pp1_offset = 769
        self.pp2_percentage = 30
        self.pp2_reference = Reference.LastTradePrice.value
        self.pp2_offset = 1000

        self.pp1_price = AFM.calc_bps_offset_minus(self.last_trade_price, self.pp1_offset)
        self.pp2_price = AFM.calc_bps_offset_minus(self.last_trade_price, self.pp2_offset)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.auction_algo.update_fields_in_component('QuodFlatParameters', dict(MaxParticipation=self.percentage_volume, PricePoint1Participation=self.pp1_percentage, PricePoint1Reference=self.pp1_reference, PricePoint1Offset=self.pp1_offset, PricePoint2Participation=self.pp2_percentage, PricePoint2Reference=self.pp2_reference, PricePoint2Offset=self.pp2_offset))
        self.auction_algo.remove_fields_from_component('QuodFlatParameters', ['PricePoint1Price', 'PricePoint2Price'])
