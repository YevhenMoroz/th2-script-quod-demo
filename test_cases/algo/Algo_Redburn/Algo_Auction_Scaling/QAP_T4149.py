...
class QAP_T4149(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.indicative_volume_new = 17000
        ...
        self.scaling_child_order_qty = '%^([1-9]|1[0-4]|1236|[1,6,7]\d{2})$'  # fisrt number 111112, 23-37K and any 3 number
        ...
        self.s_par = self.data_set.get_listing_id_by_name("listing_37")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_rule_2 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.9)
        nos_rule_3 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.8)
        nos_rule_4 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.7)
        nos_rule_5 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.6)
        nos_rule_6 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.5)
        nos_rule_7 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.4)
        nos_rule_8 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.3)
        nos_rule_9 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.2)
        nos_rule_10 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119.1)
        nos_rule_11 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, 119)
        ...
        self.rule_list = [nos_rule_1, nos_rule_2, nos_rule_3, nos_rule_4, nos_rule_5, nos_rule_6, nos_rule_7, nos_rule_8, nos_rule_9, nos_rule_10, nos_rule_11, nos_rule_12, ocr_rule, ocrr_rule]
        # endregion
        ...
        end_time_minus_1_min = AFM.get_timestamp_from_list(phases=trading_phases, phase=TradingPhases.PreClosed, start_time=False) - 65
        end_time_for_phase_changing = AFM.get_timestamp_from_list(phases=trading_phases, phase=TradingPhases.PreClosed, start_time=False) + 10
        ...
        self.fix_verifier_buy_2.set_case_id(bca.create_event("Check 11 Scaling child orders Buy side NewOrderSingle", self.case_id_3))

        scheduler.enterabs(end_time_minus_1_min + 8, 1, self.fix_verifier_buy_2.check_fix_message_sequence, kwargs=dict(fix_messages_list=[scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.FromQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))

        self.fix_verifier_buy_2.set_case_id(bca.create_event("Check 11 Scaling child orders Buy Side Pending New", self.case_id_3))
        scheduler.enterabs(end_time_minus_1_min + 9, 1, self.fix_verifier_buy_2.check_fix_message_sequence, kwargs=dict(fix_messages_list=[pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.ToQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))

        self.fix_verifier_buy_2.set_case_id(bca.create_event("Check 11 Scaling child orders Buy Side New", self.case_id_3))
        scheduler.enterabs(end_time_minus_1_min + 10, 1, self.fix_verifier_buy_2.check_fix_message_sequence, kwargs=dict(fix_messages_list=[new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.ToQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))
        # endregion

        # region Update Indicative volume to 10000
        self.fix_verifier_buy_3 = FixVerifier(self.fix_env1.buy_side, self.test_id)

        self.fix_manager_feed_handler.set_case_id(case_id=bca.create_event("Send trading phase", self.test_id))
        self.incremental_refresh_pre_close = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_indicative().update_value_in_repeating_group('NoMDEntriesIR', 'MDEntrySize', self.indicative_volume).update_MDReqID(self.s_par, self.fix_env1.feed_handler).set_phase(TradingPhases.PreClosed)
        scheduler.enterabs(end_time_for_phase_changing + 3, 1, self.fix_manager_feed_handler.send_message, kwargs=dict(fix_message=self.incremental_refresh_pre_close))
        # endregion

        # region Check Scaling child orders after uncross
        self.case_id_3 = bca.create_event("Scaling child orders on after uncross", self.test_id)
        self.fix_verifier_buy_3.set_case_id(bca.create_event("Check 11 Scaling child orders Buy side NewOrderSingle", self.case_id_3))

        scheduler.enterabs(end_time_for_phase_changing + 3, 1, self.fix_verifier_buy_3.check_fix_message_sequence, kwargs=dict(fix_messages_list=[scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order, scaling_dma_child_order], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.FromQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))

        self.fix_verifier_buy_3.set_case_id(bca.create_event("Check 11 Scaling child orders Buy Side Pending New", self.case_id_3))
        scheduler.enterabs(end_time_for_phase_changing + 4, 1, self.fix_verifier_buy_3.check_fix_message_sequence, kwargs=dict(fix_messages_list=[pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params, pending_scaling_dma_child_order_params], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.ToQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))

        self.fix_verifier_buy_3.set_case_id(bca.create_event("Check 11 Scaling child orders Buy Side New", self.case_id_3))
        scheduler.enterabs(end_time_for_phase_changing + 5, 1, self.fix_verifier_buy_3.check_fix_message_sequence, kwargs=dict(fix_messages_list=[new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params, new_scaling_dma_child_order_params], key_parameters_list=[self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params, self.key_params], direction=self.ToQuod, pre_filter=self.data_set.get_pre_filter('pre_filer_equal_D'), check_order=self.check_order_sequence))
        # endregion

        # region Send CLO phase
        self.fix_manager_feed_handler.set_case_id(case_id=bca.create_event("Send trading phase", self.test_id))
        self.incremental_refresh_pre_close = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_indicative().update_MDReqID(self.s_par, self.fix_env1.feed_handler).set_phase(TradingPhases.Closed)
        scheduler.enterabs(end_time_for_phase_changing + 10, 1, self.fix_manager_feed_handler.send_message, kwargs=dict(fix_message=self.incremental_refresh_pre_close))
        # endregion
    ...
    def run_post_conditions(self):
        ...
        cancel_auction_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.auction_algo, self.gateway_side_sell, self.status_reached_uncross)
