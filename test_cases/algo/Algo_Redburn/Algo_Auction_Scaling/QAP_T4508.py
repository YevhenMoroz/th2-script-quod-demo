...
from test_framework.data_sets.constants import DirectionEnum, Status, GatewaySide, TradingPhases, FreeNotesReject, TimeInForce
...
class QAP_T4508(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text_reject = FreeNotesReject.MissPP2Reference.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.auction_algo.update_fields_in_component("QuodFlatParameters", dict(MaxParticipation=self.percentage_volume, PricePoint1Participation=self.pp1_percentage, PricePoint1Price=self.pp1_price, PricePoint2Participation=self.pp2_percentage, PricePoint2Offset=self.pp2_offset))
