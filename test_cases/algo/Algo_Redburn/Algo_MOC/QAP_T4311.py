...
def execute(report_id):
    try:
        ...
        moc_order.update_fields_in_component('QuodFlatParameters', dict(LimitPriceOffset=limit_price_offset))
        ...
        reject_moc_order_params.change_parameters(dict(Text=text_reject_limit_price_reference, TimeInForce=tif_atc))
