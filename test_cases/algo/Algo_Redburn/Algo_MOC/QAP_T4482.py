...
class QAP_T4482(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        end_time_pre_open = AFM.get_timestamp_from_list(phases=trading_phases, phase=TradingPhases.PreOpen, start_time=False) + 1
        end_time_open = AFM.get_timestamp_from_list(phases=trading_phases, phase=TradingPhases.Open, start_time=False)
