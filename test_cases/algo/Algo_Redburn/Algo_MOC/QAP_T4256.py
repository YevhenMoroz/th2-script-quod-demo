...
class QAP_T4256(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_order.change_parameters(dict(Account=self.account, ExDestination=self.mic, OrderQty=self.qty, TimeInForce=7, Price=self.price, Instrument=self.instrument))
