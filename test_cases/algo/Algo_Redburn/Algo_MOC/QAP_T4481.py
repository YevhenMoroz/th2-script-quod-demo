...
class QAP_T4481(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        scheduler.enterabs(end_time, 1, self.fix_manager_feed_handler.send_message, kwargs=dict(fix_message=self.incremental_refresh_pre_close))
