...
class QAP_T11030(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.snapshot_full_refresh = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_id, self.fix_env1.feed_handler)
        ...
        self.would_order.change_parameters(dict(Account=self.account, ExDestination=self.mic, OrderQty=self.would_qty, Price=self.would_price, Instrument=self.instrument, TimeInForce=self.tif_atc))
