...
class QAP_T4477(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        trading_phases = AFM.get_timestamps_for_current_phase(TradingPhases.AtLast)
    ...
    def run_post_conditions(self):
        ...
        er_cancel_auction_order.change_parameters(dict(TimeInForce=7, Text='reached uncross'))
