...
class QAP_T4366(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_RB_params().change_parameter('TimeInForce', 7)
        ...
        end_time = AFM.get_timestamp_from_list(phases=trading_phases, phase=TradingPhases.PreClosed, start_time=False) / 1000
