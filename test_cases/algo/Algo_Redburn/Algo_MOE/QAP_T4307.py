...
class QAP_T4307(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_rejected.change_parameters(dict(TimeInForce=5, NoParty='*', SecAltIDGrp='*',Account=self.client, NoStrategyParameters='*', LastQty=0, SettlDate='*', Currency='EUR', HandlInst=2, LastPx=0, OrderCapacity='A', QtyType=0, ExecRestatementReason=4, Instrument="*", Text='missing WouldPriceReference')).remove_parameter('ExDestination')
