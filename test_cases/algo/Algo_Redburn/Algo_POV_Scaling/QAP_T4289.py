...
class QAP_T4289(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text_reject_invalid_price_point_2_participation = constants.FreeNotesReject.InvalidPricePoint1Participation.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snapshot = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.s_par, self.fix_env1.feed_handler).set_phase(TradingPhases.Open)
        ...
        pov_scaling_order.update_fields_in_component('QuodFlatParameters', dict(PricePoint1Participation=self.pp1_participation))
        ...
        reject_moc_order_params.change_parameters(dict(Text=self.text_reject_invalid_price_point_2_participation))
