...
class QAP_T4176(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.max_participation_open = 12
        ...
        self.auction_child_qty = AFM.get_child_qty_for_auction(self.indicative_volume, self.max_participation_open, self.qty)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.pov_algo.update_fields_in_component('QuodFlatParameters', dict(MaxParticipationOpen=self.max_participation_open, MaxParticipation=self.percentage_volume))
        ...
        cancel_auction_dma_child_order.change_parameters(dict(OrderQty=self.auction_child_qty))
