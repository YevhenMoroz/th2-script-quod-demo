...
class QAP_T4536(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.pov_algo.update_fields_in_component('QuodFlatParameters', dict(MaxParticipation=self.percentage_volume, SaveForClosePercentage=self.save_for_close_percentage))
