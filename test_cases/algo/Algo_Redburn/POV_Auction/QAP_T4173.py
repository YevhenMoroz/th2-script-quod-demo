...
class QAP_T4173(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.max_participation_close = 12
        ...
        self.auction_child_qty = AFM.get_child_qty_for_auction(self.indicative_volume, self.max_participation_close, self.qty)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.pov_algo.update_fields_in_component('QuodFlatParameters', dict(MaxParticipationClose=self.max_participation_close, MaxParticipation=self.percentage_volume))
