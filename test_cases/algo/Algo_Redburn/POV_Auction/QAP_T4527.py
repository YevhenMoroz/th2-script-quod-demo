...
class QAP_T4527(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        initial_slice = self.end_date_open.timestamp() - 50
        ...
        self.fix_manager_feed_handler.set_case_id(case_id=bca.create_event("Send PCL phase during random uncross", self.test_id))
