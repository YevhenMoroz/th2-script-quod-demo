...
class QAP_T4593(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.order_side_sell = OrderSide.Sell.value
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.vwap_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, ExDestination=self.ex_destination_1, Side=self.order_side_sell))
        ...
        self.vwap_child.change_parameters(dict(OrderQty=self.qty_child, Price=self.price_child, Account=self.account, Instrument='*', ExDestination=self.ex_destination_1, Side=self.order_side_sell))
