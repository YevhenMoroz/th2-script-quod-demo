...
class QAP_T10944(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        trade = rule_manager.add_NewOrdSingleExecutionReportTradeOnFullQty(self.fix_env1.buy_side, self.account, self.mic)
        self.rule_list = [nos, trade]
        # endregion
