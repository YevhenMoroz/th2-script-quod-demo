...
def execute(report_id):
    try:
        ...
        vwap_nav_order.update_fields_in_component('QuodFlatParameters', dict(NavigatorLimitPriceOffset=navigator_limit_price_offset))
        ...
        reject_vwap_order_params.change_parameter('Text', text_reject_navigator_limit_price_reference)
