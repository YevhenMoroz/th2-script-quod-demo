...
def execute(report_id):
    try:
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(NavigatorLimitPrice=price_nav, Waves=waves, NavigatorRebalanceTime=nav_rebalance, NavigatorPercentage=nav_percent))
