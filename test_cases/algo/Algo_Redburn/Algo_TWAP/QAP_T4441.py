...
first_reserve = max(ast, int(qty * (1 - 0.3)))
...
def execute(report_id):
    try:
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(Waves= waves, NavigatorLimitPrice=price_nav, NavigatorPercentage=nav_percent))
