...
class QAP_T4304(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(Waves=self.waves))
        ...
        nav_child_1.remove_parameters(['Price', 'NoParty'])
        ...
        cancel_twap_child_params.remove_parameter('ExDestination')
