...
def execute(report_id):
    try:
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(MaxParticipation=max_participation))
        ...
        reject_twap_order_params.change_parameter('Text', text_reject_invalid_maxparticipation)
