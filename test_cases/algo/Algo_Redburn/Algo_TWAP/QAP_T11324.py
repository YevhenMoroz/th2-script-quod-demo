...
class QAP_T11324(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price = 21
        self.waves = 3
        self.qty_would_child = 2000
        self.price_child = 20
        self.trigger_price = 20.005
        
        self.qty_dma_child = AFM.get_next_twap_slice(self.qty_ask, self.waves) + 1
        self.price_dma_child = self.price_bid - 0.005
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_1, False, self.qty_would_child, self.price_child)
