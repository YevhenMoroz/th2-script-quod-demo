...
class QAP_T4323(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(Waves=self.waves, NavigatorLimitPriceReference=self.navigator_limit_price_reference, EndDate2=end_time))
