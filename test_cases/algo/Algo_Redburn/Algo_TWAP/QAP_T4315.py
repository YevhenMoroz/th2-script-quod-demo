...
def execute(report_id):
    try:
        ...
        twap_nav_order.update_fields_in_component('QuodFlatParameters', dict(NavigatorLimitPriceOffset=navigator_limit_price_offset))
        ...
        pending_twap_order_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(twap_nav_order, gateway_side_sell, status_pending)
        ...
        reject_twap_order_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(twap_nav_order, gateway_side_sell, status_reject)
        reject_twap_order_params.change_parameter('Text', text_reject_navigator_limit_price_reference)
