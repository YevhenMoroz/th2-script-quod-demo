...
class QAP_T4226(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Check DMA child order 2
        self.case_id_4 = bca.create_event("DMA child order - level 3", self.test_id)
        ...
        self.passive_child_order_3.change_parameters(dict(Account=self.account, OrderQty=self.qty_child_1, Price=self.price_bid_1, Instrument='*', ExDestination=self.mic))
        self.fix_verifier_buy.check_fix_message(self.passive_child_order_3, key_parameters=self.key_params, message_name='Buy side NewOrderSingle DMA Child 3')
        ...
        self.fix_verifier_buy.check_fix_message(pending_passive_child_order_3_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew DMA Child 3')
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(cancel_dma_child_3_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport Cancel DMA 3 child')
        # endregion
