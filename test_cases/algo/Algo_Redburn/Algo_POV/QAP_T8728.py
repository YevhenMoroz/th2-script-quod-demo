...
class QAP_T8728(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty_aggressive_child_1 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.percentage_volume, self.qty_ltq_1, self.qty)
        self.qty_aggressive_child_2 = AlgoFormulasManager.get_pov_child_qty_for_worse_price_behavior(self.min_participation, self.percentage_volume, self.total_traded_volume, self.qty, self.executed_aggressive_qty)
        # endregion
