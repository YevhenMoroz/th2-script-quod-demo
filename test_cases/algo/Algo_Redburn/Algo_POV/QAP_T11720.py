...
class QAP_T11720(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snap_shot_par_clear.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ltq, MDEntrySize=self.qty_ltq_1)
        ...
        market_data_snap_shot_trqx.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid, MDEntrySize=self.qty_bid_trqx)
