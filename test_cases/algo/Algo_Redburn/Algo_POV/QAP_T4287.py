...
qty = 100000
price = 20
pp2_particiaption = 120
text_reject_invalid_price_point_2_participation = DataSet.FreeNotesReject.InvalidPricePoint2Participation.value
...
def execute(report_id):
    try:
        ...
        pov_scaling_order.update_fields_in_component('QuodFlatParameters', dict(PricePoint2Participation=pp2_particiaption))
        ...
        reject_pov_order_params.change_parameter('Text', text_reject_invalid_price_point_2_participation)
