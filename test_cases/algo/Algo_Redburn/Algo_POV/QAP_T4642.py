...
class QAP_T4642(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_reactive_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, self.price_child_aggressive)
        ocr_rule = rule_manager.add_OCR(self.fix_env1.buy_side)
        self.rule_list = [ocr_rule, nos_reactive_rule]
        # endregion
