...
qty = 100000
price = 20
percentage_of_volume = 120
text_reject_invalid_percentage_of_volume = DataSet.FreeNotesReject.InvalidPercentageOfVolume.value
...
def execute(report_id):
    try:
        ...
        reject_pov_order_params.change_parameter('Text', text_reject_invalid_percentage_of_volume)
