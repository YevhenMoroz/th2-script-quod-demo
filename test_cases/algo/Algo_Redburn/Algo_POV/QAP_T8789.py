...
class QAP_T8789(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.mic, False, 0, self.price, delay=1000)
        ...
        self.rule_list = [nos_rule_1, nos_ioc_rule_1, ocr_rule, ocrr_rule]
        # endregion
