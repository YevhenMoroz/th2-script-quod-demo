...
def execute(report_id):
    try:
        ...
        pov_order.update_fields_in_component('QuodFlatParameters', dict(LimitPriceOffset=limit_price_offset))
        ...
        reject_pov_order_params.change_parameter('Text', text_reject_limit_price_reference)
