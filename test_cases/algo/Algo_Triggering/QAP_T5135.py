...
class QAP_T5135(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.trigger_px = 23
        self.trig_px_type = constants.TriggerPriceType.BestOfferOrLastTrade.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [nos_dma_rule, trade_dma_rule]
        # endregion
        ...
        self.Triggering_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, Instrument=self.instrument)).remove_parameter('TimeInForce')
        ...
        self.dma_order.change_parameters(dict(OrderQty=self.qty, Price=self.price, Instrument='*'))
        ...
        fill_request_Triggering_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.Triggering_order, self.gateway_side_sell, self.status_fill)
        self.fix_verifier_sell.check_fix_message(fill_request_Triggering_order, message_name='Sell side ExecReport Fill')
        # endregion
