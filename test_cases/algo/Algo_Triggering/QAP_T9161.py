...
class QAP_T9161(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Triggering_order.update_fields_in_component('TriggeringInstruction', dict(TriggerPriceType=self.trig_px_type, TriggerPriceDirection=self.trig_px_direct, TriggerPrice=self.trigger_px))
