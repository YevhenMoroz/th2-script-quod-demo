...
class QAP_T8817(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_1, True, self.qty_ask, self.price, self.delay)
        ...
        self.Triggering_order.update_fields_in_component('TriggeringInstruction', dict(TriggerPriceType=self.trig_px_type, TriggerPrice=self.trigger_px))
        ...
        self.dma_order.change_parameters(dict(OrderQty=self.qty_ask, Price=self.price, Instrument='*', TimeInForce=self.tif_ioc))
