...
class QAP_T9030(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_order.change_parameters(dict(OrderQty=self.qty_bid, Price=self.price, Instrument='*', TimeInForce=self.tif_ioc, Side=self.side))
