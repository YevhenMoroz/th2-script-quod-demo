...
class QAP_T4089(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.multilisting_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, OrdType=self.order_type, Instrument=self.instrument, TimeInForce=self.tif_fok, Price=self.price))
        ...
        fill_dma_order.change_parameters(dict(CumQty=self.qty, LeavesQty=0, LastQty=self.qty, LastPx=self.last_price, Text='*'))
        ...
        fill_multilisted_order.change_parameters(dict(CumQty=self.qty, LeavesQty=0, LastQty=self.qty, Instrument="*", Text='*', Price=self.price))
