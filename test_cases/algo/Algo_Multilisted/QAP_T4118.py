...
class QAP_T4118(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.multilisting_order_replace_params.change_parameters(dict(OrderQty=self.inc_qty))
        ...
        replaced_dma_order_params.change_parameters(dict(OrderQty=self.inc_qty))
    ...
    def run_post_conditions(self):
        ...
        cancel_dma_order.change_parameter('OrderQty', self.inc_qty)
