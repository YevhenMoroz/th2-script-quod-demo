...
def execute(report_id):
    try:
        ...
        fix_verifier_bs.CheckNewOrderSingle(new_order_single_bs, responce_new_order_single, case=case_id_2, message_name='BS FIXBUYTH2 sent 35=D New order', key_parameters=['Price', 'OrderQty', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_3, responce_new_order_single, direction='SECOND', case=case_id_2, message_name='BS FIXBUYTH2 sent 35=8 Pending New', key_parameters=['OrderQty', 'ExecType', 'OrdStatus' ,'Price',  'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_4, responce_new_order_single, direction='SECOND', case=case_id_2,  message_name='BS FIXBUYTH2 sent 35=8 New', key_parameters=['OrderQty', 'ExecType', 'OrdStatus' ,'Price',  'TimeInForce'])
        #endregion
        ...
        responce_new_order_single_cancel = fix_manager_310.Send_OrderCancelRequest_FixMessage(fix_cancel, case=case_id_4)
        ...
        fix_verifier_ss.CheckOrderCancelRequest(cancel_ss_param, responce_new_order_single_cancel, direction='SECOND', case=case_id_4, message_name='SS FIXSELLQUOD5 sent 35=F Cancel',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_10, responce_new_order_single_cancel, direction='SECOND', case=case_id_4, message_name='BS FIXBUYTH2 sent 35=8 Cancel',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
        ...
        fix_verifier_ss.CheckExecutionReport(er_11, responce_new_order_single_cancel, case=case_id_4, message_name="SS FIXSELLQUOD5 send 35=8 Cancel", key_parameters=['OrdStatus', 'ExecType', 'TimeInForce', 'OrdType'])
        #endregion
