...
class QAP_1961(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        dma_1_order.change_parameters(dict(OrderQty=self.qty, Price=self.price, TimeInForce=self.tif_gtd, ExpireDate=self.ExpireDate, Instrument=self.instrument))
        ...
        self.dma_2_order.change_parameters(dict(OrderQty=self.qty, Price=self.price, Instrument=self.instrument, TimeInForce=self.tif_day))
    ...
    def run_post_conditions(self):
        ...
        cancel_multilisting_order_params.change_parameters(dict(TimeInForce=self.tif_day))
