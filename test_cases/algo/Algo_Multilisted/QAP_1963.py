...
class QAP_1963(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_1_order.change_parameters(dict(OrderQty=self.qty, TimeInForce=self.tif_gtd, ExpireDate=self.ExpireDate, Instrument=self.instrument, OrdType=self.order_type_mkt))
