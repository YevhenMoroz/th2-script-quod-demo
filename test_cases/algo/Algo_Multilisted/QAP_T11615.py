...
class QAP_T11615(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_1_rule = rule_manager.add_NewOrdSingle_IOCTradeByOrderQty(self.fix_env1.buy_side, self.account_qlv1, self.ex_destination_qlv1, True,  self.price_ask_qdl1, self.price_ask_qdl1, self.qty, self.qty_for_partial_fill, delay=2000)
        ...
        self.rule_list = [nos_ioc_1_rule, nos_1_rule, nos_2_rule, ocr_1_rule, ocr_2_rule]
        # endregion
