...
class QAP_T4132(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.multilisting_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, TimeInForce=self.tif_gtc, Instrument=self.instrument))
        ...
        self.dma_1_order.change_parameters(dict(OrderQty=self.display_qty, Price=self.price, TimeInForce=self.tif_gtc, Instrument=self.instrument))
