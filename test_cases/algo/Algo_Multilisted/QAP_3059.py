...
def rule_creation():
    ...
    return [market_rule_1, occr_rule, ocr_rule]
...
def execute(report_id):
    ...
    fix_verifier_buy_side.CheckNewOrderSingle(nos_2, responce, key_parameters=['ExDestination', 'Side'],
    ...
    # fix_modify_message.change_parameters({'StopPx': stop_price_2})
    ...
    # fix_modify_message = deepcopy(fix_message_multilisting)
    # fix_modify_message.change_parameters({'StopPx': stop_price_3})
    # fix_modify_message.add_tag({'OrigClOrdID': fix_modify_message.get_ClOrdID()})
