...
class QAP_T4129(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.multilisting_order_replace_params.change_parameters(dict(TimeInForce=self.tif_gtc))
        ...
        replaced_dma_order_params.change_parameters(dict(TimeInForce=self.tif_gtc))
    ...
    def run_post_conditions(self):
        ...
        cancel_multilisting_order_params.change_parameters(dict(TimeInForce=self.tif_gtc)).add_tag(dict(SettlType='*', SettlDate='*'))
