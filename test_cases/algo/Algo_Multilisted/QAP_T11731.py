...
class QAP_T11731(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty_ask_qdl1 = 300
        self.qty_ask_qdl2 = 200
        ...
        self.algopolicy = constants.ClientAlgoPolicy.qa_sorping_spray_2.value
        self.display_qty = 50
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_1_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_qlv1, self.ex_destination_qlv1, True, self.qty_ask_qdl1, self.price_ask_qdl1)
        nos_ioc_2_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, True, self.qty_ask_qdl2, self.price_ask_qdl2)
        ...
        self.rule_list = [nos_ioc_1_rule, nos_ioc_2_rule, nos_1_rule, nos_2_rule, ocr_1_rule, ocr_2_rule]
        # endregion
        ...
        market_data_snap_shot_qdl2.add_fields_into_repeating_group('NoMDEntries', [dict(MDEntryType=1, MDEntryPx=50, MDEntrySize=1000, MDEntryPositionNo=2)])
        ...
        self.Multilisted_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, ClientAlgoPolicyID=self.algopolicy))
