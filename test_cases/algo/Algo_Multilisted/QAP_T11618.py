...
class QAP_T11618(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.new_qty_ask = 500
        self.price_ask_qdl1 = 50
        self.new_price_ask_qdl1 = 44
        self.price_bid_qdl1 = 30
        self.price_ask_qdl2 = 50
        self.new_price_ask_qdl2 = 45
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_1_rule = rule_manager.add_NewOrdSingle_IOCTradeByOrderQty(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, True,  self.new_price_ask_qdl2, self.new_price_ask_qdl2, self.new_qty_ask, self.new_qty_ask, delay=2000)
        ...
        self.rule_list = [nos_1_rule, nos_2_rule, ocrr_rule, nos_ioc_1_rule, ocr_1_rule, ocr_2_rule]
        # endregion
        ...
        market_data_snap_shot_qdl1 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_qlv1, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl1.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid_qdl1, MDEntrySize=self.qty_for_md)
        market_data_snap_shot_qdl1.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.new_price_ask_qdl1, MDEntrySize=self.new_qty_ask)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl1)

        self.fix_manager_feed_handler.set_case_id(bca.create_event("Update Market Data", self.test_id))
        market_data_snap_shot_qdl2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_qlv2, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid_qdl2, MDEntrySize=self.qty_for_md)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.new_price_ask_qdl2, MDEntrySize=self.new_qty_ask)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl2)
