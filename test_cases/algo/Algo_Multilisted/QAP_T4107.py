...
class QAP_T4107(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        replaced_multilisting_order_params_dec.add_tag(dict(SettlType='*', SettlDate='*', StopPx=self.dec_stop_price)).change_parameters(dict(OrdType=self.order_type_stop_lmt, Price=self.dec_price))
        ...
        replaced_multilisting_order_params_inc.add_tag(dict(SettlType='*', SettlDate='*', StopPx=self.inc_stop_price)).change_parameters(dict(OrdType=self.order_type_stop_lmt, Price=self.inc_price))
