...
class QAP_T4115(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [nos_1_rule, nos_1_ioc_rule, nos_2_ioc_rule, ocr_rule]
        # endregion
        ...
        er_replaced_multilisting_order_params.remove_parameter('NoParty')
        ...
        # region Check fill parent
        er_partial_fill_multilisting_order_params = FixMessageExecutionReportAlgo().set_params_from_order_cancel_replace(self.multilisting_order_replace_params, self.gateway_side_sell, self.status_fill)
