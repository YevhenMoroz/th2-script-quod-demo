...
class QAP_T11734(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_1_rule = rule_manager.add_NewOrdSingle_IOCTradeByOrderQty(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, True,  self.new_price_ask_qdl2, self.new_price_ask_qdl2, self.qty_ask_qdl2, self.qty_ask_qdl2, delay=2000)
        ...
        market_data_snap_shot_qdl2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_qlv2, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid_qdl2, MDEntrySize=self.qty_for_md)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.new_price_ask_qdl2, MDEntrySize=self.qty_ask_qdl2)
