...
class QAP_T4135(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_1_order.change_parameters(dict(OrderQty=self.display_qty, Price=self.price, TimeInForce=self.tif_gtd, ExpireDate=self.ExpireDate, Instrument=self.instrument))
    ...
    def run_post_conditions(self):
        ...
        cancel_multilisting_order_params.add_tag(dict(ExpireDate=self.ExpireDate))
        cancel_multilisting_order_params.change_parameters(dict(TimeInForce=self.tif_gtd))
