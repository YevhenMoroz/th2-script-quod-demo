...
class QAP_T11612(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, True, self.qty, self.new_price_ask_qdl2)
        self.rule_list = [nos_1_rule, ocr_1_rule, nos_ioc_rule]
        # endregion
