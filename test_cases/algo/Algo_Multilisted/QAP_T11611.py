...
class QAP_T11611(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_3_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_qlv1, self.ex_destination_qlv1, self.inc_price)
        nos_4_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, self.inc_price)
