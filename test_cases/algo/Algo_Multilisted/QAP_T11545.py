...
class QAP_T11545(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.ltp_1_qlv1 = 32
        self.ltp_1_qlv2 = 32.3
        self.ltp_1_qlv3 = 28
        self.ltp_2_qlv1 = 38
        self.ltp_2_qlv2 = 33
        self.ltp_2_qlv3 = 39

        self.price_1_qlv1_child = 32.2
        self.price_1_qlv2_child = 32.5
        self.price_1_qlv3_child = 28.2
        self.price_2_qlv1_child = 38.2
        self.price_2_qlv2_child = 33.2
        self.price_2_qlv3_child = 39.2
        # endregion
        ...
        # region venue param
        self.ex_destination_qlv1 = self.data_set.get_mic_by_name("mic_1")
        ...
        self.account_qlv1 = self.data_set.get_account_by_name("account_2")
        ...
        self.listing_qlv1 = self.data_set.get_listing_id_by_name("listing_1")
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_trade_rule = rule_manager.add_NewOrdSingleExecutionReportTradeByOrdQty(self.fix_env1.buy_side, self.account_qlv1, self.ex_destination_qlv1, self.price, self.price, self.display_qty, self.display_qty, self.delay)
        ...
        self.rule_list = [nos_1_rule,nos_trade_rule, nos_2_rule, nos_3_rule, ocrr_rule, ocr_1_rule, ocr_2_rule, ocr_3_rule]
        # endregion

        # region Send the MarketData
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data", self.test_id))
        market_data_snap_shot_qlv1 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_qlv1, self.fix_env1.feed_handler)
        market_data_snap_shot_qlv1.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid, MDEntrySize=self.qty_for_md)
        market_data_snap_shot_qlv1.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask, MDEntrySize=self.qty_for_md)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qlv1)

        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data", self.test_id))
        market_data_snap_shot_qlv2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_qlv2, self.fix_env1.feed_handler)
        market_data_snap_shot_qlv2.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid, MDEntrySize=self.qty_for_md)
        market_data_snap_shot_qlv2.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask, MDEntrySize=self.qty_for_md)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qlv2)

        time.sleep(3)
        # endregion

        # region Send_MarkerData LTP 1
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data LTP initial", self.test_id))
        market_data_incr_qlv1 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv1, self.fix_env1.feed_handler)
        market_data_incr_qlv1.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=38, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv1)

        market_data_incr_qlv2 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv2, self.fix_env1.feed_handler)
        market_data_incr_qlv2.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.ltp_1_qlv2, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv2)

        market_data_incr_qlv3 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv3, self.fix_env1.feed_handler)
        market_data_incr_qlv3.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.ltp_1_qlv3, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv3)
        # endregion
        ...
        self.Multilisted_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_Single_listed_LitSOR_with_Iceberg_and_Peg_params()
        self.Multilisted_order.add_ClordId((os.path.basename(__file__)[:-3]))
        self.Multilisted_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, ExDestination=self.ex_destination_qlv1, DisplayInstruction=dict(DisplayQty=self.display_qty)))
        ...
        # region Send_MarkerData LTP 2
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data LTP new", self.test_id))
        market_data_incr_qlv1 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv1, self.fix_env1.feed_handler)
        market_data_incr_qlv1.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=32, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv1)

        market_data_incr_qlv2 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv2, self.fix_env1.feed_handler)
        market_data_incr_qlv2.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.ltp_2_qlv2, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv2)

        market_data_incr_qlv3 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv3, self.fix_env1.feed_handler)
        market_data_incr_qlv3.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.ltp_2_qlv3, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv3)
        # endregion
        ...
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data LTP new", self.test_id))
        market_data_incr_qlv1 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_qlv1, self.fix_env1.feed_handler)
        market_data_incr_qlv1.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=39, MDEntrySize=self.qty)
        self.fix_manager_feed_handler.send_message(market_data_incr_qlv1)
