...
class QAP_1998(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        fill_dma_order.change_parameters(dict(CumQty=self.qty, LeavesQty=0, LastQty=self.qty, LastPx=self.last_price, Text='*')).remove_parameter('ExDestination').add_tag(dict(ExDestination='*'))
