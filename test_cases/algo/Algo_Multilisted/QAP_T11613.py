...
class QAP_T11613(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_1_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_qlv1, self.ex_destination_qlv1, True, self.qty_for_md, self.new_price_ask_qdl1)
        nos_ioc_2_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_qlv2, self.ex_destination_qlv2, True, self.qty_for_md, self.new_price_ask_qdl2, delay=2000)
        self.rule_list = [nos_1_rule, ocr_1_rule, ocrr_rule, nos_ioc_1_rule, nos_ioc_2_rule]
        # endregion
