...
class QAP_T8784(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        trade_rule = rule_manager.add_NewOrdSingleExecutionReportTrade(self.fix_env1.buy_side, self.account, self.ex_destination_1, self.price, self.display_qty, self.delay)
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account, self.ex_destination_1, False)

        self.rule_list = [ocr_rule, nos_dma_rule, trade_rule]
        # endregion
        ...
        self.Pegged_order.change_parameter('TargetStrategy', 1008)
        ...
        self.Pegged_order.add_tag(dict(DisplayInstruction=dict(DisplayQty=self.display_qty)))
    ...
    def run_post_conditions(self):
        ...
        self.fix_manager_sell.send_message_and_receive_response(cancel_request_peg_order, case_id_2)
        ...
        # cancel_peg_order.change_parameters(dict(PegInstructions='*'))
