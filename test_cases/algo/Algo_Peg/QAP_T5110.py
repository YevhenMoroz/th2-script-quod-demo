...
class QAP_T5110(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.peg_offset_val = 2
        self.peg_offset_val_mod = 4
        self.tick_size = 0.005
        self.child_price = self.mid_price + (self.peg_offset_val * self.tick_size)
        self.child_price_mod = self.mid_price + (self.peg_offset_val_mod * self.tick_size)
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Pegged_order_replace_params.update_fields_in_component('PegInstructions', dict(PegOffsetValue=self.peg_offset_val_mod))
        ...
        er_replaced_dma_order.change_parameter('Price', self.child_price_mod)
    ...
    def run_post_conditions(self):
        ...
        cancel_peg_order.change_parameters(dict(PegInstructions='*', SettlType='*'))
