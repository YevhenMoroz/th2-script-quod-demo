...
class QAP_T4899(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.peg_px_type_init = constants.PegPriceType.MidPricePeg.value
        self.peg_px_type_mod = constants.PegPriceType.PrimaryPeg.value
        ...
        self.child_price_init = self.mid_price + (self.peg_offset_val * self.tick_size)
        self.child_price_mod = self.price_bid
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Pegged_order.update_fields_in_component('PegInstructions', dict(PegOffsetValue=self.peg_offset_val, PegOffsetType=self.peg_offset_type, PegPriceType=self.peg_px_type_init))
        ...
        self.Pegged_order_replace_params.update_fields_in_component('PegInstructions', dict(PegPriceType=self.peg_px_type_mod))
