...
class QAP_T4900(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_bid = 10
        self.price = 11
        self.qty_init_bid = self.qty_init_ask = 1_000
        ...
        self.child_price = (self.price_bid + self.price_ask)/2
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid, MDEntrySize=self.qty_init_bid)
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask, MDEntrySize=self.qty_init_ask)
        ...
        self.Pegged_order.change_parameters(dict(Account=self.client, OrderQty=self.qty_init, Price=self.price, Instrument=self.instrument))
        ...
        self.dma_order.change_parameters(dict(OrderQty=self.qty_init, Price=self.child_price, Instrument='*'))
    ...
    def run_post_conditions(self):
        ...
        cancel_peg_order.change_parameters(dict(SettlType='*', OrderQty=self.qty_mod))
        ...
        cancel_dma_order_1.change_parameter('OrderQty', self.qty_mod)
