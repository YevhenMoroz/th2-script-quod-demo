...
class QAP_T4902(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.peg_px_type = constants.PegPriceType.PrimaryPeg.value
        self.peg_offset_type = constants.PegOffsetType.Price.value
        self.peg_offset_val_init = 0.2
        self.peg_offset_val_mod = 0.4
        self.child_price_init = self.price_bid + self.peg_offset_val_init
        self.child_price_mod = self.price_bid + self.peg_offset_val_mod
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Pegged_order.update_fields_in_component('PegInstructions', dict(PegOffsetValue=self.peg_offset_val_init, PegOffsetType=self.peg_offset_type, PegPriceType=self.peg_px_type))
    ...
    def run_post_conditions(self):
        ...
        cancel_peg_order.change_parameters(dict(SettlType='*'))
