...
class QAP_T4224(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_manager_sell.send_message(cancel_request_Synthetic_TIF_order)
        ...
        er_cancel_Synthetic_TIF_order_params.change_parameters(dict(TargetStrategy='*')).change_parameter('ExpireDate', '*')
