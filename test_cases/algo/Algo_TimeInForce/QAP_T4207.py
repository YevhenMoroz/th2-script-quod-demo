...
class QAP_T4207(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rule_manager.remove_rules_by_name('NewOrdSingleExecutionReportEliminate', "fix-bs-310-columbia")
        ...
        er_pending_new_Synthetic_TIF_order_params.add_tag(dict(TargetStrategy='*')).change_parameter('ExpireDate', '*')
        ...
        er_new_Synthetic_TIF_order_params.add_tag(dict(TargetStrategy='*')).change_parameter('ExpireDate', '*')
        ...
        self.fix_verifier_buy.check_fix_message_sequence([er_pending_new_dma_order, er_new_dma_order, er_eliminate_dma_order_params,
                                                          er_pending_new_dma_order_2, er_new_dma_order_2, er_cancel_DMA_order_2_params],
    ...
    def run_post_conditions(self):
        ...
        er_cancel_Synthetic_TIF_order_params.change_parameters(dict(TargetStrategy='*', ExpireDate='*'))
