...
class QAP_T4208(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_pending_new_Synthetic_TIF_order_params.remove_parameter('NoParty').add_tag(dict(TargetStrategy='*')).change_parameter('ExpireTime', '*')
        ...
        er_new_Synthetic_TIF_order_params.add_tag(dict(TargetStrategy='*')).add_tag(dict(NoParty='*')).change_parameter('ExpireTime', '*')
        ...
        er_eliminate_dma_order_params.change_parameters(dict(OrdStatus='8', ExecType='8', Text='X: Expired', OrdRejReason=0))
    ...
    def run_post_conditions(self):
        ...
        er_cancel_Synthetic_TIF_order_params.change_parameters(dict(TargetStrategy='*', NoParty='*')).change_parameter('ExpireTime', '*')
