...
class QAP_T4208(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_pending_new_Synthetic_TIF_order_params.add_tag(dict(TargetStrategy='*')).change_parameter('ExpireTime', '*')
        ...
        er_new_Synthetic_TIF_order_params.add_tag(dict(TargetStrategy='*')).change_parameter('ExpireTime', '*')
    ...
    def run_post_conditions(self):
        ...
        er_cancel_Synthetic_TIF_order_params.change_parameters(dict(TargetStrategy='*')).change_parameter('ExpireTime', '*')
