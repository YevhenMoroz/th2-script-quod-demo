...
class QAP_T4886(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        slice1_order.change_parameters(dict(OrderQty=self.slice1_qty, Price=self.slice1_price, Instrument='*', TimeInForce=self.tif_day))
        ...
        slice2_order.change_parameters(dict(OrderQty=self.slice2_qty, Price=self.slice2_price, Instrument='*', TimeInForce=self.tif_day))
        ...
        # check cancel child DMA Slice 2
        cancel_slice2_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(slice2_order, self.gateway_side_buy, self.status_cancel)
        # cancel_slice2_order.change_parameter)
