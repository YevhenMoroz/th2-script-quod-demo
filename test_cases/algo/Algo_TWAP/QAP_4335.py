...
def rule_creation():
    ...
    return [nos_ioc_md_rule, nos_rule, nos_trade, ocr_rule]
...
def execute(report_id):
    try:
        ...
        new_order_single_params = {
            'Account': client,
            'ClOrdID': 'QAP_4335_' + bca.client_orderid(9),
            'HandlInst': 2,
            'Side': side,
            'OrderQty': qty,
            'TimeInForce': tif_day,
        ...
        case_id_3 = bca.create_event("Check Child Would Price and TWAP Child", case_id)
        ...
        fix_verifier_bs.CheckNewOrderSingle(new_slice_1, responce_new_order_single, case=case_id_3, message_name='BS FIXBUYTH2 sent 35=D New order Child Would Price', key_parameters=['OrderQty', 'Price', 'Account', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckNewOrderSingle(new_slice_2, responce_new_order_single, case=case_id_3, message_name='BS FIXBUYTH2 sent 35=D New order TWAP Child', key_parameters=['OrderQty', 'Price', 'Account', 'TimeInForce'])
        # Check that FIXBUYQUOD5 sent 35=8 pending new 
        er_6 = {
            'Account': account,
            'CumQty': '0',
