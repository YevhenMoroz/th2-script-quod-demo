...
class QAP_T4882(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_bid = 30
        self.price = 1
        self.dec_qty = self.slice2_qty = 3_000_000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order_replace_params.change_parameter('OrderQty', self.dec_qty)
        self.fix_manager_sell.send_message_and_receive_response(self.twap_order_replace_params, case_id_2)

        time.sleep(1)

        self.twap_order_replace_params.change_parameter('TransactTime', '*')
        ...
        # region check cancel child DMA Slice 1
        ...
        self.slice2_order.change_parameters(dict(OrderQty=self.slice2_qty, Price=self.price, TimeInForce=self.tif_day, Instrument='*'))#.update_repeating_group('Instrument', ['Symbol', 'SecurityID'])
    ...
    def run_post_conditions(self):
        ...
        cancel_twap_order.change_parameters(dict(NoParty='*', OrderQty=self.dec_qty, SettlType='B', CxlQty=self.dec_qty))
