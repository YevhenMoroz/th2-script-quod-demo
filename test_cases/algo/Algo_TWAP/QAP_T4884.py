...
class QAP_T4884(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_bid = 30
        self.price = 1
        self.inc_qty = self.slice2_qty = 4_000_000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order_replace_params.change_parameter('OrderQty', self.inc_qty)
    ...
    def run_post_conditions(self):
        ...
        cancel_twap_order.change_parameters(dict(NoParty='*', OrderQty=self.inc_qty, SettlType='B', CxlQty=self.inc_qty))
