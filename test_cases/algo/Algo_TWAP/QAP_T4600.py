...
class QAP_T4600(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_child.change_parameters(dict(Price=self.price_child, OrderQty=self.qty_child, Account=self.account, Instrument='*', ExDestination=self.ex_destination_1))
