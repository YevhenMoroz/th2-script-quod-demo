...
def execute(report_id):
    try:
        ...
        new_order_single_params = {
            'Account': client,
            'ClOrdID': 'QAP_4760_' + bca.client_orderid(9),
            'HandlInst': 2,
            'Side': side,
            'OrderQty': qty,
            'TimeInForce': tif_day,
        ...
        case_id_2 = bca.create_event("Send Slice 1", case_id)
        #region Slice 1
        ...
        fix_verifier_bs.CheckNewOrderSingle(new_slice_1, responce_new_order_single, case=case_id_2, message_name='BS FIXBUYTH2 sent 35=D New order TWAP Child', key_parameters=['OrderQty', 'Price', 'Account', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_6, responce_new_order_single, direction='SECOND', case=case_id_2, message_name='FIXQUODSELL5 sent 35=8 Pending New TWAP Child', key_parameters=['Price', 'OrderQty', 'ExecType', 'OrdStatus', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_7, responce_new_order_single, direction='SECOND', case=case_id_2,  message_name='FIXQUODSELL5 sent 35=8 New TWAP Child', key_parameters=['Price', 'OrderQty', 'ExecType', 'OrdStatus'])
        #endregion
