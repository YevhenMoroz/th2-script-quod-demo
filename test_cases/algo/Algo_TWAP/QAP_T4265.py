...
class QAP_T4265(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.slice2_qty = self.slice1_qty
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order_replace_params.update_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='EndDate', StrategyParameterType=19, StrategyParameterValue=end_time)])
        ...
        slice2_order.change_parameters(dict(OrderQty=self.slice2_qty, Price=self.mid_price, Instrument='*', TimeInForce=self.tif_day)) #slice2_
        ...
        cancel_slice2_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(slice1_order, self.gateway_side_buy, self.status_cancel)
        # endregion

        self.fix_verifier_buy.set_case_id(bca.create_event("Child DMA order - Slice 1 & Slice 2", self.test_id))

        self.fix_verifier_buy.check_fix_message_sequence([pending_slice1_order_params, new_slice1_order_params, cancel_slice1_order,
                                                          pending_slice2_order_params, new_slice2_order_params, cancel_slice2_order],
                                                         key_parameters_list=[None, None, None, None, None, None], direction=self.ToQuod, pre_filter=None)
    ...
    def run_post_conditions(self):
        ...
        cancel_twap_order.change_parameters(dict(NoParty='*', SettlType='*'))
