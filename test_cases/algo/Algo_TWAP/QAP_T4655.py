...
class QAP_T4655(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order.update_fields_in_component('QuodFlatParameters', dict(Waves=self.waves, WouldPriceReference=self.would_reference_price, WouldPriceOffset=self.would_price_offset, StartDate2=self.start_date, EndDate2=self.end_date, TriggerPriceRed=self.trigger_price))
