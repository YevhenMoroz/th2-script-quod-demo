...
class QAP_T4885(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_1, False, self.qty, self.price)
        ...
        self.twap_order.add_fields_into_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='StartDate', StrategyParameterType=19, StrategyParameterValue=f'{start_time}'), dict(StrategyParameterName='EndDate', StrategyParameterType=19, StrategyParameterValue=f'{end_time}'), dict(StrategyParameterName='Aggressivity',
        ...
        cancel_slice1_order.change_parameters(dict(TimeInForce=self.tif_ioc, OrdType=self.order_type))
