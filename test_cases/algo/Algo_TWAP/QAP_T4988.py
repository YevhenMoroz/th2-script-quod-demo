...
class QAP_T4988(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.waves = 4
        self.slice1_qty, self.slice2_qty, self.slice3_qty, self.slice4_qty = [
            AlgoFormulasManager.get_next_twap_slice(self.qty, waves) for waves in range(self.waves, 0, -1)]
        self.aggressivity = 1
        # endregion
