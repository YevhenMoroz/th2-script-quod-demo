...
class QAP_T4271(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order_replace_params.update_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='StartDate', StrategyParameterType=19, StrategyParameterValue=start_time)])
        ...
        # cancel_slice1_order.change_parameter)
