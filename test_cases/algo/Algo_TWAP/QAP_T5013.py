...
class QAP_T5013(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.slice1_qty = min(AlgoFormulasManager.get_pov_child_qty(self.max_participation, self.qty_ltq, self.qty),
                              AlgoFormulasManager.get_next_twap_slice(self.qty, self.waves))
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.twap_order.add_fields_into_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='StartDate', StrategyParameterType=self.param_type_time, StrategyParameterValue=start_time),
                                                                                 ...
                                                                                 dict(StrategyParameterName='MaxParticipation', StrategyParameterType=self.param_type_float, StrategyParameterValue=self.max_participation),
        ...
        # region Set TradingPhase and LTQ for TWAP POV
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Set TradingPhase for TWAP POV", self.test_id))
    ...
    def run_post_conditions(self):
        ...
        cancel_twap_order.change_parameters(dict(NoParty='*'))
