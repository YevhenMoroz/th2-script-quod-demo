...
def execute(report_id):
    try:
        ...
        new_order_single_params = {
            'Account': client,
            'ClOrdID': 'QAP_4407_' + bca.client_orderid(9),
            'HandlInst': 2,
            'Side': side,
            'OrderQty': qty,
            'TimeInForce': tif_day,
       ...
       #Check Day eliminated
        ...
        fix_verifier_bs.CheckExecutionReport(er_8, responce_new_order_single, direction='SECOND', case=case_id_2, message_name='BS FIXBUYTH2 sent 35=8 Cancel Day 1',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])


        #Check Day order 2
        # Check bs (FIXQUODSELL5 sent 35=D Day 2)
        day_order_2 = {
            'NoParty': '*',
            'Account': account,        
            'OrderQty': child_day2_qty,
            'OrdType': order_type,
            'ClOrdID': '*',
            'OrderCapacity': new_order_single_params['OrderCapacity'],
            'TransactTime': '*',
        ...
        fix_verifier_bs.CheckNewOrderSingle(day_order_2, responce_new_order_single, case=case_id_2, message_name='BS FIXBUYTH2 sent 35=D New order Slice 1 Day 2', key_parameters=['OrderQty', 'Price', 'Account', 'TimeInForce'])
        ...
        er_9 = {
            ...
            'ExecType': "A",
            'ExDestination': ex_destination_1,
            'LeavesQty': child_day2_qty
        }

        fix_verifier_bs.CheckExecutionReport(er_9, responce_new_order_single, direction='SECOND', case=case_id_2, message_name='FIXQUODSELL5 sent 35=8 Pending New Slice 1 Day 2', key_parameters=['OrderQty', 'ExecType', 'OrdStatus', 'Price', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_10, responce_new_order_single, direction='SECOND', case=case_id_2,  message_name='FIXQUODSELL5 sent 35=8 Slice 1 Day 2', key_parameters=['OrderQty', 'ExecType', 'OrdStatus', 'Price', 'TimeInForce'])
        ...
        fix_verifier_bs.CheckExecutionReport(er_11, responce_new_order_single, direction='SECOND', case=case_id_9, message_name='BS FIXBUYTH2 sent 35=8 Cancel Day 2',key_parameters=['OrderQty', 'ExecType', 'OrdStatus'])
        ...
        'LeavesQty': '0',
        'NoParty': '*',
        'CumQty': would_price_qty + trade_day_qty,
        'LastPx': '0',
        'OrdType': order_type,
        'ClOrdID': fix_message_new_order_single.get_ClOrdID(),
        'OrderCapacity': new_order_single_params['OrderCapacity'],
        ...
        fix_verifier_ss.CheckExecutionReport(er_12, responce_cancel, case=case_id_9, message_name='SS FIXSELLQUOD5 sent 35=8 Cancel', key_parameters=['Price', 'OrderQty', 'ExecType', 'OrdStatus', 'ClOrdID'])
        #endregion  
    except:
