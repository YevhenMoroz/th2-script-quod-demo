...
class QAP_3526(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_1_reject_rule = rule_manager.add_NewOrderSingle_ExecutionReport_Reject('fix-buy-side-319-kepler', "BATSDARK_KEPLER", "BATD", 20)
        nos_2_reject_rule = rule_manager.add_NewOrderSingle_ExecutionReport_Reject('fix-buy-side-319-kepler', "CHIXDELTA_KEPLER", "CHID", 20)
        ...
        self.rule_list = [nos_1_reject_rule, nos_2_reject_rule, nos_1_fok_rule, ocrr_rule]
        # endregion
