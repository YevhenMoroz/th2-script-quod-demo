...
class QAP_3527(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty = 10000
        self.minQty = 1000
        self.qty_1_child = 5200
        self.qty_2_child = 3100
        self.qty_3_child = 1700
        self.qty_4_child = 6333
        self.qty_5_child = 3667
        self.price = 20
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        cancel_dma_3_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_3_order, self.gateway_side_buy, self.status_eliminate)
        self.fix_verifier_buy.check_fix_message(cancel_dma_3_order, self.key_params, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 3 order")
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(cancel_dma_4_order, self.key_params, self.ToQuod, "Buy Side ExecReport Cancel child DMA 4 order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(cancel_dma_5_order, self.key_params, self.ToQuod, "Buy Side ExecReport Cancel child DMA 5 order")
        # endregion
