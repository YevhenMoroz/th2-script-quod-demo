...
class QAP_3732(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty_1_child = 11200
        self.qty_2_child = 10800
        self.qty_3_child = 12200
        self.qty_4_child = 9800
        self.price = 20
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_3_order.add_tag(dict(MinQty=self.dec_minQty))
        ...
        self.dma_4_order.add_tag(dict(MinQty=self.dec_minQty))
