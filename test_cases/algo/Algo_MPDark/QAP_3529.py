...
class QAP_3529(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.weight_bats = 3
        self.weight_itg = 1
        self.qty_chix_child, self.qty_bats_child, self.qty_itg_child = AlgoFormulasManager.get_child_qty_on_venue_weights(self.qty, None, self.weight_chix, self.weight_bats, self.weight_itg)
        self.price = 20
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ocr_3_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_itg_cboe_tqdarkeu, self.ex_destination_itg, True)
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_itg_order, self.key_params_with_ex_destination, self.ToQuod, "Buy Side ExecReport Cancel child DMA 3 order")
        # endregion
