...
class QAP_3507(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_trade = rule_manager.add_NewOrdSingleExecutionReportTradeByOrdQty('fix-buy-side-319-kepler', "CHIXDELTA_KEPLER", "CHID", 20, 20, 5000, 5000, 10)
        ...
        ocr_1_rule = rule_manager.add_OrderCancelRequest('fix-buy-side-319-kepler', "BATSDARK_KEPLER", "BATD", True)
        ocr_2_rule = rule_manager.add_OrderCancelRequest('fix-buy-side-319-kepler', "CHIXDELTA_KEPLER", "CHID", True)
        self.rule_list = [nos_1_rule, nos_trade, ocrr_rule, nos_1_rule, nos_2_rule, ocr_1_rule, ocr_2_rule]
        # endregion
