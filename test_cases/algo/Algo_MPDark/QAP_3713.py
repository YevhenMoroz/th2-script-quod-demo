...
class QAP_3713(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty = 50000
        self.minQty = 10000
        self.qty_1_child = 16000
        self.qty_2_child = 12000
        self.qty_3_4_child = 11000
        self.price = 20
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_3_order.change_parameters(dict(OrderQty=self.qty_3_4_child, Price=self.price, Instrument=self.instrument))
        ...
        self.dma_4_order.change_parameters(dict(OrderQty=self.qty_3_4_child, Price=self.price, Instrument=self.instrument, TimeInForce=self.tif_fok))
