...
class QAP_T4616(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_1, True, self.qty_child, self.triggerPrice)
        ...
        self.vwap_child.change_parameters(dict(OrderQty=self.qty_child, Price=self.triggerPrice, Account=self.account, Instrument='*', ExDestination=self.ex_destination_1, TimeInForce=self.tif_ioc))
