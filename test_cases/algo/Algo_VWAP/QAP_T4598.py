...
class QAP_T4598(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.vwap_child.change_parameters(dict(Price=self.price_child, OrderQty=self.qty_child, Account=self.account, Instrument='*', ExDestination=self.ex_destination_1))
    ...
    def run_post_conditions(self):
        ...
        cancel_request_pov_order = FixMessageOrderCancelRequest(self.vwap_order)
