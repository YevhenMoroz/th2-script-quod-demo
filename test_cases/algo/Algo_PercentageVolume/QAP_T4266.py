...
class QAP_T4266(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.POV_order_replace_params.add_fields_into_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='EndDate', StrategyParameterType=14, StrategyParameterValue=end_time_mod)])
