...
class QAP_6659(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=1, MDEntrySize=80) # 80 or 50
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_par)
        # endregion

        # region Send_MarketData for LTQ
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data for LTQ", self.test_id))
        ...
        self.fix_manager_feed_handler.set_case_id(case_id_0)
        market_data_snap_shot_par = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.s_par, self.fix_env1.feed_handler)
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=1, MDEntrySize=112)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_par)
        # endregion
        ...
        # # Fill Order
        # fill_dma_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_order, self.gateway_side_buy, self.status_fill)
        ...
        # fill_multilisted_order = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.POV_order, self.gateway_side_sell, self.status_fill)
