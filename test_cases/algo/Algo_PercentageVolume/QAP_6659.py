...
class QAP_6659(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.md_entry_px = 1
        self.md_entry_size_no_child = 80
        self.md_entry_size_child_create = 112
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.md_entry_px, MDEntrySize=self.md_entry_size_no_child) # 80 or 50
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_par)

        # region Set TradingPhase for POV        
        ...
        market_data_snap_shot_par = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.s_par, self.fix_env1.feed_handler)
        market_data_snap_shot_par.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.md_entry_px, MDEntrySize=self.md_entry_size_child_create)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_par)
