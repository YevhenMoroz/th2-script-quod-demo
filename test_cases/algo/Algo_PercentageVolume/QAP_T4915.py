...
class QAP_T4915(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.key_params_cancel = self.data_set.get_verifier_key_parameters_by_name("verifier_key_parameters_with_text")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_dma_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_1, self.price_bid)
        ...
        self.rule_list = [nos_ioc_rule, ocr_rule, nos_dma_rule]
        # endregion
        ...
        self.eliminate_dma_order_1 = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_order_1, self.gateway_side_buy, self.status_eliminate)
        self.fix_verifier_buy.check_fix_message(self.eliminate_dma_order_1, self.key_params, self.ToQuod, "Buy Side ExecReport Eliminate Child DMA 1")
        # endregion
        ...
        self.dma_order_2.change_parameters(dict(OrderQty=self.child_2_qty, Price=self.price_bid, Instrument='*', TimeInForce=self.tif_day))
    ...
    def run_post_conditions(self):
        ...
        # region check cancel child DMA slice 2
        ...
        self.fix_verifier_buy.check_fix_message(cancel_dma_order_2, self.key_params_cancel, self.ToQuod, "Buy Side ExecReport Cancel Child DMA 2")
        # endregion
