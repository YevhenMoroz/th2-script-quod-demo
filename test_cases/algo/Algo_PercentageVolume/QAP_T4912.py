...
class QAP_T4912(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.POV_order_replace_params.update_repeating_group('NoStrategyParameters', [{'StrategyParameterName': 'EndDate', 'StrategyParameterType': 14, 'StrategyParameterValue': end_time_mod},
        ...
        self.dma_order_3.change_parameters(dict(OrderQty=self.qty, Price=self.price, Instrument='*', TimeInForce=self.tif_day))
