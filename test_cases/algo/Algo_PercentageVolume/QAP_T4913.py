...
class QAP_T4913(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.POV_order.add_fields_into_repeating_group_algo('NoStrategyParameters', [['ChildMinQty', 1, 10], ['ChildMinValue', 1, 10], ['Aggressivity', 1, self.aggressivity]])
