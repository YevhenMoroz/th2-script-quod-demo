...
from test_framework.data_sets.constants import StrategyParameterType
...
class QAP_T4278(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.trigger_px_type = 'LastTrade'
        self.offset_val = 5
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.trailingstop_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Instrument=self.instrument))
