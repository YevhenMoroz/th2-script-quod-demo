...
class QAP_T8573(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child1_qty_leg1, self.price_ask)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child2_qty_leg2, self.price_bid_mod)
        ...
        self.dma_order_1.change_parameters(dict(OrderQty=self.child1_qty_leg1, Price=self.price_ask, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*'))
        ...
        self.dma_order_2.change_parameters(dict(OrderQty=self.child2_qty_leg2, Price=self.price_bid_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', Side=self.side_sell, LocateReqd='*'))
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child3_qty_leg1, self.price_ask)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child4_qty_leg2, self.price_bid_mod)
        ...
        self.dma_order_3.change_parameters(dict(OrderQty=self.child3_qty_leg1, Price=self.price_ask, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*'))
        ...
        self.dma_order_4.change_parameters(dict(OrderQty=self.child4_qty_leg2, Price=self.price_bid_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', LocateReqd='*', Side=self.side_sell))
