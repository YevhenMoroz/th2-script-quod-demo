...
class QAP_T7851(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.PairTrad_order_mod.change_parameter('TimeInForce', self.tif_gtc)
    ...
    def run_post_conditions(self):        
        ...
        cancel_PairTrad_order.change_parameter('TimeInForce', self.tif_gtc)
