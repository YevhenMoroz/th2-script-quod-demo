...
class QAP_T8574(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.child2_qty_leg2 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq2, self.qty, self.ratio_leg2, self.round_floor)
        self.child3_qty_leg1 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq1, self.qty, self.ratio_leg1, self.round_ceil)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_incr_par.update_repeating_group_by_index('NoMDEntriesIR', MDEntryPx=self.price_ask, MDEntrySize=self.qty_ltq1)
        ...
        market_data_incr_par.update_repeating_group_by_index('NoMDEntriesIR', MDEntryPx=self.price_bid_mod, MDEntrySize=self.qty_ltq2)
        self.fix_manager_feed_handler.send_message(market_data_incr_par)
        # endregion
        ...
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Set TradingPhase for Leg 1 DP", self.test_id))
        market_data_incr_par = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.leg_1, self.fix_env1.feed_handler)
        market_data_incr_par.update_repeating_group_by_index('NoMDEntriesIR', MDEntryPx=self.price_bid_mod, MDEntrySize=self.qty_ltq1)
        self.fix_manager_feed_handler.send_message(market_data_incr_par)
