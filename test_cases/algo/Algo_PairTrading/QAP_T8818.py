...
class QAP_T8818(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child_qty, self.price_ask_mod, self.delay)
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(self.pending_dma_order_1_params, key_parameters=self.key_params, direction=self.ToQuod, message_name='Buy side ExecReport Fill Child DMA 1')
        # endregion
