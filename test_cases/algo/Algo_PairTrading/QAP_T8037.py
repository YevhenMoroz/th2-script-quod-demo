...
class QAP_T8037(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.qty_ask, self.price_ask_mod)
