...
class QAP_T8579(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child4_qty_leg2, self.price_bid)
        ...
        self.dma_order_4.change_parameters(dict(OrderQty=self.child4_qty_leg2, Price=self.price_bid, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', LocateReqd='*', Side=self.side_sell))
