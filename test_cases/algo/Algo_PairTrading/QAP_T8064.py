...
class QAP_T8064(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.def_conf_value = "true"
        self.mod_conf_value = "false"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.ssh_client.get_and_update_file(self.config_file, {".//PairTrading/usePoV": self.mod_conf_value})
