...
class QAP_T8298(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.pct = 0.1
        self.price_ask_init = 40
        self.price_ask_mod = 32
        self.price_bid = 30
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rej_rule_ = rule_manager.add_NewOrderSingle_ExecutionReport_RejectWithReason(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, self.price_ask_mod, 0)
        ioc_dma_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_trqx, self.ex_destination_trqx, True, self.child_qty, self.price_bid)

        self.rule_list = [ioc_dma_rej_rule_, ioc_dma_rule]
        # endregion
        ...
        self.reject_dma_order_1_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_order_1, self.gateway_side_buy, self.status_reject)
        # endregion
        ...
        # region Check child DMA order 3 Leg 1
        ...
        self.fix_verifier_buy.check_fix_message(self.dma_order_3, key_parameters=self.key_params, message_name='Buy side NewOrderSingle Child DMA Leg 3')

        self.reject_dma_order_3_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_order_3, self.gateway_side_buy, self.status_reject)
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence([self.reject_dma_order_1_params, self.pending_dma_order_2_params, self.new_dma_order_2_params,
                                                          self.fill_dma_order_2_params, self.reject_dma_order_3_params],
                                                         [self.key_params, self.key_params, self.key_params, self.key_params, self.key_params],
