...
class QAP_T8578(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty = self.qty_ltq = 1000
        self.ratio_leg1 = 1.5
        self.ratio_leg2 = 2.5
        self.pct = 0.1
        self.price_ask = 27
        self.price_bid_mod = 17.5
        ...
        self.child3_qty_leg1 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq, self.qty, self.ratio_leg1, self.round_ceil)
        self.child4_qty_leg2 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq, self.qty, self.ratio_leg2, self.round_ceil)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child2_qty_leg2, self.price_ask)
        ...
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Set TradingPhase for Leg 1 DP", self.test_id))
        ...
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Set TradingPhase for Leg 2 SQI", self.test_id))
        ...
        self.dma_order_2.change_parameters(dict(OrderQty=self.child2_qty_leg2, Price=self.price_ask, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', LocateReqd='*'))
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child3_qty_leg1, self.price_bid_mod)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child4_qty_leg2, self.price_ask)
        ...
        self.dma_order_3.change_parameters(dict(OrderQty=self.child3_qty_leg1, Price=self.price_bid_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', Side=self.side_sell, LocateReqd='*'))
        ...
        self.dma_order_4.change_parameters(dict(OrderQty=self.child4_qty_leg2, Price=self.price_ask, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', LocateReqd='*'))

        self.fix_verifier_buy.check_fix_message(self.dma_order_4, key_parameters=self.key_params, message_name='Buy side NewOrderSingle Child DMA 3 Leg 2')
