...
class QAP_T8114(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.child_qty_legs = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq1, self.qty, self.ratio_leg1, self.round_floor)
        self.child_qty2_legs = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.child_qty_legs, self.qty, self.ratio_leg1, self.round_floor)
        self.qty_ltq2 = self.child_qty_legs
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child_qty_legs, self.price_ask_mod)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_trqx, self.ex_destination_trqx, True, self.child_qty_legs, self.price_bid)
        ...
        self.dma_order_1.change_parameters(dict(OrderQty=self.child_qty_legs, Price=self.price_ask_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*'))
        ...
        self.dma_order_2.change_parameters(dict(OrderQty=self.child_qty_legs, Price=self.price_bid, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*',
                                                Account=self.account_trqx, ExDestination=self.ex_destination_trqx, LocateReqd='*', Side=self.side_sell))
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child_qty2_legs, self.price_ask_mod)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_trqx, self.ex_destination_trqx, True, self.child_qty2_legs, self.price_bid)
        ...
        self.dma_order_3.change_parameters(dict(OrderQty=self.child_qty2_legs, Price=self.price_ask_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*'))
        ...
        self.dma_order_4.change_parameters(dict(OrderQty=self.child_qty2_legs, Price=self.price_bid, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*',
                                                Account=self.account_trqx, ExDestination=self.ex_destination_trqx, LocateReqd='*', Side=self.side_sell))
