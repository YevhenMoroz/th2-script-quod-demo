...
class QAP_T9174(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.child_qty_leg1 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq, self.qty, self.ratio_leg1, self.round)
        self.child_qty_leg2 = AlgoFormulasManager.get_pov_child_qty_on_ltq(self.pct, self.qty_ltq, self.qty, self.ratio_leg2, self.round)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ioc_dma_rule_1 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child_qty_leg1, self.price_ask)
        ioc_dma_rule_2 = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_par, self.ex_destination_par, True, self.child_qty_leg2, self.price_bid_mod)
        ...
        self.dma_order_1.change_parameters(dict(OrderQty=self.child_qty_leg1, Price=self.price_ask, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*'))
        ...
        self.dma_order_2.change_parameters(dict(OrderQty=self.child_qty_leg2, Price=self.price_bid_mod, Instrument='*', TimeInForce=self.tif_ioc, PositionEffect='*', Side=self.side_sell, LocateReqd='*'))
