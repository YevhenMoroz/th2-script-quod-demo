...
class QAP_T4546(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        reject_iceberg_order_params.remove_parameter('ExecRestatementReason').change_parameters(dict(TargetStrategy='*', Text=FreeNotesReject.DispQtyNegOrZero.value, OrdRejReason='*'))
