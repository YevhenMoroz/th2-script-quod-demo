...
class QAP_T4545(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        reject_iceberg_order_params.remove_parameter('ExecRestatementReason').change_parameters(dict(TargetStrategy='*', Text=FreeNotesReject.DispQtyGtThanOrdQty.value, OrdRejReason='*'))
