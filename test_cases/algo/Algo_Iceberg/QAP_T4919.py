...
class QAP_T4919(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.inc_display_qty = self.inc_dma1_qty = 100
        self.price = 20
        self.price_ask = 40
        self.price_bid = 30
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [ocr_rule, ocrr_rule, nos_rule]
        # endregion
        ...
        self.iceberg_order_replace_params.add_tag(dict(DisplayInstruction=dict(DisplayQty=self.inc_display_qty)))
        ...
        cancel_dma_1_order.change_parameter('OrderQty', self.inc_dma1_qty)
    ...
    def run_post_conditions(self):
        ...
        cancel_iceberg_order_params.change_parameters(dict(SettlType='*', NoParty='*', DisplayInstruction=dict(DisplayQty=self.inc_display_qty))).remove_parameters(['NoStrategyParameters', 'SecondaryAlgoPolicyID'])
