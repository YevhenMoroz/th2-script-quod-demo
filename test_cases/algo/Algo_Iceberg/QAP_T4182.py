...
class QAP_T4182(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.expire_date = (self.now + timedelta(days=5)).strftime("%Y%m%d")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        new_iceberg_order_params.remove_parameter('SecondaryAlgoPolicyID')
    ...
    def run_post_conditions(self):
        ...
        # self.fix_manager_sell.send_message(cancel_request_iceberg_order)
        ...
        reject_iceberg_order_params = FixMessageOrderCancelRejectReportAlgo().set_params_from_new_order_single(self.iceberg_order, self.gateway_side_sell, self.status_new)
        reject_iceberg_order_params.change_parameters(dict(Text='market has closed', ExecRestatementReason='*'))
        self.fix_verifier_sell.check_fix_message(reject_iceberg_order_params, key_parameters=self.key_params, message_name='Sell side ExecReport Cancel Reject')
        # endregion
