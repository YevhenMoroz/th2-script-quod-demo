...
class QAP_T5017(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Iceberg_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, DisplayInstruction=dict(DisplayQty=self.display_qty))).add_tag(dict(ShortCode="test tag 5009"))
