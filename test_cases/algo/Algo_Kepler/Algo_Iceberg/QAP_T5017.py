...
class QAP_T5017(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.misc_number = constants.MiscNumber.ordr_misc_5.value
        # endregion

        # region Compare message parameters
        # self.param1 = constants.MiscNumber.ordr_misc_5.value
