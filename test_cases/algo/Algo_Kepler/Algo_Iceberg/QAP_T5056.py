...
class QAP_T5056(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Iceberg_order_replace_params.change_parameters(dict(DisplayInstruction=dict(DisplayQty=self.inc_display_qty)))
