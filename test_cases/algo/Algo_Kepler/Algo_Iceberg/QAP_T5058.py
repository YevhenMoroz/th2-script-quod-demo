...
class QAP_T5058(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_reject_replaced_Iceberg_order_params.change_parameters(dict(CxlRejResponseTo='2', Text="11603 'DisplayQty' (0) negative or zero")).add_tag(dict(Account=self.account))
