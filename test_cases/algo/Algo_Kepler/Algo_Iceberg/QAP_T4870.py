...
class QAP_T4870(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Iceberg_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Instrument=self.instrument, Price=self.price, Currency=self.currency, DisplayInstruction=dict(DisplayQty=self.display_qty)))
        ...
        self.dma_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_child_of_LitDark_Iceberg_Kepler_params()
