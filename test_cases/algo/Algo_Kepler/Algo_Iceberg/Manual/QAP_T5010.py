...
class QAP_T5010(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Iceberg_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Instrument=self.instrument, Price=self.price, ExDestination=self.ex_destination_qdl1, TimeInForce=self.tif_gtc, DisplayInstruction=dict(DisplayQty=self.display_qty)))
