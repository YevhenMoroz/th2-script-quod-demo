...
class QAP_T4892(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.ChildExpireDate=(now + timedelta(days=2)).strftime("%Y%m%d")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_order.add_tag(dict(MinQty=self.min_qty, StopPx=self.stop_price, ExpireDate=self.ChildExpireDate))
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_order, key_parameters=self.key_params_NOS_child_with_minqty, message_name='Buy side NewOrderSingle Child DMA 1 order')
        ...
        self.SORPING_STL_GTD_Iceberg_MinQty_order_replace_params.change_parameters(dict(ExpireDate=self.NewExpireDate))
        ...
        er_replaced_dma_order_params.change_parameters(dict(ExpireDate=self.NewExpireDate))
        self.fix_verifier_buy.check_fix_message_kepler(er_replaced_dma_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy Side ExecReport Replace Request')
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 2 order")
