...
class QAP_T4861(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # market_data_snap_shot_qdl6.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.px_for_incr, MDEntrySize=self.qty_for_incr, TradingSessionSubID=4, SecurityTradingStatus=2)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl6)
        ...
        # market_data_snap_shot_qdl7.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.px_for_incr, MDEntrySize=self.qty_for_incr, TradingSessionSubID=4, SecurityTradingStatus=2)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl7)
