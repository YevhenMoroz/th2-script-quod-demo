...
class QAP_T4830(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_eliminate_SORPING_STL_Iceberg_MinQty_order_params.add_tag(dict(Text='Iceberg synthesisation forbidden by algorithm parameters - child order blocked by internal validation'))
