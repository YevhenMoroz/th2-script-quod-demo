...
class QAP_T4852(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_STL_Iceberg_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, OrdType=self.order_type_stop_lmt)).add_tag(dict(MinQty=self.min_qty, StopPx=self.stop_price, DisplayInstruction=dict(DisplayQty=self.display_qty)))
