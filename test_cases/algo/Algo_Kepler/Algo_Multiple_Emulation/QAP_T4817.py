...
class QAP_T4817(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_STL_GTC_Iceberg_MinQty_order_replace_params.change_parameters(dict(DisplayInstruction=dict(DisplayQty=self.inc_display_qty)))
        ...
        self.dma_2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit6, OrderQty=self.inc_display_qty, Price=self.price, Instrument=self.instrument, OrdType=self.order_type_stop_lmt, TimeInForce=self.tif_gtd))
