...
class QAP_T4875(TestCase):
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.er_cancel_dma_1_order, self.er_cancel_dma_2_order], [self.key_params_ER_child, self.key_params_ER_child], self.ToQuod, pre_filter=self.pre_filter, check_order=False)
