...
class QAP_T4863(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_MinQty_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price)).add_tag(dict(MinQty=self.min_qty))
