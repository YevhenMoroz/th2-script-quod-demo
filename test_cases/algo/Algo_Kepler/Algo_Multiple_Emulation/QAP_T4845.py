...
class QAP_T4845(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_order.add_tag(dict(MinQty=self.min_qty, StopPx=self.stop_price, ExpireDate=self.ExpireDate))
    ...
    def run_post_conditions(self):
        ...
        er_cancel_SORPING_STL_GTD_Iceberg_MinQty_order_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.SORPING_STL_GTD_Iceberg_MinQty_order, self.gateway_side_sell, self.status_cancel)
