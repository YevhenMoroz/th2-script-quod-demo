...
class QAP_T4829(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_eliminate_SORPING_STL_GTC_Iceberg_order_params.add_tag(dict(Text='Multi-day expiry adjustment forbidden by algorithm parameters - child order blocked by internal validation'))
