...
class QAP_T4805(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_pending_new_SORPING_GTD_order_params.change_parameters(dict(ExpireDate=self.NewExpireDate))
        ...
        er_new_SORPING_GTD_order_params.change_parameters(dict(ExpireDate=self.NewExpireDate))
    ...
    def run_post_conditions(self):
        ...
        er_cancel_SORPING_GTD_order_params.change_parameters(dict(ExpireDate=self.NewExpireDate))
