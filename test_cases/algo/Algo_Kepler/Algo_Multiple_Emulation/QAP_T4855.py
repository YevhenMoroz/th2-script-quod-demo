...
class QAP_T4855(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_STL_GTD_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, TimeInForce=self.tif_gtd, OrdType=self.order_type_stop_lmt)).add_tag(dict(ExpireDate=self.ExpireDate, StopPx=self.stop_price))
