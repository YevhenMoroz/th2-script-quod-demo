...
class QAP_T4820(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_2_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit6, self.dec_price)
        ...
        self.SORPING_STL_GTC_Iceberg_MinQty_order_replace_params.change_parameters(dict(Price=self.dec_price))
