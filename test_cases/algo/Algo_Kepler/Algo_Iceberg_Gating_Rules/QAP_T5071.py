...
class QAP_T5071(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        # region venue param
        self.ex_destination_xpar = self.data_set.get_mic_by_name("mic_28")
        self.client = self.data_set.get_client_by_name("client_4")
        self.account_xpar = self.data_set.get_account_by_name("account_9")
        self.listing_id_par = self.data_set.get_listing_id_by_name("listing_27")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.Iceberg_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_Kepler_Iceberg_params_with_algopolicy()
