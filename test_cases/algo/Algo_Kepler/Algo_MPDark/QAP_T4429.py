...
class QAP_T4429(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty_2_chix_child, self.qty_2_bats_child = AlgoFormulasManager.get_child_qty_on_venue_weights(self.qty_1_bats_child, None, self.weight_chix, self.weight_bats)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_fill_dma_1_chix_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Fill Child DMA 1 order on venue CHIX DARKPOOL UK')
        # endregion
        ...
        order_cancel_batsdark = FixMessageOrderCancelRequestAlgo().set_cancel_params_for_child(self.dma_1_bats_order)
        self.fix_verifier_buy.check_fix_message_sequence([rfq_cancel_chixlis, rfq_cancel_trqx, order_cancel_batsdark], key_parameters_list=[None, None, None], direction=self.FromQuod, pre_filter=self.pre_filter_1)
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence([nos_chixlis_rfq, nos_trql_rfq, self.dma_1_chix_order, self.dma_1_bats_order], key_parameters_list=[None, None, None, None], direction=self.FromQuod, pre_filter=self.pre_filter_2)
        # endregion
        ...
        self.fix_verifier_buy.set_case_id(bca.create_event("Check cancel 1 child DMA order on venue BATS DARKPOOL UK", self.test_id))
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_1_bats_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 1 order on venue BATS DARKPOOL UK")
        # endregion
