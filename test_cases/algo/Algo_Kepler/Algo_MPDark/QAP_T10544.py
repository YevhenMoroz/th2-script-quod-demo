...
class QAP_T10544(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_chixlis_rfq, key_parameters=self.key_params_NOS_child, message_name='Buy side RFQ on CHIXLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_chixlis_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew LIS Child order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_chixlis_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New LIS Child order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_partial_fill_dma_chixlis_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Partial fill LIS Child order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_chixlis_rfq_2, key_parameters=self.key_params_NOS_child, message_name='Buy side RFQ on CHIXLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_trql_rfq_2, key_parameters=self.key_params_NOS_child, message_name='Buy side RFQ on TQLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_chixdelta_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle dark child on chix_delta')
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([nos_chixlis_rfq, nos_trql_rfq, dma_chixlis_order, nos_chixlis_rfq_2, nos_trql_rfq_2, self.dma_chixdelta_order], [None, None, None, None, None, None], self.FromQuod, pre_filter=self.pre_filter)
