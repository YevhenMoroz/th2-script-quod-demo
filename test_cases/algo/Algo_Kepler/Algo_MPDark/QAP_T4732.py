...
class QAP_T4732(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_1_chix_order.change_parameters(dict(Account=self.account_chix, ExDestination=self.ex_destination_chix, OrderQty=self.qty_chix_1_child))
        ...
        self.MP_Dark_order_replace_params.change_parameters(dict(MinQty=self.inc_minQty))
        ...
        self.dma_2_chix_order.change_parameters(dict(Account=self.account_chix, ExDestination=self.ex_destination_chix, OrderQty=self.qty_chix_2_child))
