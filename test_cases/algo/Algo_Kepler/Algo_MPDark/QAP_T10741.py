...
class QAP_T10741(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.dec_qty = 5000
        self.price = 20
        self.delay_for_rfq_accept = 3450
        self.delay_for_rfq_cancel = 1000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rfq_cancel_rule = rule_manager.add_OrderCancelRequestRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_trqx, True, self.delay_for_rfq_cancel)
