...
class QAP_8219(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.chix_weight = 60
        self.bats_weight = 40
        self.qty_chix_child = self.qty_bats_child = AlgoFormulasManager.get_child_qty_on_venue_weights(self.qty, self.min_qty, self.chix_weight, self.bats_weight)[0]
        self.price = 20
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_reject_rule = rule_manager.add_NewOrderSingle_ExecutionReport_RejectWithReason(self.fix_env1.buy_side, self.account_chix, self.ex_destination_chix, self.price, self.reason, self.text, self.delay)
        ...
        self.rule_list = [nos_reject_rule, nos_2_rule, ocr_2_rule]
        # endregion
        ...
        self.MP_Dark_order.change_parameters(dict(Account=self.client, OrderQty=self.qty)).add_tag(dict(MinQty=self.min_qty))
