...
class QAP_T11564(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_api_manager.remove_parameters(self.algopolicy, "DarkPoolsSequence")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_batsdark_order, self.dma_itg_order], [self.key_params_NOS_child, self.key_params_NOS_child], self.FromQuod, pre_filter=self.pre_filter, check_order=False)
        # endregion
    ...
    def run_post_conditions(self):
        ...
        new_parameter = {
            "algoParameterValue": "BATSDARK/ITG/ITGIPA",
            "isEditable": "true",
            "isVisible": "true",
            "scenarioParameterName": "DarkPoolsSequence",
            "scenarioParameterRequired": "false",
            "scenarioParameterType": "V",
        }
