...
class QAP_T4745(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rfq_rule = rule_manager.add_NewOrdSingleRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.qty, self.qty, self.new_reply, self.restated_reply, 15000)
        ...
        self.rule_list = [rfq_rule, rfq_cancel_rule, new_order_single, cancel_rule, new_order_single_BATD, new_order_single_CHID, cancel_rule_BATD, cancel_rule_CHID]
        # endregion
