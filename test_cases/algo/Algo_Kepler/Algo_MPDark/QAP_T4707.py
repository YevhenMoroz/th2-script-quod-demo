...
class QAP_T4707(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, True)
        self.rule_list = [rfq_1_rule, rfq_cancel_rule, nos_rule, ocr_rule]
        # endregion
