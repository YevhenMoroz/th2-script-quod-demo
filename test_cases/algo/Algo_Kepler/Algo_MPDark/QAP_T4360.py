...
class QAP_T4360(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_partial_fill_dma_1_chix_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Partial Fill Child DMA 1 order on venue CHIX DARKPOOL UK')
        # endregion
        ...
        order_cancel_chixdelta = FixMessageOrderCancelRequestAlgo().set_cancel_params_for_child(self.dma_1_chix_order).add_tag(dict(misc5='*'))
