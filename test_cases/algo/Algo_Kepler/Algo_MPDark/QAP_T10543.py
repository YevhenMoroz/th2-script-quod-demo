...
class QAP_T10543(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty = 3000000
        self.price = 20
        self.delay_for_rfq_new = 5000
        self.delay_for_rfq_restated = 15000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rfq_new_rule = rule_manager.add_NewOrdSingleRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.qty, self.qty, True, False, self.delay_for_rfq_new)
        ...
        rfq_restated_rule = rule_manager.add_NewOrdSingleRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.qty, self.qty, False, True, self.delay_for_rfq_restated)
        self.rule_list = [rfq_new_rule, rfq_cancel_rule, nos_rule, ocr_rule, rfq_restated_rule]
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_chix_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle dark child on the CHIXDELTA')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_chix_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew dark child on the CHIXDELTA')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_chix_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New dark child on the CHIXDELTA')
        # endregion
