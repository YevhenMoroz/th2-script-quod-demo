...
class QAP_T11566(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "AllowedVenues", AlgoFormulasManager.create_string_for_strategy_venues("BATSDARK", "ITG", "ITGIPA"))
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_batsdark_order, self.dma_itg_order, self.dma_itgipa_order], [self.key_params_NOS_child, self.key_params_NOS_child, self.key_params_NOS_child], self.FromQuod, pre_filter=self.pre_filter)
        # endregion
