...
class QAP_T11563(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "DarkPoolsSequence", AlgoFormulasManager.create_string_for_strategy_venues("BATSDARK", "ITG"))
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "AllowedVenues", AlgoFormulasManager.create_string_for_strategy_venues("ITG", "BATSDARK", "ITGIPA", "COPENHAGENPA"))
        # endregion
        ...
        nos_3_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_kepler, self.ex_destination_itgipa, self.price)
        nos_4_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_kepler, self.ex_destination_copenhagenpa, self.price)
        ...
        ocr_3_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_kepler, self.ex_destination_itgipa, True)
        ocr_4_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_kepler, self.ex_destination_copenhagenpa, True)
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_itgipa_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 3 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(order_cancel_request_dma_itgipa_order, key_parameters=self.key_params_OCR_child, message_name='Buy side OrderCancelRequest Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Cancel Child DMA 3 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_copenhagenpa_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 4 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(order_cancel_request_dma_copenhagenpa_order, key_parameters=self.key_params_OCR_child, message_name='Buy side OrderCancelRequest Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Cancel Child DMA 4 order')
        # endregion

        # region Check that are only dark childs on venues defined in the AllowedVenues were created
        self.fix_verifier_buy.set_case_id(bca.create_event("Check that are only dark childs on venues defined in the AllowedVenues were created", self.test_id))

        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_batsdark_order, self.dma_itg_order, self.dma_itgipa_order, self.dma_copenhagenpa_order], [self.key_params_NOS_child, self.key_params_NOS_child, self.key_params_NOS_child, self.key_params_NOS_child], self.FromQuod, pre_filter=self.pre_filter, check_order=False)
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "AllowedVenues", AlgoFormulasManager.create_string_for_strategy_venues("BATSDARK", "ITG"))
        # endregion
