...
class QAP_T11554(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "DarkPoolWeights", AlgoFormulasManager.create_string_for_strategy_weight(dict(CHIXDELTA=6, BATSDARK=4)))
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "AllowedVenues", AlgoFormulasManager.create_string_for_strategy_venues("CHIXDELTA", "BATSDARK", "CBOEEU", "ITG"))
        # endregion
        ...
        # region Check that are only two dark childs on venues defined in the AllowedVenues were created
        self.fix_verifier_buy.set_case_id(bca.create_event("Check that are only two dark childs on venues defined in the AllowedVenues were created", self.test_id))
