...
class QAP_3733(TestCase):
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_tqdarkeu_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 5 order on venue TURQUOISE DARKPOOL EU")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_tqdark_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 6 order on venue TURQUOISE DARKPOOL UK")
        # endregion
