...
class QAP_T4581(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.read_log_verifier = ReadLogVerifierAlgo("log319-quote-request", self.test_id)
        self.read_log_verifier2 = ReadLogVerifierAlgo("log319-other-quote-requests-terminated", self.test_id)
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rfq_rule = rule_manager.add_NewOrdSingleRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.qty, self.qty, self.new_reply, self.restated_reply, 3000)
        rfq_rule_reject = rule_manager.add_NewOrderSingle_RFQ_Reject(self.fix_env1.buy_side, self.client, self.ex_destination_trql, self.qty, 0)
        ...
        self.rule_list = [rfq_rule, rfq_cancel_rule, rfq_rule_reject, new_order_single, cancel_rule]
        # endregion
