...
class QAP_T10726(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text = "Algorithm terminated"
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_chix, self.ex_destination_chix, False)
        ...
        # region Check that the Cancel request is rejected
        er_reject_cancel_dma_chix_order = FixMessageOrderCancelRejectReportAlgo().set_params_from_new_order_single(self.dma_chix_order, self.gateway_side_buy, self.status_reject)
        self.fix_verifier_buy.check_fix_message_kepler(er_reject_cancel_dma_chix_order, self.key_params_ER_cancel_reject_child, self.ToQuod, "Buy Side OrderCancelRejectReport child DMA 1 order")
        # endregion
        ...
        self.read_log_verifier.set_case_id(bca.create_event("Check that the parent order is terminated", self.test_id))
