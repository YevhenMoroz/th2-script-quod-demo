...
class QAP_T11569(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_api_manager.modify_strategy_parameter(self.algopolicy, "AllowedVenues", AlgoFormulasManager.create_string_for_strategy_venues("BATSDARK", "COPENHAGENPA", "ITGIPA"))
        # endregion
        ...
        self.rule_list = [nos_1_rule, nos_3_rule, nos_4_rule, ocr_1_rule, ocr_3_rule, ocr_4_rule]
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_itgipa_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 2 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 2 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 2 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(order_cancel_request_dma_itgipa_order, key_parameters=self.key_params_OCR_child, message_name='Buy side OrderCancelRequest Child DMA 2 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_itgipa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Cancel Child DMA 2 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_copenhagenpa_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 3 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(order_cancel_request_dma_copenhagenpa_order, key_parameters=self.key_params_OCR_child, message_name='Buy side OrderCancelRequest Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_copenhagenpa_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Cancel Child DMA 3 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_batsdark_order, self.dma_itgipa_order, self.dma_copenhagenpa_order], [self.key_params_NOS_child, self.key_params_NOS_child, self.key_params_NOS_child], self.FromQuod, pre_filter=self.pre_filter)
        # endregion
