...
class QAP_3500(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.MP_Dark_order_replace_params.change_parameters(dict(OrderQty=self.inc_qty)).add_tag(dict(MinQty=self.minQty, IClOrdIdAO='OD_5fgfDXg-00', ShortCode='17536'))
