...
class QAP_T10530(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(dma_chixlis_order, key_parameters=self.key_params_NOS_LIS, message_name='Buy side send the child order on the CHIXLIS', direction=self.FromQuod)
