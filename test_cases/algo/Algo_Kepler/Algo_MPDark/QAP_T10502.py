...
class QAP_T10502(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_3_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_cboe, self.ex_destination_cboe, self.dec_price)
        ...
        self.MP_Dark_order_replace_params.change_parameters(dict(Price=self.dec_price))
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_replace_dma_chix_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport CancelReplace child DMA 1 order on venue CHIX DARKPOOL UK")
        # endregion
        ...
        self.dma_cboe_order.change_parameters(dict(Account=self.account_cboe, ExDestination=self.ex_destination_cboe, OrderQty=self.qty, Price=self.dec_price, Instrument=self.instrument))
