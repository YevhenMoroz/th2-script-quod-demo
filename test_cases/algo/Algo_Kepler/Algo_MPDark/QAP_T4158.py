...
class QAP_T4158(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_chixlis_1_rfq, key_parameters=self.key_params_with_ex_destination, message_name='Buy side 1st RFQ on CHIXLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_trql_1_rfq, key_parameters=self.key_params_with_ex_destination, message_name='Buy side 1st RFQ on TQLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_chixlis_2_rfq, key_parameters=self.key_params_with_ex_destination, message_name='Buy side 2nd RFQ on CHIXLIS')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(nos_trql_2_rfq, key_parameters=self.key_params_with_ex_destination, message_name='Buy side 2nd RFQ on TQLIS')
        # endregion
