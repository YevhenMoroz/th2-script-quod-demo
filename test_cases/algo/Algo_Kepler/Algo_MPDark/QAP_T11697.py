...
class QAP_T11697(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.algopolicy = 'QA_Auto_DarkPool_Spray_AV'
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        rfq_rule_chix_lis = rule_manager.add_NewOrdSingleRFQExecutionReport(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.qty, self.qty, self.new_reply, self.restated_reply, 0)
        ...
        nos_8_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.price)
        nos_trade_rule = rule_manager.add_NewOrdSingleExecutionReportTradeByOrdQty(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, self.price, self.price, self.qty, 990000, 0)
        ocr_8_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.client, self.ex_destination_chixlis, True)
        self.rule_list = [nos_8_rule, nos_trade_rule, ocr_8_rule, rfq_rule_chix_lis, nos_1_rule, nos_2_rule, nos_3_rule, nos_4_rule, nos_5_rule, nos_6_rule, ocr_1_rule, ocr_2_rule, ocr_3_rule, ocr_4_rule, ocr_5_rule, ocr_6_rule, rfq_cancel_rule]
        # endregion
        ...
        self.dma_cboe_order.change_parameters(dict(Account=self.account_itg_cboe_tqdarkeu, ExDestination=self.ex_destination_cboe, OrderQty=self.qty_cboe_child))
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_itg_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_itg_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_itg_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 4 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_tqdarkeu_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 5 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_tqdarkeu_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 5 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_tqdarkeu_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 5 order')
        # endregion
        ...
        self.dma_tqdark_order.change_parameters(dict(Account=self.account_tqdark, ExDestination=self.ex_destination_tqdark, OrderQty=self.qty_tqdark_child, Price=self.price, Instrument='*'))
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_tqdark_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 6 order on venue TURQUOISE DARKPOOL UK')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_tqdark_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Child DMA 6 order on venue TURQUOISE DARKPOOL UK')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_tqdark_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Child DMA 6 order on venue TURQUOISE DARKPOOL UK')
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_bats_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel first DMA 2 order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_cboe_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 3 order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_itg_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 4 order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_tqdarkeu_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 5 order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_tqdark_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 6 order")
        # endregion
