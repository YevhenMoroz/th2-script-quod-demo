...
class QAP_T4713(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_1_market_rule = rule_manager.add_NewOrdSingle_Market(self.fix_env1.buy_side, self.account_chix, self.ex_destination_chix, True, self.qty_chix_child, 0)
        nos_2_market_rule = rule_manager.add_NewOrdSingle_Market(self.fix_env1.buy_side, self.account_bats, self.ex_destination_bats, True, self.qty_bats_child, 0)
