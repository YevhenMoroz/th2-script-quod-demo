...
class QAP_T4713(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_bats_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Fill Child DMA order on venue BATS DARKPOOL UK')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_chix_order, self.dma_bats_order], key_parameters_list=[None, None], direction=self.FromQuod, pre_filter=self.pre_filter)
        # endregion
