...
class QAP_T10700(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.nos_2_chixlis_rfq = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_RFQ_params().change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.inc_price, ExDestination=self.ex_destination_chixlis, Instrument='*'))
        ...
        self.nos_2_trql_rfq = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_RFQ_params().change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.inc_price, ExDestination=self.ex_destination_trql, Instrument='*'))
