...
class QAP_3159(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_STL_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_Multiply_Emulation_params()
        ...
        self.dma_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_Child_of_Multiply_Emulation_params()
