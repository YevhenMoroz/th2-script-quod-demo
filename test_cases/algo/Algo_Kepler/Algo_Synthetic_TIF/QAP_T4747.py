...
class QAP_T4747(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.tif_gtd = constants.TimeInForce.GoodTillCancel.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # TODO Need edit rules for this test
        ...
        self.Synthetic_TIF_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, TimeInForce=self.tif_gtd)).add_fields_into_repeating_group('NoStrategyParameters', self.no_strategy_1)
