...
class QAP_T7887(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_reject_SORPING_order_params.remove_parameters(['SecondaryAlgoPolicyID', 'ExecRestatementReason', 'Currency']).add_tag(dict(OrdRejReason='*')).change_parameters(dict(Text=(self.text_1, self.text_2), Price='*'))
