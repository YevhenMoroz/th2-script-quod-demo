...
class QAP_T4973(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.listing_id_qdl1 = self.data_set.get_listing_id_by_name("listing_17")
        self.listing_id_qdl2 = self.data_set.get_listing_id_by_name("listing_18")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.qty, Price=self.price, Side=self.sell, Instrument=self.instrument))
