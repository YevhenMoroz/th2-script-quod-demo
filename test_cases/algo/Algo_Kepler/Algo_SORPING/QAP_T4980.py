...
class QAP_T4980(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_order_replace_params.change_parameters(dict(Price=self.inc_price, OrderQty=self.dec_qty))
        ...
        self.dma_2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_par, OrderQty=self.display_qty, Price=self.inc_price, Instrument=self.instrument))
