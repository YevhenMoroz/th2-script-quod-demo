...
class QAP_T4972(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.qty, Price=self.price, Side=self.sell))
