...
class QAP_T4874(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_reject_replaced_SORPING_order_params.change_parameters(dict(CxlRejResponseTo='2', Text='order about to be filled (pending aggressive child orders)'))
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill Aggressive child DMA 2 order")
        # endregion
