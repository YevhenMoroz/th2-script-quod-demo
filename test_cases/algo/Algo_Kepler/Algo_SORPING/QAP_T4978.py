...
class QAP_T4978(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_1_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_batsdark, self.ex_destination_batsdark, False, self.traded_qty, self.price)
        nos_2_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account_chixdark, self.ex_destination_chixdark, False, self.traded_qty, self.price)
        ...
        nos_2_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_par, self.dec_price)
        ...
        self.dma_qdpkp1_order.change_parameters(dict(Account=self.account_chixdark, ExDestination=self.ex_destination_chixdark, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, TimeInForce=self.tif_iok))
        ...
        self.dma_qdpkp2_order.change_parameters(dict(Account=self.account_batsdark, ExDestination=self.ex_destination_batsdark, OrderQty=self.qty, Price=self.price, Instrument=self.instrument, TimeInForce=self.tif_iok))
        ...
        self.dma_1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_par, OrderQty=self.display_qty, Price=self.price, Instrument=self.instrument))
        ...
        er_pending_new_dma_1_order_params.change_parameters(dict(ExDestination=self.ex_destination_par))
        ...
        er_new_dma_1_order_params.change_parameters(dict(ExDestination=self.ex_destination_par))
        ...
        self.SORPING_order_replace_params.change_parameters(dict(OrderQty=self.inc_qty, Price=self.dec_price, DisplayInstruction=dict(DisplayQty=self.inc_display_qty)))
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_1_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 1 order")
        # endregion
        ...
        self.dma_2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_par, OrderQty=self.inc_display_qty, Price=self.dec_price, Instrument=self.instrument))
        ...
        er_pending_new_dma_2_order_params.change_parameters(dict(ExDestination=self.ex_destination_par))
        ...
        er_new_dma_2_order_params.change_parameters(dict(ExDestination=self.ex_destination_par))
    ...
    def run_post_conditions(self):
        ...
        # self.fix_verifier_buy.check_fix_message(er_cancel_dma_2_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Cancel child DMA 2 order")
        # # endregion
        #
