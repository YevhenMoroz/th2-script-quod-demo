...
class QAP_T4873(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_GTC_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Price=self.price, TimeInForce=self.tif_gtc, Instrument=self.instrument))
        ...
        self.dma_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit1, OrderQty=self.qty, Price=self.price, Instrument=self.instrument))
