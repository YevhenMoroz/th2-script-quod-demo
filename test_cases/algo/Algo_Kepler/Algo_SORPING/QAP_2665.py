...
class QAP_2665(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_1_ask_qdl2 = 44
        self.qty_1_ask_qdl2 = 1000
        self.price_bid_qdl2 = 30
        self.qty_bid_qdl2 = 1000
        self.price_2_ask_qdl2 = 42
        self.qty_2_ask_qdl2 = 1000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_1_qdl1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit1, OrderQty=self.qty_aggressive_qdl1, Price=self.price_aggressive_qdl1, TimeInForce=self.tif_iok))
        ...
        self.dma_1_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.qty_aggressive_qdl2, Price=self.price_aggressive_qdl2, TimeInForce=self.tif_iok))
        ...
        er_partial_fill_dma_2_qdl1_order.change_parameters(dict(CumQty=self.qty_2_ask_qdl2, LeavesQty=self.modify_qty_passive_qdl1, LastQty=self.qty_2_ask_qdl2, LastPx=self.price_2_ask_qdl2))
