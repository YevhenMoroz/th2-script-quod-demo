...
class QAP_T4996(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_bid = 30
        self.algo_Cst = 'TestCLIENTACCOUNT'

        self.no_party = [
            {'PartyID': 'TestCLIENTACCOUNT', 'PartyIDSource': 'D',
             'PartyRole': '24'}
           ]
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_qdl1_order.remove_parameter('AlgoCst01').add_tag(dict(AlgoCst03=self.algo_Cst))
