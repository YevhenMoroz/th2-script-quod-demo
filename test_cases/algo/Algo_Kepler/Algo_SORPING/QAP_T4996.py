...
class QAP_T4996(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.misc_number = constants.MiscNumber.ordr_misc_0.value
        # endregion

        # region Compare message parameters
        # self.param1 = constants.ReadLogParams.party_id.value
        # self.param2 = constants.MiscNumber.ordr_misc_0.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_qdl1_order.add_tag(dict(AlgoCst03=self.party_id))
