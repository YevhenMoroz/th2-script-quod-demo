...
class QAP_T5002(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_2_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Lit passive Child DMA order on venue QDL1: OldQty=13000, NewQty=12000, price=45")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_3_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel Lit passive Child DMA order on venue QDL1: OldQty=12000, NewQty=11000, price=45")
        # endregion
