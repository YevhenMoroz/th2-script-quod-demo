...
class QAP_T5002(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        market_data_snap_shot_qdl3.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask_qdl3, MDEntrySize=self.qty_for_md_qdl3)
        ...
        market_data_snap_shot_qdl1 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_id_qdl1, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl1.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask_qdl1, MDEntrySize=0)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl1)

        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data", self.test_id))
        market_data_snap_shot_qdl2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_id_qdl2, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask_qdl2, MDEntrySize=0)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl2)
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_qdpkp1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Dark child DMA order on venue QUODDKP1')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_eliminate_dma_qdpkp1_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Eliminate Dark child DMA order on venue QUODDKP1")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_qdpkp2_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Dark child DMA order on venue QUODDKP2')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_eliminate_dma_qdpkp2_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Eliminate Dark child DMA order on venue QUODDKP2")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_1_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle 1st Lit aggressive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill 1st Lit aggressive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_1_qdl2_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle 2nd Lit aggressive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_1_qdl2_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill 2nd Lit aggressive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_2_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle 1st Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 1st Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 1st Lit passive Child DMA order')
        # endregion
        ...
        self.SORPING_order_replace_1_params = FixMessageOrderCancelReplaceRequestAlgo(self.SORPING_order)
        self.SORPING_order_replace_1_params.change_parameters(dict(Price=self.dec_price))
        self.fix_manager_sell.send_message_and_receive_response(self.SORPING_order_replace_1_params, case_id_2)

        self.fix_verifier_sell.check_fix_message(self.SORPING_order_replace_1_params, direction=self.ToQuod, message_name='Sell side OrderCancelReplaceRequest')

        time.sleep(5)

        er_replaced_1_SORPING_order_params = FixMessageExecutionReportAlgo().set_params_from_order_cancel_replace(self.SORPING_order_replace_1_params, self.gateway_side_sell, self.status_cancel_replace)
        er_replaced_1_SORPING_order_params.change_parameters(dict(OrdStatus=1))
        self.fix_verifier_sell.check_fix_message(er_replaced_1_SORPING_order_params, key_parameters=self.key_params_ER_parent, message_name='Sell Side ExecReport Replace Request')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_2_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel 1st Lit passive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_3_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle 2nd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_3_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 2nd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_3_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 2nd Lit passive Child DMA order')
        # endregion
        ...
        self.SORPING_order_replace_2_params = FixMessageOrderCancelReplaceRequestAlgo(self.SORPING_order)
        self.SORPING_order_replace_2_params.change_parameters(dict(Price=self.inc_price))
        self.fix_manager_sell.send_message_and_receive_response(self.SORPING_order_replace_2_params, case_id_2)

        time.sleep(5)

        self.fix_verifier_sell.check_fix_message(self.SORPING_order_replace_2_params, self.key_params_ER_parent, direction=self.ToQuod, message_name='Sell side OrderCancelReplaceRequest')

        er_replaced_2_SORPING_order_params = FixMessageExecutionReportAlgo().set_params_from_order_cancel_replace(self.SORPING_order_replace_2_params, self.gateway_side_sell, self.status_cancel_replace)
        er_replaced_2_SORPING_order_params.change_parameters(dict(OrdStatus=1))
        self.fix_verifier_sell.check_fix_message(er_replaced_2_SORPING_order_params, key_parameters=self.key_params_ER_parent, message_name='Sell Side ExecReport Replace Request')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_3_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel 2nd Lit passive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_4_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle 3rd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_4_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 3rd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_4_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 3rd Lit passive Child DMA order')
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_4_qdl1_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Cancel 3rd Lit passive Child DMA order")
        # endregion

        er_cancel_SORPING_order_params = FixMessageExecutionReportAlgo().set_params_from_order_cancel_replace(self.SORPING_order_replace_2_params, self.gateway_side_sell, self.status_cancel)
