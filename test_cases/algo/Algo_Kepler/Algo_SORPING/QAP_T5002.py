...
class QAP_T5002(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_fill_dma_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill 1st Lit aggressive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_fill_dma_1_qdl2_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill 2nd Lit aggressive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_pending_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 1st Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message(er_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 1st Lit passive Child DMA order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_2_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel 1st Lit passive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_pending_new_dma_3_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 2nd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message(er_new_dma_3_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 2nd Lit passive Child DMA order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_3_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel 2nd Lit passive Child DMA order")
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message(er_pending_new_dma_4_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew 3rd Lit passive Child DMA order')
        ...
        self.fix_verifier_buy.check_fix_message(er_new_dma_4_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New 3rd Lit passive Child DMA order')
        # endregion
    ...
    def run_post_conditions(self):
        ...
        self.fix_verifier_buy.check_fix_message(er_cancel_dma_4_qdl1_order, self.key_params_ER_eliminate_or_cancel_child, self.ToQuod, "Buy Side ExecReport Cancel 3rd Lit passive Child DMA order")
        # endregion
