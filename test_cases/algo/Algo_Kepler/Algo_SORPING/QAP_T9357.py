...
class QAP_T9357(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text_1 = "TAL phase, sending lit"
        self.text_2 = "Phase of the reference market is TAL"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.read_log_verifier.set_case_id(bca.create_event("Check that primary venue goes to the TAL phase", self.test_id))
