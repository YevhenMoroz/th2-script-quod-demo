...
class QAP_T8815(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.party_role_2 = constants.PartyRole.party_role_12.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_eliminate_rule = rule_manager.add_NewOrderSingle_ExecutionReport_Eliminate(self.fix_env1.buy_side, self.account_qdl11, self.ex_destination_qdl11, self.price, self.delay_for_eliminate)
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_qdl11, self.ex_destination_qdl11, False, self.delay_for_cancel)
        self.rule_list = [nos_eliminate_rule, ocr_rule]
        # endregion
