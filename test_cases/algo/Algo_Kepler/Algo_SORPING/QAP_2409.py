...
class QAP_2409(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.dma_qdl1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit1,  OrderQty=self.qty_qdl1, Price=self.price_qdl1, TimeInForce=self.tif_iok))
        ...
        self.dma_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.qty_qdl2, Price=self.price_qdl2, TimeInForce=self.tif_iok))
