...
class QAP_T4979(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.SORPING_order_replace_params.change_parameters(dict(Price=self.dec_price, DisplayInstruction=dict(DisplayQty=self.inc_display_qty)))
