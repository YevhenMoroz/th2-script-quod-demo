...
class QAP_T4966(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_buy.check_fix_message_sequence_kepler([self.dma_qdpkp1_order, self.dma_qdpkp2_order, self.dma_1_order, self.dma_2_order], [self.key_params_ER_child, self.key_params_ER_child, self.key_params_ER_child, self.key_params_ER_child], self.FromQuod, pre_filter=None, check_order=False)
