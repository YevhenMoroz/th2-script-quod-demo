...
class QAP_T4061(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.px_for_incr = 0
        self.qty_for_incr = 0
        self.algopolicy = constants.ClientAlgoPolicy.qa_sorping_11.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit1, True, self.qty, self.price_bid_qdl1)
        ...
        self.Multilisting_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, OrdType=self.ord_type, Instrument=self.instrument, Side=self.side, ClientAlgoPolicyID=self.algopolicy)).remove_parameter('Price')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport Fill Child DMA 1 order')
        # endregion
