...
class QAP_2410(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_fill_SORPING_order.change_parameters(dict(LastQty=self.qty_for_lit_2_child, Instrument='*')).remove_parameters(['SecAltIDGrp', 'SecondaryClOrdID']).add_tag(dict(LastMkt='*', ChildOrderID='*', ExDestination='*'))
