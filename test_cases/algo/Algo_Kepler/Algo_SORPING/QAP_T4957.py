...
class QAP_T4957(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [nos_1_rule, ocr_1_rule, nos_2_rule, ocr_2_rule]
        # endregion
        ...
        # region Set up AUC phase
        market_data_snap_shot_qdl8 = FixMessageMarketDataIncrementalRefreshAlgo().set_market_data_incr_refresh_ltq().update_MDReqID(self.listing_id_qdl8, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl8.update_repeating_group_by_index('NoMDEntriesIR', 0, MDEntryPx=self.px_for_incr, MDEntrySize=self.qty_for_incr, TradingSessionSubID=self.trading_phase, SecurityTradingStatus=self.trading_status)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl8)
        # endregion
