...
class QAP_T5073(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.qty_for_lit_1_child = 1000
        self.qty_for_lit_2_child = 100
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_3_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit1, True, self.qty_for_lit_1_child, self.price_bid_qdl1)
        nos_4_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit2, True, self.qty_for_lit_2_child, self.price_bid_qdl2)
        ...
        self.dma_qdpkp1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quoddkp1, Side=self.sell, OrderQty=self.qty, Price=self.dark_price, Instrument=self.instrument, TimeInForce=self.tif_iok))
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_eliminate_dma_qdpkp1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 1 order")
        # endregion
        ...
        self.dma_qdpkp2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quoddkp2, Side=self.sell, OrderQty=self.qty, Price=self.dark_price, Instrument=self.instrument, TimeInForce=self.tif_iok))
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_eliminate_dma_qdpkp2_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 2 order")
        # endregion
        # endregion
        ...
        self.dma_qdl1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit1, Side=self.sell, OrderQty=self.qty_for_lit_1_child, Price=self.price_bid_qdl1, TimeInForce=self.tif_iok))
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_qdl1__order, self.key_params_ER_fill_child, self.ToQuod, "Buy Side ExecReport Eliminate child DMA 3 order")
        # endregion
        ...
        self.dma_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, Side=self.sell, OrderQty=self.qty_for_lit_2_child, Price=self.price_bid_qdl2, TimeInForce=self.tif_iok))
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Child DMA 4 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_qdl2_order, self.key_params_ER_fill_child, self.ToQuod, "Buy Side ExecReport Fill child DMA 4 order")
        # endregion
        ...
        er_fill_SORPING_order.change_parameters(dict(LastQty=self.qty_for_lit_2_child))
