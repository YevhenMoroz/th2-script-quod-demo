...
class QAP_T9262(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.price_ask_qdl2_3 = 40
        self.price_bid_qdl2_3 = 28
        self.px_for_incr = 0
        self.qty_for_incr = 0
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit1, self.price_ask_qdl1)
        ...
        market_data_snap_shot_qdl3.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask_qdl2_3, MDEntrySize=self.qty_for_md)
        ...
        self.SORPING_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, OrdType=self.ord_type)).remove_parameter('Price')
        ...
        self.dma_qdl1_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit1, OrderQty=self.qty))
