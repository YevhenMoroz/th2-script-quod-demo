...
class QAP_T9355(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.text_1 = "POP phase, sending lit"
        self.text_2 = "Phase of the reference market is POP"
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.read_log_verifier.set_case_id(bca.create_event("Check that primary venue goes to the POP phase", self.test_id))
