...
class QAP_T10968(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Check that child DMA orders are created
        self.fix_verifier_buy.set_case_id(bca.create_event("Check that child DMA orders are created", self.test_id))
        ...
        # region Check replies on the childs
        self.fix_verifier_buy.set_case_id(bca.create_event("Check replies on the childs", self.test_id))
        ...
        # region Check that the parent algo order is filled
