...
class QAP_T4065(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.leaves_qty = self.qty - self.cum_qty
        self.price = 11
        self.price_ask = 40
        self.price_bid = 11
        self.qty_bid = 200
        self.qty_ask = 1000000
        self.new_qty_bid_qdl2 = 100
        self.price_bid_for_passive_phase = 10
        self.new_price_bid_qdl2 = 12
        self.px_for_incr = 0
        self.qty_for_incr = 0
        self.delay = 1000
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_1_fok_rule = rule_manager.add_NewOrdSingle_FOK(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit1, True, self.price, self.delay)
        nos_2_fok_rule = rule_manager.add_NewOrdSingle_FOK(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit2, True, self.price, self.delay)
        nos_ioc_rule = rule_manager.add_NewOrdSingle_IOC(self.fix_env1.buy_side, self.account, self.ex_destination_quodlit2, True, self.leaves_qty, self.new_price_bid_qdl2)
        ...
        self.rule_list = [nos_1_fok_rule, nos_2_fok_rule, nos_ioc_rule, nos_rule, ocr_rule]
        # endregion
        ...
        market_data_snap_shot_qdl2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_id_qdl2, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.price_bid_for_passive_phase, MDEntrySize=self.new_qty_bid_qdl2)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl2)
        ...
        self.dma_1_qdl1_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_ChildMinQty_Kepler_params()
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_1_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Aggressive Child DMA 1 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_1_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Aggressive Child DMA 1 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_1_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Aggressive Child DMA 1 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_1_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill Aggressive DMA 1 order")
        # endregion
        ...
        self.dma_1_qdl2_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_ChildMinQty_Kepler_params()
        self.dma_1_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.trade_qty, Price=self.price, TimeInForce=self.tif_fok))
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_1_qdl2_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Aggressive Child DMA 2 order')

        er_pending_new_dma_1_qdl2_order_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_1_qdl2_order, self.gateway_side_buy, self.status_pending)
        er_pending_new_dma_1_qdl2_order_params.change_parameters(dict(ExDestination=self.ex_destination_quodlit1))
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_1_qdl2_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Aggressive Child DMA 2 order')

        er_new_dma_1_qdl2_order_params = FixMessageExecutionReportAlgo().set_params_from_new_order_single(self.dma_1_qdl2_order, self.gateway_side_buy, self.status_new)
        er_new_dma_1_qdl2_order_params.change_parameters(dict(ExDestination=self.ex_destination_quodlit1))
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_1_qdl2_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Aggressive Child DMA 2 order')
        # endregion
        ...
        er_fill_dma_1_qdl2_order.change_parameters(dict(CumQty=self.trade_qty, LeavesQty=0, LastQty=self.trade_qty, LastPx=self.price))
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_1_qdl2_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill Aggressive DMA 2 order")
        # endregion
        ...
        er_partially_fill_synthMinQty_order.change_parameters(dict(LastPx=self.price, CumQty=self.cum_qty, LeavesQty=self.leaves_qty, LastQty=self.trade_qty))
        ...
        self.fix_manager_feed_handler.set_case_id(bca.create_event("Send Market Data", self.test_id))
        market_data_snap_shot_qdl2 = FixMessageMarketDataSnapshotFullRefreshAlgo().set_market_data().update_MDReqID(self.listing_id_qdl2, self.fix_env1.feed_handler)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 0, MDEntryPx=self.new_price_bid_qdl2, MDEntrySize=self.qty_bid)
        market_data_snap_shot_qdl2.update_repeating_group_by_index('NoMDEntries', 1, MDEntryPx=self.price_ask, MDEntrySize=self.qty_ask)
        self.fix_manager_feed_handler.send_message(market_data_snap_shot_qdl2)
        ...
        self.dma_2_qdl1_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_ChildMinQty_Kepler_params()
        ...
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_2_qdl1_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Passive Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_pending_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport PendingNew Passive Child DMA 3 order')
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_new_dma_2_qdl1_order_params, key_parameters=self.key_params_ER_child, direction=self.ToQuod, message_name='Buy side ExecReport New Passive Child DMA 3 order')
        # endregion
        ...
        self.fix_verifier_buy.check_fix_message_kepler(er_cancel_dma_2_qdl1_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Cancel Passive child DMA 3 order")
        # endregion
        ...
        self.dma_2_qdl2_order = FixMessageNewOrderSingleAlgo(data_set=self.data_set).set_DMA_ChildMinQty_Kepler_params()
        self.dma_2_qdl2_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_quodlit2, OrderQty=self.leaves_qty, Price=self.new_price_bid_qdl2, TimeInForce=self.tif_ioc))
        self.fix_verifier_buy.check_fix_message_kepler(self.dma_2_qdl2_order, key_parameters=self.key_params_NOS_child, message_name='Buy side NewOrderSingle Aggressive Child DMA 2 order')
        # endregion
        ...
        er_fill_dma_2_qdl2_order.change_parameters(dict(CumQty=self.leaves_qty, LeavesQty=0, LastQty=self.leaves_qty, LastPx=self.new_price_bid_qdl2))
        self.fix_verifier_buy.check_fix_message_kepler(er_fill_dma_2_qdl2_order, self.key_params_ER_child, self.ToQuod, "Buy Side ExecReport Fill Aggressive DMA 4 order")
        # endregion
        ...
        er_fill_synthMinQty_order.change_parameters(dict(LastPx=self.new_price_bid_qdl2, CumQty=self.qty, LeavesQty=0, LastQty=self.leaves_qty))
