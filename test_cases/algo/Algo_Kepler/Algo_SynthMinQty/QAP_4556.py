...
class QAP_4556(TestCase):
    ...
    def run_post_conditions(self):
        ...
        er_cancel_synthMinQty_order_params.remove_parameter('NoStrategyParameters').add_tag(dict(SettlDate='*', MinQty=self.min_qty)).add_tag(dict(NoParty='*'))
