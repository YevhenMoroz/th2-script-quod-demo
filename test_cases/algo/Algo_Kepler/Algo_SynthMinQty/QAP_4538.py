...
class QAP_4538(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        er_fill_dma_qdl1_order.change_parameters(dict(CumQty=self.qty, LeavesQty=0, LastQty=self.qty, LastPx=self.price)).remove_parameter('ExDestination')
        ...
        er_fill_synthMinQty_order.change_parameters(dict(LastPx=self.price, CumQty=self.qty, LeavesQty=0, LastQty=self.qty)) # .remove_parameters(['SecAltIDGrp', 'SecondaryClOrdID'])
