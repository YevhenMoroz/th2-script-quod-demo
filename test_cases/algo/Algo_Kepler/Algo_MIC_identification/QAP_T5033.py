...
class QAP_T5033(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        self.account_xlux = self.data_set.get_account_by_name("account_9")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_xlux, self.ex_destination_xlux, self.price)
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_xlux, self.ex_destination_xlux, True)
        ...
        self.Iceberg_order.change_parameters(dict(Account=self.client, OrderQty=self.qty, Instrument=self.instrument, Price=self.price, ExDestination=self.ex_destination_xlux, DisplayInstruction=dict(DisplayQty=self.display_qty)))
        ...
        self.dma_order.change_parameters(dict(Account=self.account_xlux, ExDestination=self.ex_destination_xlux, OrderQty=self.display_qty, Price=self.price, Instrument=self.instrument))
