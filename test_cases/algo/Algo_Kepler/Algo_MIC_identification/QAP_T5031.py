...
class QAP_T5031(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        # region instrument
        self.instrument = self.data_set.get_fix_instrument_by_name("instrument_33")
        # endregion
        ...
        self.account_xbru = self.data_set.get_account_by_name("account_9")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        nos_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew(self.fix_env1.buy_side, self.account_xbru, self.ex_destination_xbru, self.price)
        ocr_rule = rule_manager.add_OrderCancelRequest(self.fix_env1.buy_side, self.account_xbru, self.ex_destination_xbru, True)
