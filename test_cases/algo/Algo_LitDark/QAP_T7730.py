...
from test_framework.data_sets.constants import DirectionEnum, Status, GatewaySide, OrderSide, TimeInForce, StrategyParameterType
...
class QAP_T7730(TestCase):
    ...
    def __init__(self, report_id, data_set=None, environment=None):
        ...
        # region venue parameters
        self.cost_per_trade = 6
        self.comm_per_unit = 11
        self.comm_basis_points = 16
        self.spread_discount_proportion = 1
        self.is_comm_per_unit = True
        # endregion
        ...
        self.venue_id = self.data_set.get_venue_by_name("venue_1")
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.litdark_order.add_fields_into_repeating_group_algo('NoStrategyParameters', [['Visibility', self.float_type, self.visibility],
                                                                                         ['ImbalanceTolerance', self.float_type, self.imbalance_tolerance],
                                                                                         ['DarkPoolWeights', self.string_type, f'{self.venue_id}=1']])
