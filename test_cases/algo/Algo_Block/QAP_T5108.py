...
class QAP_T5108(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rule_list = [ocr_rule, nos_rule, ocrr_rule]
        # endregion
        ...
        self.Synthetic_Block_order.update_repeating_group('NoStrategyParameters', [dict(StrategyParameterName='ReleaseMode', StrategyParameterType='14', StrategyParameterValue=self.release_mode),
                                                                                   dict(StrategyParameterName='ReleaseQty', StrategyParameterType='6', StrategyParameterValue=self.release_qty),
        ...
        self.dma_order.change_parameters(dict(Account=self.account, ExDestination=self.ex_destination_1, OrderQty='*', Price=self.price, Instrument='*'))
