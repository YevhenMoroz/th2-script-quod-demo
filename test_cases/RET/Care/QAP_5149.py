...
from test_cases.wrapper.ret_wrappers import create_order, direct_poc_order_via_inbox, verify_order_value
...
def execute(session_id, report_id):
    ...
    direct_poc_order_via_inbox("LastTradedPrice", "0", "99.99", "NSE")
    # endregion
