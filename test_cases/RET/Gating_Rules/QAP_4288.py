...
def execute(session_id, report_id):
    ...
    verifier(case_id, event_name='Check order Status', expected_value='Sent', actual_value=order_sts)
    ...
    verifier(case_id, event_name='Check order GatingRuleCondName', expected_value='CareDefResult',
