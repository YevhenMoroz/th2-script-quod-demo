...
class QAP_T7582(TestCase):
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.price_for_amend_house_fill = '15'
    ...
    def run_pre_conditions_and_steps(self):
        ...
        new_qty = '70'
        self.trade_entry.set_default_amend_house_fill(order_id_second, new_qty, self.price_for_amend_house_fill,
        ...
        self.ja_manager.compare_values({'DecreasingQty': decreased_qty},
                                       {'DecreasingQty': str(float(cum_sell_qty_before) - float(cum_sell_qty_after))},
                                       f'Verifying that {JavaApiFields.CumSellQty.value} decreased by 30 for {self.source_acc} (step 5)')
        ...
        self.ja_manager.compare_values({'DecreasingQty': decreased_qty,
                                       ...
                                       {'DecreasingQty': str((float(cum_buy_qty_before) - float(cum_buy_qty_after))),
                                        JavaApiFields.BuyAvgPx.value: buy_avg_px_actually},
                                       f'Verifying that {JavaApiFields.CumBuyQty.value}  decreased by 30 for {self.wash_book} and {JavaApiFields.BuyAvgPx.value} has properly value (step 6)')
        # endregion
