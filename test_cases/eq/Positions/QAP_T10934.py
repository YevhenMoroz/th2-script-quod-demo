...
class QAP_T10934(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region step 6 Send wave request
        nos_rule = None
        try:
        ...
        # region step 7: get position for Security Account CareWB
