...
class QAP_T10361(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        basket_name = 'Basket_for_QAP_T10361'
        ...
        self.order_submit2.update_fields_in_component("NewOrderSingleBlock", {'OrdQty': str(int(self.qty) + int(
            self.qty)),
                                                                              'AvgPriceType': "BA",
                                                                              'ExternalCare': 'N',
        ...
        self.java_api_manager.compare_values(
            ...
            'Check 1 Care order after execution')
