...
class QAP_1089(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        qty_of_bag = QAP_1089._adjustment_of_value(str(int(qty) * 2))
        qty_of_bag_after_modification = QAP_1089._adjustment_of_value(str(int(qty) * 3))
        qty_of_bag_leaves_unmatched = QAP_1089._adjustment_of_value(str(int((int(qty)/2+int(qty)*2))))
        orders_id = []
        name_of_bag = 'QAP_1089'
        # endregion
        ...
        for i in range(3):
            ...
            if i == 0:
                self.order_book.manual_execution(str(int(qty) / 2), price)
        ...
        order_bag_id = self.__extracting_and_comparing_value_for_bag_order([OrderBagColumn.order_bag_qty.value,
