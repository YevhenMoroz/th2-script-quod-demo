...
class QAP_T7645(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        qty_of_bag = QAP_T7645._adjustment_of_value(str(int(qty) * 3))
        leaves_qty_of_bag_after_cancel_order = QAP_T7645._adjustment_of_value(str(int(qty) * 2))
        orders_id = []
        name_of_bag = 'QAP_T7645'
