...
class QAP_T8679(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        expected_result = {JavaApiFields.PartyRole.value: "CUS", JavaApiFields.CounterpartID.value: "1"}
        self.java_api_manager.compare_values(expected_result, child_ord_rep["CounterpartList"]["CounterpartBlock"][0],
                                             "Check counterpart after modification")
        # endregion
