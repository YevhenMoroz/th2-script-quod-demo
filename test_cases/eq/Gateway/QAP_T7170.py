...
class QAP_T7170(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.ssh_client.send_command("qrestart QUOD.ESBUYTH2TEST QUOD.ORS QUOD.CS")
        time.sleep(70)
        # endregion
        ...
        # region trade via mass manual execution CO orders (step 2)
        ...
        self.trade_entry_message.set_default_trade(order_id_2)
        self.java_api_manager.send_message(self.trade_entry_message)
        time.sleep(5)
        # endregion
        ...
        self.fix_message.change_parameters({'ClOrdID': client_order_id})
        ...
        list_of_ignored_fields = ['MiscFeesGrp', 'CommissionData', 'SecurityDesc', 'SecurityDesc', 'GatingRuleCondName',
                                  'GatingRuleName']
