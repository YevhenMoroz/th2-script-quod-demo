...
from test_framework.win_gui_wrappers.java_api_constants import ExecutionReportConst, OrderReplyConst, \
    ...
    CommissionBasisConst, CommissionAmountTypeConst
...
class QAP_T7514(TestCase):
    ...
    def __init__(self, report_id, session_id, data_set, environment):
        ...
        self.unallocate_request = Order_BlockUnallocateRequest()
        self.qty = '300'
        self.result = None
        self.price = '10'
        # endregion
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.allocation_instruction.update_fields_in_component('AllocationInstructionBlock',
                                                               {
                                                                   ...
                                                                   'ClientCommissionList': {'ClientCommissionBlock': [{
                                                                       ...
                                                                       'CommissionBasis': CommissionBasisConst.CommissionBasis_ABS.value,
        ...
        # region check 35 = AK messages step 9
        change_parameters = {
            'NoOrders': [{
                'ClOrdID': cl_ord_id,
                'OrderID': '*'
