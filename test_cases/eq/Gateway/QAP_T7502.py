...
from test_framework.win_gui_wrappers.fe_trading_constant import OrderBookColumns, ExecSts, Capacity
...
class QAP_T7502(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.last_capacity = Capacity.agency.value
    ...
    def run_pre_conditions_and_steps(self):
        ...
        exec_report.change_parameters({'SettlDate': self.settl_date, "LastMkt": self.mic, "VenueType": "O", "OrdStatus": "1",
                                       "LastCapacity" :"1"})
