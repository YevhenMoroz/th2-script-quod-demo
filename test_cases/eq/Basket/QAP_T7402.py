...
class QAP_T7402(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.wave_creation_request.set_default(list_id, ord_id_list=[ord_id1, ord_id2], percent_qty=self.per_qty,
                                               profile=QtyPercentageProfile.InitialQty.value)
        ...
        # region Verify wave
        self.java_api_manager.compare_values(
            {JavaApiFields.QtyPercentageProfile.value: QtyPercentageProfile.InitialQty.value,
             JavaApiFields.PercentQtyToRelease.value: self.per_qty},
            list_wave_notify_block,
            'Check created first wave with InitialQty QtyPercentageProfile')
        # endregion
        ...
        self.java_api_manager.compare_values(
            ...
            'Check first Child Order after InitialQty waving')
        self.java_api_manager.compare_values(
            {JavaApiFields.OrdQty.value: '50.0'},
            ord_notify_element[1],
            'Check second Child Order after InitialQty waving')
        # endregion
        ...
        self.java_api_manager.compare_values(
            {JavaApiFields.QtyPercentageProfile.value: QtyPercentageProfile.InitialQty.value,
             JavaApiFields.PercentQtyToRelease.value: self.per_qty},
            list_wave_notify_block,
            'Check created second wave with InitialQty QtyPercentageProfile')
        # endregion
