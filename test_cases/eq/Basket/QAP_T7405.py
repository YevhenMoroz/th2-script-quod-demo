...
class QAP_T7405(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        responses = self.java_api_manager.send_message_and_receive_response(self.remove_order_from_basket_request)
        self.return_result(responses, ORSMessageType.OrdListNotification.value)
        list_notify_block = self.result.get_parameter('OrdListNotificationBlock')
        # endregion
        ...
        # region check values
        self.java_api_manager.compare_values(
            {'OrdIDList': {'OrdIDBlock': [{'OrdID': ord_id2}]}}, list_notify_block,
