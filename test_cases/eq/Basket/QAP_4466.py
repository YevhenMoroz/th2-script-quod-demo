...
class QAP_4466(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # endregion
        # region check values
        result1 = self.basket_book.get_basket_value('Qty', basket_book_filter={OrderBookColumns.order_id.value:order_id1})
        expected = {'1': '200'}
        self.basket_book.compare_values(expected, result1, 'Check Qty')
        result2 = self.basket_book.get_basket_value('Qty',
                                                    basket_book_filter={OrderBookColumns.order_id.value: order_id2})
        expected = {'2': '300'}
