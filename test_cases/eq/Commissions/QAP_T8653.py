...
class QAP_T8653(TestCase):
    ...
    def __init__(self, report_id, session_id, data_set, environment):
        ...
        self.allocation_instruction_report = FixMessageAllocationInstructionReportOMS()
        self.confirm_report = FixMessageConfirmationReportOMS(self.data_set)
