...
class QAP_T9251(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        tree.getroot().find("calculatedReportFeesDFD").text = 'false'
        tree.write("temp.xml")
        ...
        self.java_api_manager.compare_values(
            ...
            exec_report_calc,
            "Check fee doesn't attach to child orders execution", VerificationMethod.NOT_CONTAINS)
        # endregion
        ...
        self.java_api_manager.compare_values(
            {JavaApiFields.ExecutionReportBlock.value: JavaApiFields.MiscFeesList.value},
            exec_report,
            "Check fee doesn't attach to execution", VerificationMethod.NOT_CONTAINS)
        # endregion
