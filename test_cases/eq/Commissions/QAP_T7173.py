...
class QAP_T7173(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        filter_list_middle_office = [MiddleOfficeColumns.order_id.value,order_id]
        # endregion
        ...
        # endregion
        # region Book order
        self.mid_office.book_order(filter=filter_list)
        # endregion
        # region approve block
        self.mid_office.approve_block(filter_list=filter_list_middle_office)
        # endregion
        # region allocate
        self.mid_office.allocate_block(filter=filter_list)
        # endregion
        ...
        fix_response_confirmation.change_parameters(
            {'tag5120': "*", "AllocQty": self.qty, "AllocAccount": self.client_acc, 'Currency': self.currency,'AvgPx':'*',
