...
class QAP_T7308(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.rest_commission_sender.set_modify_client_commission_message(
            comm_profile=self.data_set.get_comm_profile_by_name("abs_amt"), client=self.client)
        ...
        expected_result = {'CommissionCurrency': self.data_set.get_currency_by_name("currency_2"),
                           'CommissionBasis': 'ABS', 'CommissionRate': '0.01', 'CommissionAmount': '0.01',
