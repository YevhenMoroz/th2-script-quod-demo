...
class QAP_T7308(TestCase):
    ...
    def __init__(self, report_id, session_id, data_set, environment):
        ...
        self.client_for_rule = self.data_set.get_venue_client_names_by_name("client_pt_3_venue_2")
    ...
    def run_pre_conditions_and_steps(self):
        ...
        conf_report = FixMessageConfirmationReportOMS(self.data_set).set_default_confirmation_new(
            self.fix_message)
        conf_report.change_parameters({"Account": self.client, "AvgPx": "0.2", "Currency": "*", "tag5120": "*",
