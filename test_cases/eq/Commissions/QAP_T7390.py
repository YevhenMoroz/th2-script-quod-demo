...
class QAP_T7390(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_verifier_dc.check_fix_message_fix_standard(self.alloc_report, ['Quantity', 'AllocType', 'NoOrders'],
                                                            ignored_fields=alloc_ignored_fields)
        # endregion

        # region check confirmation message
        no_misc_fees = {'NoMiscFees': [{"MiscFeeAmt": '8954.91', "MiscFeeCurr": self.com_cur,
                                        "MiscFeeType": "4"}]}
        conf_ignored_fields = ['CommissionData', 'Account', 'tag5120', 'AvgPx', 'Currency', 'OrderAvgPx', 'tag11245',
                               'ExecAllocGrp']
