...
class QAP_T7039(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        # part 2: Set up AccountGroup (precondition)
        ...
        self.java_api_manager.compare_values(
            ...
            compute_booking_misc_fee_response,
        ...
        alloc_id = allocation_report[JavaApiFields.AllocationReportBlock.value][JavaApiFields.ClientAllocID.value]
        self.java_api_manager.compare_values(
        ...
        self.java_api_manager.compare_values(
            ...
            allocation_report,
            'Check that Block doesn`t has Agent Fees (part of step 1)', VerificationMethod.NOT_CONTAINS)
        # endregion
        ...
        self.java_api_manager.compare_values(
            ...
            confirmation_report,
            'Check that Agent Fees is absent for confirmation (step 2)', VerificationMethod.NOT_CONTAINS)
        # endregion
