...
def execute(report_id, session_id):
    ...
    try:
        ...
        nos_rule = rule_manager.add_NewOrdSingle_IOC(test_cases.wrapper.eq_fix_wrappers.get_buy_connectivity(), client +
                                                     '_PARIS', 'XPAR', False, 800, 40)
        fix_message = test_cases.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 2, 1, client, 2, qty, 3, price)
    finally:
        time.sleep(1)
