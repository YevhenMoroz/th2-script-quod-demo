...
class QAP_T8300(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        self.fix_message.change_parameter("OrdType", "5")
        self.fix_message.remove_parameter("Price")
        self.fix_manager.send_message_and_receive_response_fix_standard(self.fix_message)
        exec_rep = self.fix_manager.get_last_message("ExecutionReport").get_parameters()
        self.fix_manager.compare_values({"OrdType": "5", "ExecType": "A"}, exec_rep, "Check OrdType")
