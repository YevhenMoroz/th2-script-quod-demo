...
class QAP_T7611(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        try:
            nos_rule = self.rule_manager.add_NewOrdSingle_FOK_FIXStandard(
                self.bs_connectivity, self.venue_client_names, self.venue, False, float(self.price)
            )
