...
class QAP_T7615(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        try:
            nos_rule = self.rule_manager.add_MarketNewOrdSingle_FOK_FIXStandard(self.bs_connectivity,
                                                                                self.venue_client_names, self.venue,
                                                                                float(self.price), True)
        ...
        list_of_ignored_fields: list = ['ReplyReceivedTime', 'SecondaryOrderID', 'Text', 'LastMkt',
                                        ...
                                        "Instrument", "Account", "GatingRuleCondName", "GatingRuleName"]
