...
def execute(report_id, session_id):
    ...
    try:
        ...
        fix_message = test_cases.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 2, 2, client, 1, qty, 1)
    ...
    test_cases.wrapper.eq_fix_wrappers.cancel_order_via_fix(case_id, order_id, cl_order_id, client, 2)
