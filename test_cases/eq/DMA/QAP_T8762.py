...
class QAP_T8762(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 1-2: Send FIX message and trade it
        ...
        # region Step 2: Check that message 35=8, 39=2 is presented
        ...
        # region Step 2: Check that message 35=8, 39=B is presented
        ignored_list = ['Parties', 'QuodTradeQualifier', 'BookID', 'SettlCurrency', 'TradeReportingIndicator',
                        ...
                        "GatingRuleName", "LastExecutionPolicy", "TradeDate", "LastLiquidityInd", "SecondaryExecID"]
        self.fix_execution_report.set_default_calculated(self.fix_message)
