...
def execute(report_id):
    ...
    call(common_act.verifyEntities, verification(before_order_details_id, "checking order",
                                                 [verify_ent("Parent Status", order_status.name, "Open"),
    ...
    call(order_book_service.orderBookDirectLoc, direct_loc_request("UnmatchedQty", "100", "NSE", request))
    # end region
    ...
    call(common_act.verifyEntities, verification(before_order_details_id, "checking Child order",
                                                 [verify_ent("Child Order Status", order_status.name, "Open"),
