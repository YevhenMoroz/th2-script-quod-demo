...
class QAP_T11445(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        # region step 1: Create DMA multy_leg order:
        ...
        self.new_order_multi_leg.update_fields_in_component(JavaApiFields.NewOrderMultiLegBlock.value, {
            ...
            JavaApiFields.LegOrderElements.value: {JavaApiFields.LegOrderBlock.value: [
                {JavaApiFields.LegNumber.value: "1", JavaApiFields.LegPrice.value: "0", JavaApiFields.LegInstrID.value:
                    instrument_leg_first},
                {JavaApiFields.LegNumber.value: "2", JavaApiFields.LegPrice.value: "0", JavaApiFields.LegInstrID.value:
        ...
        list_ignored_fields = ['Account', 'OrderQtyData', 'OrdType',
                               ...
                               'Parties', 'SettlCurrency',
                               'ExDestination', 'LegOrdGrp', 'Instrument']
        ...
        instrument_multy_leg_fix = self.data_set
        zero_value = '0.0'
        ...
        self.fix_verifier_buy_side.check_fix_message_fix_standard(self.fix_multileg_modification_request, ignored_fields=list_ignored_fields)
        # endregion
