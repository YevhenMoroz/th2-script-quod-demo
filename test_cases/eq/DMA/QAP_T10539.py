...
class QAP_T10539(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        try:
            ...
            self.java_api_manager.key_is_absent("SettlType", order_reply,
                                                "Checking that SettlType is empty for 1st order")
            ...
            self.java_api_manager.key_is_absent("SettlType", order_reply,
                                                "Step 1 - Checking that SettlType is empty for 2nd order")
        ...
        # region Step 2 - Mass Modify SettlDate
        try:
    ...
    def __send_modif_request(self, ord_id: str, number_of_order: str):
        ...
        self.modification_request.update_fields_in_component(
            "OrderModificationRequestBlock", {"SettlDate": settl_date_new}
        )
        ...
        self.java_api_manager.compare_values(
            {"SettlDate": settl_date_expected},
            order_reply,
            f"Step 2 - Checking that SettlDate(today+2) of {number_of_order} order after Mass Modify",
        )
        self.java_api_manager.key_is_absent("SettlType", order_reply,
                                            f"Step 2 - Checking that SettlType is empty for {number_of_order} order")
