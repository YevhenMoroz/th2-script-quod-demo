...
class QAP_T7147(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        try:
            new_order_single = self.rule_manager.add_NewOrdSingleExecutionReportPendingAndNew_FIXStandard(self.fix_env.buy_side, self.venue_client_names, self.venue, float(price))
