...
class QAP_T11540(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.recovery_desk_1 = self.environment.get_list_fe_environment()[0].desk_ids[0]  # 9
        self.recovery_desk_2 = self.environment.get_list_fe_environment()[0].desk_ids[1]  # 10
    ...
    def run_pre_conditions_and_steps(self):
        ...
        set_value_params: dict = {
            ...
            "recoveryDesk": [{"recoveryDeskID": self.recovery_desk_1}, {"recoveryDeskID": self.recovery_desk_2}],
        }
