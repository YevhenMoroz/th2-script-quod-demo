...
class QAP_T11536(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.recovery_desk = self.environment.get_list_fe_environment()[0].desk_ids[1]  # 10
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.java_api_manager.compare_values(
            {
                ...
                JavaApiFields.RecipientDeskID.value: str(self.recovery_desk),
            },
            order_notification,
            "Check RecipientDeskID and GatingRuleCondName",
        )

        self.java_api_manager.key_is_absent(JavaApiFields.RecipientUserID.value, order_notification,
                                            "Check that RecipientUserID is empty")
        ...
        self.java_api_manager.key_is_absent(JavaApiFields.RecipientUserID.value, cd_ord_notif_message,
                                            "Check that RecipientUserID is empty in Client Inbox")
        # endregion
