...
class QAP_T4318(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 2 - Create DMA order
        try:
        ...
        # region Step 3 - Check that the Gating rule is applied to the order
        ...
        self.java_api_manager.compare_values(
            ...
            order_notification,
            "Step 3- Check that the Gating rule is applied to the order",
        )
        # endregion
