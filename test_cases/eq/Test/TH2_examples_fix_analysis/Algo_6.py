...
def execute(report_id):
    try:
        ...
        nos_rule = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew("fix-buy-side-316-ganymede", "TRQX_CLIENT1", "TRQX", 30)
        nos_rule_1 = rule_manager.add_NewOrdSingleExecutionReportPendingAndNew("fix-buy-side-316-ganymede", "TRQX_CLIENT1", "TRQX", 29.95)
        ...
        new_order_single_params = {
            ...
            'Currency': "EUR",
            'TargetStrategy': 1005,
            'ClientAlgoPolicyID':'QUOD TWAP test'
        ...
        rule_manager.remove_rule(nos_rule_1)
