...
class QAP_T7533(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.middle_office.set_modify_ticket_details(settl_currency=self.data_set.get_currency_by_name('currency_5'),
                                                     exchange_rate='2',
                                                     exchange_rate_calc='Multiple',
