...
class QAP_T7507(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Set-up parameters and check 167=CS in ExecutionReports
        ...
        # region Checking PostTradeStatuses in the Order book
        ...
        self.order_book.check_order_fields_list(
            {OrderBookColumns.post_trade_status.value: PostTradeStatuses.ready_to_book.value,
             OrderBookColumns.exec_sts.value: ExecSts.filled.value}, 'Comparing PostTradeStatus after Complete')
        # endregion
        ...
        # region Set-up parameters and check 167=CS in second AllocationReport
        pre_alloc_grp: dict = {
