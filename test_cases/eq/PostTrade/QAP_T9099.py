...
class QAP_T9099(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        if alloc_report_comm[0]['CommissionAmountType'] == "REP":
        ...
        self.java_api_manager.compare_values({'CommissionAmountType': "REP"}, alloc_report_comm[1],
                                             "Check allocation comm 2(step 2)")
        conf_report_comm = conf_report['ClientCommissionList']['ClientCommissionBlock']
        if conf_report_comm[0]['CommissionAmountType'] == "REP":
        ...
        self.java_api_manager.compare_values({'CommissionAmountType': "REP"}, conf_report_comm[1],
