...
class QAP_T7531(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.middle_office.compare_values(
            ...
            values_after_book, 'Comparing statuses after Book for block of MiddleOffice')
        # endregion
        ...
        self.middle_office.compare_values(
            {MiddleOfficeColumns.sts.value: 'Accepted', MiddleOfficeColumns.match_status.value: 'Matched',
             MiddleOfficeColumns.summary_status.value: ''}, values_after_approve,
