    ...
    def run_pre_conditions_and_steps(self):
        ...
        with open('./logs.txt') as file:
            ...
            self.java_api_manager.compare_values({
                'RootSettlCurrency': f'RootSettlCurrency="{settl_currency}"','SettlCurrAmt':f'SettlCurrAmt={settl_currency_amt}'}, {
                 "RootSettlCurrency": res,"SettlCurrAmt":res}, "Check Allocation report",
