...
class QAP_T10867(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.java_api_manager.compare_values({"CustDirectedOrder": "Y"}, ord_rep, "Check modification")
        # endregion
        ...
        self.java_api_manager.compare_values({"CustDirectedOrder": "Y"}, alloc_report_message,
                                             "Check CustDirectedOrder")
        # endregion
