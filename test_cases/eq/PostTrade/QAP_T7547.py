...
class QAP_T7547(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        order_report_message = self.java_api_manager.get_last_message(ORSMessageType.OrdReply.value).get_parameters()[
            JavaApiFields.OrdReplyBlock.value
        ]
        self.java_api_manager.compare_values(
            {
        ...
        list_of_security_account = [self.alloc_account_1, self.alloc_account_2]
        for account in list_of_security_account:
            ...
            print_message(f"CONFIRMATION FOR {account}", responses)
