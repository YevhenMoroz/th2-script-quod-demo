...
from test_framework.java_api_wrappers.java_api_constants import AllocationReportConst, JavaApiFields, \
    ConfirmationReportConst, AllocationInstructionConst
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.allocation_instruction.update_fields_in_component('AllocationInstructionBlock',
                                                               {"InstrID": instrument_id, "AccountGroupID": self.client,
                                                                ...
                                                                'RootMiscFeesList': {
                                                                    'RootMiscFeesBlock': [{'RootMiscFeeType': "REG",
                                                                                           'RootMiscFeeAmt': "0.3845",
                                                                                           'RootMiscFeeCurr': "EUR",
        ...
        self.java_api_manager.compare_values({"PartyRole": "STL"}, allocation_report["PartiesList"]["PartiesBlock"][0],
                                             "Check PartyRole")
