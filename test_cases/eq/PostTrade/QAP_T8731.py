...
class QAP_T8731(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.order_submit.update_fields_in_component("NewOrderSingleBlock", {
            "AccountGroupID": self.client, "AllocInstructionMiscBlock": {"AllocInstructionMisc0": "BO1"},
            "ConfirmationMiscBlock": {"ConfirmationMisc0": "AO1"}})
        ...
        self.java_api_manager.compare_values({"ConfirmationMisc0": "AO1"},
                                             alloc_report_message["ConfirmationMiscBlock"],
                                             "Check ConfirmationMiscBlock")
        self.java_api_manager.compare_values({"AllocInstructionMisc0": "BO1"},
                                alloc_report_message["AllocInstructionMiscBlock"], "Check AllocInstructionMiscBlock")
        # endregion
