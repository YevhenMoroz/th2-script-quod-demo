...
class QAP_T11139(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.order_submit.update_fields_in_component("NewOrderSingleBlock", {"AccountGroupID": self.client, "Side": "S",
        ...
        self.allocation_instruction.update_fields_in_component('AllocationInstructionBlock', {
            "InstrID": instrument_id, "Side": "S", 'ExecAllocList': {'ExecAllocBlock': [{
        ...
        self.confirmation_request.update_fields_in_component(
            "ConfirmationBlock", {"AllocAccountID": self.account, "Side": "S", "AllocQty": self.qty})
        ...
        self.java_api_manager.compare_values(
            {JavaApiFields.Side.value: "S"}, alloc_report_message,
