...
class QAP_T7266(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        exec_qty1 = str(int(int(self.qty) * 0.25))
        self.order_book.manual_execution(exec_qty1, filter_dict=ord_filter)
        ...
        # endregion
        exec_qty2 = str(int(int(self.qty) * 0.75))
        ...
        self.booking_win.cancel_booking(
            {MiddleOfficeColumns.order_id.value: order_id, MiddleOfficeColumns.qty.value: exec_qty1})
        self.booking_win.cancel_booking(
        ...
        self.middle_office.book_order(filter=[OrderBookColumns.cl_ord_id.value, cl_ord_id])
        self.middle_office.compare_values(
            {MiddleOfficeColumns.qty.value: self.qty}, book_qty,
