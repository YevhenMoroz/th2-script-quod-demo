...
class QAP_T7491(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.java_api_manager.compare_values({"CountryCode": "GBR", "CountryCodeAlpha2": "GB"}, allocation_report,
                                             "Cehck CountryCode and CountryCodeAlpha2")
