...
class QAP_T7505(TestCase):
    ...
    def __init__(self, report_id, session_id, data_set, environment):
        ...
        self.client_2 = 'MOClient_9'  # MOClient_9 CS=CTM
        self.client_3 = self.data_set.get_client('client_pos_3')  # SBK Account type = Firm
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Checking PostTradeStatus in OrderBook
        ...
        self.middle_office.set_modify_ticket_details(client=self.client_2)
        ...
        # region Checking values after Book in the Middle Office
        values_after_book = self.middle_office.extract_list_of_block_fields(
            [MiddleOfficeColumns.conf_service.value, MiddleOfficeColumns.sts.value,
             MiddleOfficeColumns.match_status.value, MiddleOfficeColumns.client_id.value],
            [OrderBookColumns.order_id.value, order_id])
        self.middle_office.compare_values(
            {MiddleOfficeColumns.conf_service.value: 'External', MiddleOfficeColumns.sts.value: 'ApprovalPending',
             MiddleOfficeColumns.match_status.value: 'Unmatched', MiddleOfficeColumns.client_id.value: self.client_2},
            values_after_book, 'Comparing values after Book for block of MiddleOffice')
        # endregion
