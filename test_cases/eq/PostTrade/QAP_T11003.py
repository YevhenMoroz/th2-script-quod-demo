    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.java_api_manager.compare_values(
            {JavaApiFields.AllocStatus.value: AllocationReportConst.AllocStatus_ACK.value,
             JavaApiFields.AllocReportType.value: AllocationReportConst.AllocReportType_ACC.value}, alloc_report,
            'Check Manual Block')
        # endregion
        ...
        expected_result_confirmation = {
            ...
            JavaApiFields.MatchStatus.value: ConfirmationReportConst.MatchStatus_MAT.value}
        self.java_api_manager.compare_values(expected_result_confirmation, confirm_report, 'Check manual confirmation')
        # endregion
