...
class QAP_T11140(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.order_submit.update_fields_in_component("NewOrderSingleBlock", {"AccountGroupID": self.client, "Side": "5",
        ...
        self.allocation_instruction.update_fields_in_component('AllocationInstructionBlock', {
            "InstrID": instrument_id, "Side": "5", 'ExecAllocList': {'ExecAllocBlock': [{
        ...
        self.confirmation_request.update_fields_in_component(
            "ConfirmationBlock", {"AllocAccountID": self.account, "Side": "5", "AllocQty": self.qty})
        ...
        self.java_api_manager.compare_values(
            {JavaApiFields.Side.value: "5"}, alloc_report_message,
