...
class QAP_T7538(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        qty = '200'
        price = '10'
        security_account = self.data_set.get_account_by_name('client_pt_4_acc_2')
        ...
        self.order_submit.update_fields_in_component('NewOrderSingleBlock', {
            ...
            "PreTradeAllocationBlock": {
                "PreTradeAllocationList": {"PreTradeAllocAccountBlock": [
                    {"AllocAccountID": security_account, "AllocQty": qty}]}}})
        ...
        self.java_api_manager.compare_values(expected_result, allocation_report,
                                             'Check Status, Match Status and Summary Status (step 2)')
        # endregion
        ...
        self.java_api_manager.compare_values(expected_result, confirmation_report,
                                             'Check Status , MatchStatus, Qty and Price (step 3)')
        # endregion
