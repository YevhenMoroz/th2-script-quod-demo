...
from test_framework.java_api_wrappers.java_api_constants import JavaApiFields, ConfirmationReportConst
...
from test_framework.java_api_wrappers.ors_messages.MatchCptyMOBlocksRequest import MatchCptyMOBlocksRequest
...
class QAP_T7465(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.match_request = MatchCptyMOBlocksRequest()
    ...
    def run_pre_conditions_and_steps(self):
        ...
        fix_alloc_id = allocation_report[JavaApiFields.AllocReportID.value]
        ...
        expected_result = {JavaApiFields.ConfirmStatus.value: ConfirmationReportConst.ConfirmStatus_CXL.value,
                           JavaApiFields.MatchStatus.value: ConfirmationReportConst.MatchStatus_UNM.value}
        self.java_api_manager.compare_values(expected_result, conf_report, "Step 1")
        # endregion
        # Step 2
        self.match_request.set_default(fix_alloc_id, alloc_id)
        self.java_api_manager.send_message_and_receive_response(self.match_request)
        conf_report = \
            self.java_api_manager.get_last_message(ORSMessageType.ConfirmationReport.value).get_parameters()[
                JavaApiFields.ConfirmationReportBlock.value]
        expected_result = {JavaApiFields.ConfirmStatus.value: ConfirmationReportConst.ConfirmStatus_AFF.value,
                           JavaApiFields.MatchStatus.value: ConfirmationReportConst.MatchStatus_MAT.value}
        self.java_api_manager.compare_values(expected_result, conf_report, "Step 2")
        # endregion
