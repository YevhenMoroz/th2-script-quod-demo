...
class QAP_T10247(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.quote_request.set_default(self.listing_id, offer_px, bid_px, notional_amt=nat_amt,
                                       th_px=str(float(last_trd_px)))
        self.quote_request.update_fields_in_component('QuoteManagementRequestBlock',
        ...
        self.java_api_manager.compare_values({"QuoteStatus": "ACK"}, quote_rep, "Check that quote without listing was not created")
