...
class QAP_T10181(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.ssh_client.send_command("qstop -id QUOD.FIXBUYTH2TEST")
        ...
        self.java_api_manager.compare_values({"QuoteStatus": "REJ"}, quote_rep, "Check quote")
        # endregion

    @try_except(test_id=Path(__file__).name[:-3])
    def run_post_conditions(self):
        self.ssh_client.send_command("qstart FIXBUYTH2TEST")
        time.sleep(20)
