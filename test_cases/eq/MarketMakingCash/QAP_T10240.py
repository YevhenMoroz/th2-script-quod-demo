...
class QAP_T10240(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 2
        bid_px: str = str(float(open_px) - float(spread))
        offer_px: str = str(float(open_px) + float(spread))
        self.quote_request.set_default(self.listing_id, offer_px, bid_px, offer_size, bid_size, side="B", th_px=open_px)
