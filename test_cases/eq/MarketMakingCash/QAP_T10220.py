...
class QAP_T10220(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        ord_rep = self.java_api_manager.get_last_message(ORSMessageType.OrderReply.value, bid_size).get_parameters()[
        ...
        ord_rep = self.java_api_manager.get_last_message(ORSMessageType.OrderReply.value, offer_size).get_parameters()[
            JavaApiFields.OrdReplyBlock.value]
