...
class QAP_T10168(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.listing_quote.set_default(
            self.listing_id, quoting_px_ref_type="LTB", spread_px_type="PRC", bid_spread=spread, offer_spead=spread
        )
        ...
        offer_px: str = str(float(bid_px) + (float(spread) + float(spread)))
