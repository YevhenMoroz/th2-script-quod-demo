...
class QAP_T10203(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # endregion
        # region Step 1
        self.listing_quote.set_default(self.listing_id, quoting_px_ref_type="ASK", spread_px_type="PRC",
        ...
        # endregion
        # region Step 2
        bid_px = str(float(best_ask) - float(spread))
        offer_px = str(float(best_ask) + float(spread))
        self.quote_request.set_default(self.listing_id, offer_px, bid_px, offer_size, bid_size, th_px=best_ask)
