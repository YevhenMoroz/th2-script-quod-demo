...
class QAP_T10209(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.listing_quote.set_default(
            self.listing_id, quoting_px_ref_type="CLO", spread_px_type="PRC", bid_spread=spread, offer_spead=spread
        )
        ...
        self.quote_request.set_default(self.listing_id, offer_px, bid_px, notional_amt=not_amt, th_px=close_px)
