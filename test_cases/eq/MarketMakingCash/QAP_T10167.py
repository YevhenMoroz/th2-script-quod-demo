...
class QAP_T10167(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.fix_manager_fh.send_message(self.market_data_refresh)
        self.market_data_refresh.set_market_data_incr_refresh(md_req_id, "2", "2", last_trd_px, "0")
        self.fix_manager_fh.send_message(self.market_data_refresh)
        ...
        # endregion
        # region Step 2
        bid_px = str(math.ceil((float(closing_px) - (float(closing_px) * float(spread))) * 100) / 100)
