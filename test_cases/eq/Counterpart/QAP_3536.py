...
def execute(report_id, session_id):
    ...
    bo_connectivity = test_cases.wrapper.eq_fix_wrappers.get_bo_connectivity()
    ...
    try:
        ...
        nos_rule2 = rule_manager.add_NewOrdSingleExecutionReportTrade(
            ...
            client + '_PARIS', 'XPAR',
            int(price), int(qty), 1)
        fix_message = test_cases.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 1, 1, client + "_PARIS", 2, qty, 0, price)
