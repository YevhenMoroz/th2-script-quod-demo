...
def execute(report_id, session_id):
    ...
    try:
        ...
        test_cases.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 1, 1, client, 2, qty, 0, price)
    except Exception:
    ...
    # region create CO
    test_cases.wrapper.eq_fix_wrappers.create_order_via_fix(case_id, 3, 1, client, 1, qty, 0)
