...
class QAP_T7690(TestCase):
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.ref_price = self.data_set.get_ref_price('ref_pr_1')
        self.ref_price_res = self.data_set.get_ref_price('ref_pr_10')
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # endregion
        # region check fields
        self.order_book.set_filter([OrderBookColumns.order_id.value, order_id]).check_second_lvl_fields_list({OrderBookColumns.sts.value: ExecSts.open.value})
