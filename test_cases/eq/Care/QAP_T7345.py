...
class QAP_T7345(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region step 2-3: Manual Execute CO order again
        self.java_api_manager.send_message_and_receive_response(self.manual_execute)
        execution_report = \
            self.java_api_manager.get_last_message(ORSMessageType.ExecutionReport.value).get_parameters()[
                JavaApiFields.ExecutionReportBlock.value]
        ...
        self.java_api_manager.compare_values(
            ...
            execution_report, 'Verify that order Fully Filled (step 3)')
        # endregion
        ...
        self.java_api_manager.compare_values(
            ...
            execution_report, f'Verify that order Partially Filled and has valid value for {JavaApiFields.UnmatchedQty.value} (step 5)')
        # endregion
