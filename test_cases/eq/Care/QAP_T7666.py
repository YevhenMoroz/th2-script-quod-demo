...
class QAP_T7666(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.java_api_manager.compare_values({
            ...
            JavaApiFields.TimeInForce.value: TimeInForces.ATC.value, JavaApiFields.OrdType.value: OrdTypes.Market.value},
            ord_reply_block, "Check error values after Direct MOC")
        # endregion