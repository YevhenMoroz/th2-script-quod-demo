...
class QAP_T7661(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None, environment=None):
        ...
        self.modify_request = FixMessageOrderCancelReplaceRequestOMS(self.data_set)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.trd_request.set_default_trade(ord_id)
        ...
        # region Step 1-3
        new_price = "30"
        self.modify_request.set_default(self.nos, price=new_price)
        self.fix_manager.send_message_and_receive_response_fix_standard(self.modify_request)
        exec_rep = self.fix_manager.get_last_message("ExecutionReport").get_parameters()
        self.fix_manager.compare_values({"Price": new_price}, exec_rep, "Check new price")
        # endregion
