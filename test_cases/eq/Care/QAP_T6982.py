...
class QAP_T6982(TestCase):
    ...
    def __init__(self, report_id, session_id, data_set, environment):
        ...
        self.params = {
            ...
            "StrategyParametersGrp": {"NoStrategyParameters": [
                {
                    'StrategyParameterName': 'StartTime',
                    'StrategyParameterType': '19',
                    'StrategyParameterValue': (datetime.utcnow() + timedelta(minutes=10)).strftime("%Y%m%d-%H:%M:%S")
                }
            ]}
        }
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region step 1: Create CO order with algo param and check 35=8 message
        ...
        execution_report_1.add_tag(self.params)
        ...
        self.params['StrategyParametersGrp']['NoStrategyParameters'][0]['StrategyParameterValue'] = (
                    datetime.utcnow() + timedelta(minutes=60)).strftime("%Y%m%d-%H:%M:%S")
