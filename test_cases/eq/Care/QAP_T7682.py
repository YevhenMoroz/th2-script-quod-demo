...
class QAP_T7682(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 11-12 - Amend CO by User2
        ...
        ord_mod_reply = self.java_api_manager.get_last_message(
        ...
        self.java_api_manager.compare_values(
            ...
            "Checking Qty and Price after Amend by User2 in OrderModificationReply",
        )
        ...
        self.java_api_manager.compare_values(
            ...
            order_reply,
            "Step 12 - Comparing Qty and Price after Amend by User2 in OrdReply",
        )
        # endregion

        # region Step 13 - Cancel CO by User2
        self.cancel_request.set_default(ord_id)
        responses = self.java_api_manager.send_message_and_receive_response(self.cancel_request)
        ...
        self.java_api_manager.compare_values(
            ...
            order_reply,
            "Step 13 - Checking that the CO is canceled",
        )
        # endregion
