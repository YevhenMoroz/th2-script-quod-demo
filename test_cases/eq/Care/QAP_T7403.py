...
class QAP_T7403(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # region Step 3
        self.cross_request.set_default(self.data_set, ord_id_care, ord_id_care2, exec_qty="300")
        ...
        self.java_api_manager.compare_values({"ErrorCD": "QUOD-24813"}, cross_reply, "Check cross not allowed")
        # endregion
