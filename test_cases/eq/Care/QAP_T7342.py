...
class QAP_T7342(TestCase):
    ...
    def run_pre_conditions_and_steps(self):
        ...
        self.nos.update_fields_in_component("NewOrderSingleBlock", {"ClientAccountGroupID": self.dummy_client})
        ...
        exp_res = {"ClientAccountGroupID": self.dummy_client, "OrdStatus": "HLD"}
