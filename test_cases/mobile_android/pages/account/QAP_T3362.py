...
class QAP_T3362(CommonTestCase):
    ...
    def test_context(self):
        ...
        # Step 8
        menu_page.click_default_client_selection(self.client2_2)
        self.verify(f"Step 8 - {self.client2_2} is set as default client", self.client2_2,
                    menu_page.get_default_client())
        # endregion
        ...
        main_page.click_on_menu()
        menu_page.click_on_preferences()
        self.verify(f"Step 9 - {self.client1_1} is set as default client", self.client1_1,
                    menu_page.get_default_client())
        # endregion
        ...
        main_page.click_on_menu()
        menu_page.click_on_preferences()
        self.verify(f"Step 10 - {self.client2_2} is set as default client", self.client2_2,
                    menu_page.get_default_client())
        # endregion
