...
class QAP_T3383(CommonTestCase):
    ...
    def test_context(self):
        ...
        self.verify("Step 5 and 6 - Watchlist 2 is deleted", False, market_watchlists_page.get_watchlist_exist("Watchlist 2"))
        self.verify("Step 5 and 6 - Watchlist 1 exists", True, market_watchlists_page.get_watchlist_exist("Watchlist 1"))
        # endregion

        # Step 7
        market_watchlists_page.create_watchlist()
        self.verify("Step 7 - Watchlist 1 exists", True, market_watchlists_page.get_watchlist_exist("Watchlist 1"))
        self.verify("Step 7 - Watchlist 2 exists", True, market_watchlists_page.get_watchlist_exist("Watchlist 2"))
        # endregion

        # Step 8
        market_watchlists_page.rename_watchlist("Watchlist 2", "Watchlist 1")
        self.verify("Step 7 - Watchlist 1 exists", True,
                    market_watchlists_page.get_watchlist_exist("Watchlist 1"))
        self.verify("Step 7 - Watchlist 1 copy(1) exists", True,
                    market_watchlists_page.get_watchlist_exist("Watchlist 1 copy(1)"))
        self.verify("Step 7 - Watchlist 2 doesn't exist", False,
                    market_watchlists_page.get_watchlist_exist("Watchlist 2"))
        # endregion
        ...
        self.verify('''Postconditions - "Watchlist 1" is deleted''', False,
                    market_watchlists_page.get_watchlist_exist("Watchlist 1"))
        market_watchlists_page.delete_watchlist("Watchlist 1 copy(1)")
        self.verify('''Postconditions - "Watchlist 1 copy(1)" is deleted''', False,
                    market_watchlists_page.get_watchlist_exist("Watchlist 1 copy(1)"))
        # endregion