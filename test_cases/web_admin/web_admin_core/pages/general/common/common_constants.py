class CommonConstants:
    ...
    OLD_PASSWORD_FIELD_AT_LOGIN_PAGE_XPATH = "//*[@class='confirm-body']//*[@formcontrolname='oldPassword']"
    NEW_PASSWORD_FIELD_AT_LOGIN_PAGE_XPATH = "//*[@class='confirm-body']//*[@formcontrolname='newPassword']"
