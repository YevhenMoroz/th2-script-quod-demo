class StaleRatesConstants:
    STALE_RATES_PAGE_TITLE_XPATH = "//span[@class='entity-title left'][text()='Stale Rates ']"
    ...
    VALUES_TAB_STALE_RATES_DELAY_XPATH = '//*[@formcontrolname="staleRatesDelay"]'
