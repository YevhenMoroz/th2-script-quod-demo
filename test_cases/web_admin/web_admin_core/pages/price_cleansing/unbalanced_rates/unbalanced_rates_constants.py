class UnbalancedRatesConstants:
    UNBALANCED_RATES_PAGE_TITLE_XPATH = "//span[@class='entity-title left'][text()='Unbalanced Rates ']"
    ...
    VALUES_TAB_ENRICH_EMPTY_SIDE_OF_BOOK_XPATH = '//*[text()="Enrich Empty Side Of Book"]/preceding-sibling::span'
