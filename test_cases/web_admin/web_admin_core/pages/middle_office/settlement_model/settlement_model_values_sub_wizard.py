...
class SettlementModelValuesSubWizard(CommonPage):
    ...
    def is_name_field_required(self):
        return self.is_field_required(SettlementModelConstants.VALUES_TAB_NAME_XPATH)

    def is_description_field_required(self):
        return self.is_field_required(SettlementModelConstants.VALUES_TAB_DESCRIPTION_XPATH)

    def is_settl_location_field_required(self):
        return self.is_field_required(SettlementModelConstants.VALUES_TAB_SETTL_LOCATION_XPATH)
