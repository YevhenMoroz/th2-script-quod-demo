...
class QAP_T3290(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            value_tab.set_order_scope(self.order_scope)
            value_tab.set_order_fee_profile(self.order_fee_profile)
            ...
            self.instr_list = random.choice(dimensions_tab.get_all_instrument_list_from_drop_menu())
            dimensions_tab.set_instrument_list(self.instr_list)
