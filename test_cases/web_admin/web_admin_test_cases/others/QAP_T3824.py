...
class QAP_T3824(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.party_rule_table.update({"party_id_source": "BIC", "party_role": "ClientID", "party_role_qualifier": "Bank",
                                      "venue": self.data_set.get_venue_by_name("venue_5")})
    ...
    def precondition(self):
        ...
        counterparts_sub_wizard.set_party_role_qualifier_at_party_roles_tab(self.party_rule_table["party_role_qualifier"])
        counterparts_sub_wizard.set_venue_at_party_roles_tab(self.party_rule_table["venue"])
        time.sleep(1)
