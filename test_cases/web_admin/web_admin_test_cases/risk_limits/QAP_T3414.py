...
class QAP_T3414(CommonTestCase):
    ...
    def test_context(self):
        try:
            ...
            time.sleep(1)
            self.buying_power = random.choice(values_tab.get_all_buying_powers_from_drop_menu())
            values_tab.set_buying_powers([self.buying_power])
            ...
            main_page.set_name_filter(self.name)
            time.sleep(1)
            self.verify("New entity with Buying power has been create", True,
                        main_page.is_searched_entity_found(self.name))
            ...
            self.verify("Saved Buying Power displayed", self.buying_power,
