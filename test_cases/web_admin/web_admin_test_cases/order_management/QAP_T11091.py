...
class QAP_T11091(CommonTestCase):
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.dark_subwizard_values = ['0', '0', '0', 'Y', 'Neutral', 'DAY', 'Spray', '0', 'N', '700', '0']
        self.lit_general_subwizard_values = ['Y', 'N', '0', 'Default', 'Default', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'Neutral', '0', '1', 'N', 'N', 'N', 'Default', 'N', 'Y', '0', 'Y']
        self.lit_aggressive_subwizard_values = ['0', 'Y', 'N', 'N', '0', 'A', '0', 'P', '0', '10', 'N', 'N']
