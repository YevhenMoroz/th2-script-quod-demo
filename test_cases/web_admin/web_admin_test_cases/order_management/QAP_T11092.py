...
class QAP_T11092(CommonTestCase):
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.general_subwizard_values = ['3', '0', 'Ticks', 'N', '100', 'Y', '0', 'Y', '0', '0', '0', 'N', 'CLO', '0', 'Ticks',
                                         'MAN', 'N', '0', '0', '100', '0', '1', 'Ticks', '5', 'N', '0', '0', '0', '0', '0', 'N', '0',
                                         'LTP', '0', 'Ticks', '5', 'N', '0', 'N', 'N', 'N', 'PRM', '-1', 'Ticks', '0', '0', '100', '0', '0', 'NOW', 'N', 'AVG']
