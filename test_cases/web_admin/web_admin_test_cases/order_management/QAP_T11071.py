...
class QAP_T11071(CommonTestCase):
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        super().__init__(web_driver_container, self.__class__.__name__, second_lvl_id, data_set=data_set,
                         environment=environment)
        self.login = self.data_set.get_user("user_1")
        self.password = self.data_set.get_password("password_1")
        self.strategy_type = self.data_set.get_strategy_type("strategy_type_11")
        self.strategy_name = self.data_set.get_default_execution_strategy("default_execution_strategy_1")
        self.general_subwizard_values = ['Y', '1', 'N', '100', 'Y', '0', '0', '0', '0', 'N', 'N', 'CLO', '1', '1',
                                         '0', 'Ticks', 'MAN', 'N', '0', '0', '0', '100', '100', '0', '0', 'N', '0',
                                         '0', '0', '0', '0', 'N', '0', 'MID', '0', 'Ticks', 'Y', 'N', 'N', 'N', 'N',
                                         'PRM', '-1', 'Ticks', '0', '0', '0', 'NOW', '10', '0', 'AVG']
