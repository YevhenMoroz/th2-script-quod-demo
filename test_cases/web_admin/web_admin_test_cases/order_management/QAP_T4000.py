...
class QAP_T4000(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            conditions_tab.set_condition_criteria(self.criteria)
            conditions_tab.set_condition_value(self.value)
            conditions_tab.click_on_save_checkmark()
            time.sleep(1)

            expected_result = 'No results have added'
            self.verify("Warning message displayed", expected_result, wizard.get_footer_error_text())
