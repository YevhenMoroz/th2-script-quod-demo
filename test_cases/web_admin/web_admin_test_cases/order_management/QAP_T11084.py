...
class QAP_T11084(CommonTestCase):
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.general_subwizard_values = ['LastTrade']
    ...
    def test_context(self):
        try:
            ...
            self.verify("LitGeneralSubWizard parameters' values", self.general_subwizard_values, actual_lit_general_subwizard_values)
