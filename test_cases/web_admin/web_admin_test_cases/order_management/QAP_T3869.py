...
class QAP_T3869(CommonTestCase):
    ...
    def test_context(self):
        try:
            ...
            main_menu = ExecutionStrategiesPage(self.web_driver_container)
            strategies_wizard = ExecutionStrategiesWizard(self.web_driver_container)
            expected_parameter_at_dark_block = "TestSuperStrategy1=1/test1582=2"
            expected_parameter_and_value_at_dark_block = ["DarkBrokerSequence: ", expected_parameter_at_dark_block]
