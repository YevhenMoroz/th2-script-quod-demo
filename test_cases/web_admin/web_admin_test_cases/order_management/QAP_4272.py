...
class QAP_4272(CommonTestCase):
    ...
    def test_context(self):
        try:
            ...
            execution_strategies_lit_general.set_parameter("Cross Currency")
            ...
            execution_strategies_lit_aggressive.set_parameter("Stat Hit Ratio CalcType")
            ...
            execution_strategies_lit_sweeping.set_parameter("Minimum Percentage")
