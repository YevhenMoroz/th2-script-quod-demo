...
class QAP_T3544(CommonTestCase):
    ...
    def test_context(self):
        try:
            ...
            try:
                ...
                self.verify("General block is displayed", True, True)
            except Exception:
                self.verify("General block doesn't displayed", True, Exception.__class__.__name__)
