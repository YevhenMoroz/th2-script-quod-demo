...
class QAP_T11055(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None,
        ...
        self.venue_account_id_source = 'BIC'
    ...
    def precondition(self):
        ...
        page.set_id(self.id)
        time.sleep(1)
        if not page.is_searched_account_found(self.id):
        ...
        self.db_manager.my_db.execute(
            f"UPDATE VENUESECACTNAME SET ALIVE = 'N', INLASTENABLEDENTITY = 'Y' WHERE ACCOUNTID = '{self.id}'")
