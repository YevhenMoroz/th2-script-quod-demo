...
class QAP_T10309(CommonTestCase):
    ...
    def precondition(self):
        ...
        if not users_page.is_searched_user_found(self.user_id):
            ...
            interface_preferences_tab.user_interface_preference_table.click_on_update_button_and_attach_file(
                self.path_to_file)
    ...
    def test_context(self):
        ...
        time.sleep(1)
        interface_preferences_tab.user_interface_preference_table.click_on_download_button()
        time.sleep(2)
        interface_preferences_tab.user_interface_preference_table.click_on_plus_button()
        time.sleep(1)
        self.verify("Interface ID is not duplicated after downloading preference from another entry",
                    True,
                    interface_preferences_tab.user_interface_preference_table.get_interface_id_in_editor() != self.interface_pref_id)
