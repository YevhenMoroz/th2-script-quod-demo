...
class QAP_T10310(CommonTestCase):
    ...
    def test_context(self):
        ...
        time.sleep(1)
        self.verify("User Interface preference sub-wizard open",
                    True, interface_preferences_tab.user_interface_preference_table.is_sub_wizard_open())
