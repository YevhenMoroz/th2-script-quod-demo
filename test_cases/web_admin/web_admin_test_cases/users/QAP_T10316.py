...
class QAP_T10316(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.error_message = 'Such a record already exists'
    ...
    def test_context(self):
        ...
        interface_preferences_tab.user_interface_preference_table.click_on_checkmark_button()
        time.sleep(1)
        self.verify("Error appears", self.error_message, wizard.get_footer_error_message_text())
