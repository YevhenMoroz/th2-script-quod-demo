...
class QAP_T3783(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.user_id = "QAP4186"
        self.ext_id_client = ''.join(random.sample((string.ascii_uppercase + string.digits) * 6, 6))
        self.email = 'test@test.com'
        self.desk = [self.data_set.get_desk("desk_1")]
        self.non_visible_position_flattening_periods = ["Delivery", "TPlus3"]
    ...
    def precondition(self):
        ...
        if not main_page.is_searched_user_found(self.user_id):
            ...
            values_tab.set_non_visible_position_flattening_periods(self.non_visible_position_flattening_periods)
    ...
    def test_context(self):
        try:
            ...
            time.sleep(2)
            values_tab = UsersValuesSubWizard(self.web_driver_container)
            values_tab.get_non_visible_position_flattening_periods()
