...
class QAP_T10312(CommonTestCase):
    ...
    def test_context(self):
        ...
        users_page.click_on_edit_at_more_actions()
        time.sleep(1)
        interface_ids = interface_preferences_tab.user_interface_preference_table.get_all_interface_id_from_table()
        self.verify("Interface Preference Id has been changed", True, self.new_interface_pref_id in interface_ids)
