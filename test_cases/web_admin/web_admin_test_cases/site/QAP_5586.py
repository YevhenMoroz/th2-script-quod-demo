...
class QAP_5586(CommonTestCase):
    ...
    def test_context(self):
        try:
            ...
            desk_assignments_tab.set_location_at_description_tab(self.base_location)
