...
class QAP_T3394(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            login_page.login_to_web_admin(self.users["location"]["login"], self.users["location"]["password"])
            ...
            self.verify("Dropdown contain only Security Accounts according with hierarchy the administrator(*user_loc*)"
                        f" is assigned to {self.account_id} is in dropdown.",
