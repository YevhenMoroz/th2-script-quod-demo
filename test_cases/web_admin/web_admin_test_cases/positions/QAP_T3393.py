...
class QAP_T3393(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            login_page.login_to_web_admin(self.users["desk"]["login"], self.users["desk"]["password"])
            ...
            self.verify("Dropdown contain only Security Accounts according with hierarchy "
                        f"the administrator(*user_desk*) is assigned to. {self.account_id} is in dropdown.",
