...
class QAP_T3634(CommonTestCase):
    ...
    def __init__(self, web_driver_container: WebDriverContainer, second_lvl_id, data_set=None, environment=None):
        ...
        self.test_data = {
            ...
            "client": {
                "id": 'QAP5413' + ''.join(random.sample((string.ascii_uppercase + string.digits) * 6, 6)),
                "name": 'QAP5413',
    ...
    def precondition(self):
        ...
        time.sleep(2)
        if not cash_positions_page.is_searched_cash_account_found(self.test_data['cash_position']['name']):
