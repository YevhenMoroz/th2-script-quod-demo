...
from test_framework.web_admin_core.pages.reference_data.venues.nested_wizards.venues_routing_param_group_sub_wizard import \
...
from test_framework.web_admin_core.pages.reference_data.venues.venues_profiles_sub_wizard import \
...
class QAP_3136(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            expected_result = [self.name_at_routing_param_groups,
                               self.positive_routes[0] + ", " + self.positive_routes[1],
