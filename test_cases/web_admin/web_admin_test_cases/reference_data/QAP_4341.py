...
from test_framework.web_admin_core.pages.reference_data.venues.venues_values_sub_wizard \
    import VenuesValuesSubWizard
from test_framework.web_admin_core.pages.reference_data.venues.venues_profiles_sub_wizard import VenuesProfilesSubWizard
