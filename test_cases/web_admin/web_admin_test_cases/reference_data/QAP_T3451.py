...
from test_framework.web_admin_core.pages.reference_data.venue_lists.venue_lists_page import VenueListsPage
from test_framework.web_admin_core.pages.reference_data.venue_lists.venue_lists_wizard import VenuesListsWizard
from test_framework.web_admin_core.pages.root.side_menu import SideMenu
from test_framework.web_admin_core.utils.web_driver_container import WebDriverContainer
from test_cases.web_admin.web_admin_test_cases.common_test_case import CommonTestCase


class QAP_T3451(CommonTestCase):
    ...
    def test_context(self):
        ...
        try:
            ...
            self.verify("New Venue Listing is create", True, main_page.is_searched_venue_list_found(self.name))
