...
class FixEnvironment(BaseEnvironment):
    ...
    def __init__(self, environment_type: str = None, sell_side: str = None, sell_side2: str = None,
                 ...
                 feed_handler2: str = None, sell_side_cnx: str = None):
    ...
    def get_instance(env: EnvironmentType):
        ...
        elif env.value == EnvironmentType.quod319_kuiper_standard.value:
            if EnvironmentType.quod319_kuiper_standard.value not in FixEnvironment.environment_instances.keys():
                site_environment = FixEnvironment(
                    environment_type=EnvironmentType.quod319_kuiper_standard.value,
                    sell_side=Connectivity.Kuiper_319_Sell_Side.value,
                    buy_side=Connectivity.Kuiper_319_Buy_Side.value,
                    feed_handler=Connectivity.Kuiper_319_Feed_Handler.value
                )
                FixEnvironment.environment_instances.update(
                    {EnvironmentType.quod319_kuiper_standard.value: site_environment})
                return FixEnvironment.environment_instances[EnvironmentType.quod319_kuiper_standard.value]
        else:
