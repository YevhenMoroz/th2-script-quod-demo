...
class WebAdminEnvironment(BaseEnvironment):
    ...
    def get_instance(env: EnvironmentType):
        if env.value == EnvironmentType.quod314_luna_rest.value:
            if EnvironmentType.quod314_luna_rest.value not in WebAdminEnvironment.environment_instances.keys():
            ...
            return WebAdminEnvironment.environment_instances[EnvironmentType.quod314_luna_rest.value]
        else:
