class OrderBookConstants:
    ...
    ORDER_ORDER_QTY_XPATH = 'document.querySelector("*.window-tab-container [aria-describedby="igx-grid-1_OrdQty"] .ng-star-inserted span")' #//*[@data-rowindex="0"]//*[@aria-describedby="igx-grid-1_OrdQty"]//*[@class="ng-star-inserted"]
