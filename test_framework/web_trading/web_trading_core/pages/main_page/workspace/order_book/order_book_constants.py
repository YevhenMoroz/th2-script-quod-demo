class OrderBookConstants:
    ...
    ORDER_SYMBOL_XPATH = 'return document.querySelector("igx-grid-cell span").textContent'
    ORDER_INSTR_TYPE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(2) span").textContent'
    ORDER_ORDER_ID_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(3) span").textContent'
    ORDER_CLIENT_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(4) span").textContent'
    ORDER_ACCOUNT_CODE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(5) span").textContent'
    ORDER_SIDE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(6) span").textContent'
    ORDER_ORDER_QTY_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(7) span").textContent'
    ORDER_PRICE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(8) span").textContent'
    ORDER_AVG_PRICE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(9) span").textContent'
    ORDER_LEAVES_QTY_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(10) span").textContent'
    ORDER_ORDER_TYPE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(11) span").textContent'
    ORDER_CUM_QTY_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(12) span").textContent'
    ORDER_ORDER_STATUS_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(13) span").textContent'
    ORDER_EXPIRE_DATE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(14) span").textContent'
    ORDER_SETTLE_DATE_XPATH = 'return document.querySelector("igx-grid-cell:nth-child(15) span").textContent'
