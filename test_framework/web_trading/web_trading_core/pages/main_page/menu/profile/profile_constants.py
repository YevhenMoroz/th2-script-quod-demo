...
PREFERENCE_CANCEL_BUTTON_XPATH = '//*[@class="button-style-cancel"]'
PREFERENCE_SAVE_BUTTON_XPATH = '//*[@class="button-style"]'
...
SECURITY_CANCEL_BUTTON_XPATH = '//*[@class="button-style-cancel"]'
SECURITY_SAVE_BUTTON_XPATH = '//*[@class="button-style"]'