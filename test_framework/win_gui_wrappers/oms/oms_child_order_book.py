...
from win_gui_modules.order_book_wrappers import CancelOrderDetails, MenuItemDetails, BaseOrdersDetails, \
    ModifyOrderDetails, ManualCrossDetails, SuspendOrderDetails, DiscloseFlagDetails, AddToBasketDetails, \
    CreateBasketDetails, ManualExecutingDetails, SecondLevelTabDetails, SecondLevelExtractionDetails, \
    MassExecSummaryAveragePriceDetails, SplitBookingDetails, TransferOrderDetails, TransferPoolDetailsCLass, \
    MassManualExecutionDetails, UnmatchAndTransferDetails, SubLvlInfo, GetSubLvlDetails, InternalTransferActionDetails
...
class OMSChildOrderBook(BaseChildOrderBook):
    def __init__(self, case_id, session_id):
        ...
        self.mass_exec_summary_average_price_call = Stubs.win_act_child_order_book.massExecSummaryAtAveragePrice
        self.direct_moc_request_correct_call = Stubs.win_act_child_order_book.orderBookDirectMoc
        self.order_book_grid_scrolling_call = Stubs.win_act_child_order_book.orderBookGridScrolling
        self.manual_execution_order_call = Stubs.win_act_child_order_book.manualExecution
        self.house_fill_call = Stubs.win_act_child_order_book.houseFill
        self.is_menu_item_present_call = Stubs.win_act_child_order_book.isMenuItemPresent
        self.group_modify_order_call = Stubs.win_act_child_order_book.groupModify
        self.un_complete_order_call = Stubs.win_act_child_order_book.unCompleteOrder
        self.notify_dfd_order_call = Stubs.win_act_child_order_book.notifyDFD
        self.check_out_order_call = Stubs.win_act_child_order_book.checkOutOrder
        self.reassign_order_call = Stubs.win_act_child_order_book.reassignOrder
        self.complete_order_call = Stubs.win_act_child_order_book.completeOrder
        self.check_in_order_call = Stubs.win_act_child_order_book.checkInOrder
        self.suspend_order_call = Stubs.win_act_child_order_book.suspendOrder
        self.release_order_call = Stubs.win_act_child_order_book.releaseOrder
        self.disclose_flag_call = Stubs.win_act_child_order_book.discloseFlag
        self.add_to_basket_call = Stubs.win_act_child_order_book.addToBasket
        self.create_basket_call = Stubs.win_act_child_order_book.createBasket
        self.cancel_order_call = Stubs.win_act_child_order_book.cancelOrder
        self.refresh_order_call = Stubs.win_act_child_order_book.refreshOrder
        self.manual_cross_call = Stubs.win_act_child_order_book.manualCross
        self.mass_unbook_call = Stubs.win_act_child_order_book.massUnbook
        self.mass_book_call = Stubs.win_act_child_order_book.massBook
        ...
        self.split_booking_call = Stubs.win_act_child_order_book.splitBooking
        self.direct_loc_request_correct_call = Stubs.win_act_child_order_book.orderBookDirectLoc
        self.mass_book_details = RowsNumbersForGrid(self.base_request)
        self.mass_book_call = Stubs.win_act_child_order_book.massBook
        self.transfer_order_details = TransferOrderDetails()
        self.transfer_order_call = Stubs.win_act_child_order_book.transferOrder
        ...
        self.direct_order_correct_call = Stubs.win_act_child_order_book.orderBookDirectOrder
        self.mass_manual_execution_call = Stubs.win_act_child_order_book.massManualExecution
        self.mass_manual_execution_details = MassManualExecutionDetails(self.base_request)
        self.direct_child_care_call = Stubs.win_act_child_order_book.orderBookDirectChildCare
        self.unmatch_and_transfer_details = UnmatchAndTransferDetails(self.base_request)
        self.unmatch_and_transfer_call = Stubs.win_act_child_order_book.unmatchAndTransfer
        self.get_empty_rows_call = Stubs.win_act_child_order_book.checkIfOBGridHaveNoRows
        self.sub_lvl_info_details = SubLvlInfo()
        self.get_sub_lvl_details = GetSubLvlDetails(self.base_request)
        self.extract_sub_lvl_details_call = Stubs.win_act_child_order_book.extractSubLvlDetails
        # endregion
