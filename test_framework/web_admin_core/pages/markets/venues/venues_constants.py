class VenuesConstants:
    ...
    # --Values tab--
    VALUES_TAB_NAME_XPATH = '//*[@formcontrolname="venueName"]'
    VALUES_TAB_ID_XPATH = '//*[@formcontrolname="venueID"]'
    VALUES_TAB_MIC_XPATH = '//*[@formcontrolname="MIC"]//input'
    VALUES_TAB_COUNTRY_XPATH = '//*[@id="countryEnumTable"]'
    VALUES_TAB_CATEGORY_XPATH = '//*[@formcontrolname="venueCategory"]'
    VALUES_TAB_SHORT_NAME_XPATH = '//*[@formcontrolname="venueShortName"]'
    VALUES_TAB_VERY_SHORT_NAME_XPATH = '//*[@formcontrolname="venueVeryShortName"]'
    VALUES_TAB_CLIENT_VENUE_ID_XPATH = '//*[@formcontrolname="clientVenueID"]'
    ...
    DEFAULT_TAB_SETTLEMENT_TIME_XPATH = '//*[@id="venueSettlTime"]'
