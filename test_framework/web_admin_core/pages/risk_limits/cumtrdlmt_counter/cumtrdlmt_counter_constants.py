class CumTrdLmtCounterConstants:
    CUMTRDLMT_COUNTER_PAGE_TITLE_XPATH = "//span[@class='entity-title left'][text()='CumTrdLmt Counter ']"
    ...
    MAIN_PAGE_CUM_BUY_ORD_QTY_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[2]//input'
    MAIN_PAGE_CUM_ORD_AMT_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[3]//input'
    MAIN_PAGE_CUM_SELL_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[4]//input'
    MAIN_PAGE_CUM_BUY_ORD_AMT_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[5]//input'
    MAIN_PAGE_CUM_ORD_QTY_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[6]//input'
    MAIN_PAGE_CUM_SELL_ORD_AMT_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[7]//input'
