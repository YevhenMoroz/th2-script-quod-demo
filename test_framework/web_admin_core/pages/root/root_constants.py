class RootConstants:
    ...
    INSTRUMENT_SYMBOLS_ITEM_XPATH = "//span[text()='Instrument Symbols']"
    ...
    CLIENT_LISTS_ITEM_XPATH = "//span[text()='Client Lists']"
    CASH_ACCOUNTS_ITEM_XPATH = "//span[text()='CashAccounts']"
    EXTERNAL_CLIENT_GROUP_IDS_ITEM_XPATH = "//span[text()='External Client Group IDs']"
