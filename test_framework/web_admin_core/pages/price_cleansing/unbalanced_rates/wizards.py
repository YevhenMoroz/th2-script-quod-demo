...
from test_framework.web_admin_core.pages.price_cleansing.unbalanced_rates.constants import Constants
...
class ValuesTab(CommonPage):
    ...
    def is_remove_detected_price_update_checkbox_selected(self):
        return self.is_checkbox_selected(Constants.Wizard.ValuesTab.REMOVE_DETECTED_PRICE_UPDATES_CHECKBOX)

    def click_on_enrich_empty_side_of_book_checkbox(self):
        self.find_by_xpath(Constants.Wizard.ValuesTab.ENRICH_EMPTY_SIDE_OF_BOOK_XPATH).click()

    def is_enrich_empty_side_of_book_checkbox_selected(self):
        return self.is_checkbox_selected(Constants.Wizard.ValuesTab.ENRICH_EMPTY_SIDE_OF_BOOK_XPATH)
