class RatesFollowingTradesConstants:
    RATES_FOLLOWING_TRADES_PAGE_TITLE_XPATH = "//span[@class='entity-title left'][normalize-space()='Rates Following Trade']"
    ...
    MAIN_PAGE_STALE_RATES_DELAY_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[2]//input'
    MAIN_PAGE_VENUE_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[3]//input'
    MAIN_PAGE_LISTING_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[4]//input'
    MAIN_PAGE_SYMBOL_FILTER_XPATH = '//*[@class="ag-header-container"]/div[2]/div[5]//input'
    ...
    MAIN_PAGE_STALE_RATES_DELAY_XPATH = '//*[@class="staleRatesDelay"]//span//span[4]'
    ...
    VALUES_TAB_REMOVE_DETECTED_PRICE_UPDATES_CHECKBOX_XPATH = '//*[text()="Remove Detected Price Updates"]/preceding-sibling::span'
    VALUES_TAB_RELATED_RATES_DELAY_XPATH = '//*[@formcontrolname="relatedRatesDelay"]'
