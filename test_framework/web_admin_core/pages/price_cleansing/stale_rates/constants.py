class Constants:
    class MainPage:
        PAGE_TITLE = '//span[@class="entity-title left"][normalize-space()="Stale Rates"]'
        ...
        class Filters:
            ...
            STALE_RATES_DELAY = '(//input[@class="ag-floating-filter-input"])[2]'
    ...
    class Wizard:
        ...
        class ValuesTab:
            ...
            STALE_RATES_DELAY = '//input[@id="staleRatesDelay"]'
