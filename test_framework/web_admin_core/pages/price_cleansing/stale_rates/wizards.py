...
from test_framework.web_admin_core.pages.price_cleansing.stale_rates.constants import Constants
...
class ValuesTab(CommonPage):
    ...
    def set_stale_rate_delay(self, value: int or float):
        self.set_text_by_xpath(Constants.Wizard.ValuesTab.STALE_RATES_DELAY, str(value))

    def get_stale_rate_delay(self):
        return self.get_text_by_xpath(Constants.Wizard.ValuesTab.STALE_RATES_DELAY)
