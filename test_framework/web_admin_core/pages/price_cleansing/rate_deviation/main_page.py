...
class MainPage(CommonPage):
    ...
    def set_price_deviation_filter(self, value):
        self.set_text_by_xpath(Constants.MainPage.Filters.PRICE_DEVIATION, value)
    ...
    def set_price_deviation_format_filter(self, value):
        self.set_text_by_xpath(Constants.MainPage.Filters.PRICE_DEVIATION_FORMAT, value)
