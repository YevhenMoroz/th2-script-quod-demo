...
class ClientsPoliciesSubWizard(CommonPage):
    ...
    def set_default_child_execution_strategy(self, value):
        self.set_combobox_value(ClientsConstants.POLICIES_TAB_DEFAULT_CHILD_EXECUTION_STRATEGY_XPATH, value)

    def get_default_child_execution_strategy(self):
