...
class QAP_Example(TestCase):
    ...
    def __init__(self, report_id, session_id=None, data_set=None):
        ...
        self.ja_manager = JavaApiManager(self.ja_connectivity, bca.create_event(Path(__file__).name[:-3], report_id))
        self.base_window = BaseMainWindow(self.test_id, session_id)
        self.ord_book = OMSOrderBook(self.test_id, session_id)
        self.cl_inbox = OMSClientInbox(self.test_id, session_id)
    ...
    def run_pre_conditions_and_steps(self):
        ...
        # endregion
        # region Accept Care
        self.cl_inbox.accept_order(self.data_set.get_venue_by_name("venue_1"), qty, price)
        # endregion
