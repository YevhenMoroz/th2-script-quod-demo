...
class FixMessageExecutionReportAlgo(FixMessageExecutionReport):
    ...
    def set_params_from_new_order_single_for_Kepler_DMA(self, new_order_single: FixMessageNewOrderSingle, status: Status):
        if status is Status.Pending:
            self.__set_pending_new_kepler_dma(new_order_single)
        elif status is Status.New:
            self.__set_new_kepler_dma(new_order_single)
        elif status is Status.Fill:
            self.__set_fill_kepler_dma(new_order_single)
        elif status is Status.PartialFill:
            self.__set_partial_fill_kepler_dma(new_order_single)
        elif status is Status.Reject:
            self.__set_reject_kepler_dma(new_order_single)
        elif status is Status.Cancel:                           
            self.__set_cancel_kepler_dma(new_order_single)
        elif status is Status.Eliminate:
            self.__set_eliminate_kepler_dma(new_order_single)
        else:
            raise Exception(f'Incorrect Status')
        return self

    def set_params_from_order_cancel_replace_for_Kepler_DMA(self, order_cancel_replace: FixMessageOrderCancelReplaceRequest, status: Status):
        if status is Status.CancelReplace:
            self.__set_cancel_replace_kepler_dma(order_cancel_replace)
        elif status is Status.Cancel:
            self.__set_cancel_rep_kepler_dma(order_cancel_replace)
        else:
            raise Exception(f'Incorrect Status')
        return self
    ...
    def __set_pending_new_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if new_order_single.get_parameter('OrdType') != 1 and new_order_single.get_parameter('OrdType') != 3:
            temp.update(Price=new_order_single.get_parameter("Price"))
        if new_order_single.get_parameter('OrdType') == 3 or new_order_single.get_parameter('OrdType') == 4:
    ...
    def __set_new_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if new_order_single.get_parameter('OrdType') != 1 and new_order_single.get_parameter('OrdType') != 3:
            temp.update(Price=new_order_single.get_parameter("Price"))
        if new_order_single.get_parameter('OrdType') == 3 or new_order_single.get_parameter('OrdType') == 4:
    ...
    def __set_fill_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if str(new_order_single.get_parameter('OrdType')) == '2':
            temp.update(Price = new_order_single.get_parameter("Price"))
        if 'DisplayInstruction' in new_order_single.get_parameters():
    ...
    def __set_partial_fill_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if str(new_order_single.get_parameter('OrdType')) == '2':
            temp.update(Price = new_order_single.get_parameter("Price"))
        if 'DisplayInstruction' in new_order_single.get_parameters():
    ...
    def __set_cancel_replace_kepler_dma(self, order_cancel_replace: FixMessageOrderCancelReplaceRequest = None):
        temp = dict()
        if order_cancel_replace.get_parameter('OrdType') == '2':
            temp.update(Price = order_cancel_replace.get_parameter("Price"))
        if 'DisplayInstruction' in order_cancel_replace.get_parameters():
    ...
    def __set_cancel_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if new_order_single.get_parameter('OrdType') != 1 and new_order_single.get_parameter('OrdType') != 3:
            temp.update(Price=new_order_single.get_parameter("Price"))
        if new_order_single.get_parameter('OrdType') == 3 or new_order_single.get_parameter('OrdType') == 4:
    ...
    def __set_cancel_rep_kepler_dma(self, order_cancel_replace: FixMessageOrderCancelReplaceRequest = None):
        temp = dict()
        if order_cancel_replace.is_parameter_exist('Price'):
            temp.update(Price=order_cancel_replace.get_parameter('Price'))
        if order_cancel_replace.is_parameter_exist('StopPx'):
    ...
    def __set_eliminate_sell(self, new_order_single: FixMessageNewOrderSingle = None):
        ...
        if new_order_single.get_parameter('TargetStrategy') != '1008' and new_order_single.get_parameter('TargetStrategy') != '1011':
            temp.update(LastMkt='*')
        if new_order_single.get_parameter('TargetStrategy') == '1010' or (new_order_single.is_parameter_exist('ClientAlgoPolicyID') and new_order_single.get_parameter('ClientAlgoPolicyID') in ['QA_Auto_SORPING_ME_Y', 'QA_Auto_SORPING_ME_N', 'QA_Auto_SORPING_4', 'QA_Auto_SORPING_8']):
            temp.update(
                NoParty='*',
                SecondaryAlgoPolicyID='*'
            )
    ...
    def __set_eliminate_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if new_order_single.get_parameter('OrdType') != 1 and new_order_single.get_parameter('OrdType') != 3:
            temp.update(Price=new_order_single.get_parameter("Price"))
        if new_order_single.get_parameter('OrdType') == 3 or new_order_single.get_parameter('OrdType') == 4:
    ...
    def __set_reject_kepler_dma(self, new_order_single: FixMessageNewOrderSingle = None):
        temp = dict()
        if str(new_order_single.get_parameter('OrdType')) == '2':
            temp.update(Price = new_order_single.get_parameter("Price"))
        if new_order_single.is_parameter_exist('ExDestination'):
    ...
    def __set_cancel_rep_kepler_sell(self, order_cancel_replace: FixMessageOrderCancelReplaceRequest = None):
        ...
        if order_cancel_replace.get_parameter('TargetStrategy') == '1011' and order_cancel_replace.is_parameter_exist('ClientAlgoPolicyID'):
            temp.update(SecondaryAlgoPolicyID='*')
        if order_cancel_replace.get_parameter('TargetStrategy') == '1010' or (order_cancel_replace.get_parameter('TargetStrategy') == '1008' and order_cancel_replace.is_parameter_exist('MinQty')) or (
                order_cancel_replace.get_parameter('TargetStrategy') == '1004' and order_cancel_replace.is_parameter_exist('ClientAlgoPolicyID')):
            temp.update(
                NoParty='*',
                SecondaryAlgoPolicyID='*'
            )
