...
class FixMessageQuoteCancelFX(FixMessage):
    ...
    def set_params_for_cancel(self, quote_request, quote):
        ...
        if quote_request.get_message_type() is fix_request:
            ...
            temp = dict(
                ...
                QuoteID=quote_request.get_parameter("QuoteRequestBlock")["QuoteReqList"]["QuoteReqBlock"][0][
                    "LiveQuoteID"],
                QuoteCancelType="5"
            )
        else:
    ...
    def set_params_for_cancel_synergy(self, quote_request: FixMessageQuoteRequestFX, quote: FixMessageQuoteSynergyFX):
        temp = dict(
            QuoteReqID=quote_request.get_parameter("QuoteReqID"),
            QuoteID=quote.get_parameter("QuoteID"),
            QuoteCancelType="5",
