...
from regression_cycle import web_admin_regression #algo_regression, fx_regression, eq_regression, retail_regression, , web_trading_regression, mobile_android_regression
